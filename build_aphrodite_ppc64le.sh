...
python3.12 -m venv /opt/aphrodite
source /opt/aphrodite/bin/activate

export PATH=/opt/aphrodite/bin:$PATH
...
export Python_EXECUTABLE=/opt/aphrodite/bin/python3
export Python3_EXECUTABLE=/opt/aphrodite/bin/python3
export PYTHON_EXECUTABLE=/opt/aphrodite/bin/python3

export Python_ROOT_DIR=/opt/aphrodite
export Python3_ROOT_DIR=/opt/aphrodite
...
export PYTHONPATH=/opt/aphrodite/lib64/python3.12/site-packages:/opt/aphrodite/lib/python3.12/site-packages:${PYTHONPATH:-}
