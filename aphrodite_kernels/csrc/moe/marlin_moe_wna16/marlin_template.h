...
template <typename scalar_t,  // compute dtype, half or nv_float16
          const aphrodite::ScalarTypeId b_type_id,  // weight MarlinScalarType
                                                    // id
...
__global__ void Marlin(
  ...
  constexpr bool dequant_skip_flop =
      is_a_8bit || b_type == aphrodite::kFE4M3fn ||
  ...
  const int scales_expert_stride =
      prob_n * prob_k / group_size / (b_type == aphrodite::kFE2M1f ? 16 : 8);
  ...
  // part1: DP
  // part2: two-tile SK
  // see https://github.com/aphrodite-project/aphrodite/pull/24722 for more
  // details
  ...
  int s_gl_stride = prob_n / (b_type == aphrodite::kFE2M1f ? 16 : 8);
  constexpr int s_sh_stride =
      16 * thread_n_blocks / (b_type == aphrodite::kFE2M1f ? 16 : 8);
