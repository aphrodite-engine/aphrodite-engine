...
APHRODITE_USE_PRECOMPILED=0 APHRODITE_USE_PRECOMPILED_RUST=0 \
...
```bash
export APHRODITE_USE_V2_MODEL_RUNNER=1          # model runner v2
export APHRODITE_DEEP_GEMM_WARMUP=skip
