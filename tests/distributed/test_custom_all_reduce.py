...
from aphrodite.distributed.device_communicators import custom_all_reduce as car
...
def test_custom_allreduce(
    ...
    if not gpu_p2p_access_check(0, 1):
        pytest.skip("Custom all-reduce requires peer-to-peer GPU access.")
