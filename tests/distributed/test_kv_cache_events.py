...
def test_block_stored_session_id_is_wire_compatible():
    ...
    assert msgspec.msgpack.decode(pre_session_payload, type=BlockStored).session_id is None
    ...
    assert msgspec.msgpack.decode(new_payload, type=_PreSessionBlockStored).medium == "GPU"
