...
from aphrodite.distributed.parallel_state import get_tp_group, get_world_group
...
# of the `LLM` instance.
params = list(llm.llm_engine.modeling.driver_worker.worker.model_runner.model.parameters())
