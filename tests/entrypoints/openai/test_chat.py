...
def server(
    ...
    monkeypatch_module.setenv('APHRODITE_USE_V1', '1' if use_v1 else '0')
...
def is_v1_server(server):
    import os
    assert os.environ['APHRODITE_USE_V1'] in ['0', '1']
    return os.environ['APHRODITE_USE_V1'] == '1'
