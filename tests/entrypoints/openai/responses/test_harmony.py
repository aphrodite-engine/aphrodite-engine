...
@pytest.mark.parametrize("model_name", [MODEL_NAME])
@pytest.mark.parametrize("tool_choice", ["auto", "required"])
async def test_function_calling_multi_turn(client: OpenAI, model_name: str, tool_choice: str):
...
async def test_system_message_with_tools(client: OpenAI, model_name: str):
    from aphrodite.entrypoints.openai.parser.harmony_utils import get_system_message
...
@pytest.mark.parametrize("model_name", [MODEL_NAME])
@pytest.mark.parametrize("tool_choice", ["auto", "required"])
async def test_function_calling_full_history(client: OpenAI, model_name: str, tool_choice: str):
    tools = [GET_WEATHER_SCHEMA]
...
@pytest.mark.parametrize("model_name", [MODEL_NAME])
@pytest.mark.parametrize("tool_choice", ["auto", "required"])
async def test_function_calling_with_stream(client: OpenAI, model_name: str, tool_choice: str):
...
@pytest.mark.parametrize("model_name", [MODEL_NAME])
@pytest.mark.parametrize("tool_choice", ["auto", "required"])
async def test_function_calling_no_code_interpreter_events(client: OpenAI, model_name: str, tool_choice: str):
...
@pytest.mark.parametrize("model_name", [MODEL_NAME])
@pytest.mark.parametrize("tool_choice", ["auto", "required"])
async def test_function_call_with_previous_input_messages(client: OpenAI, model_name: str, tool_choice: str):
