...
from aphrodite.entrypoints.pooling.scoring.io_processor import JinaRankingIOProcessor
from aphrodite.entrypoints.pooling.scoring.protocol import RerankRequest
from aphrodite.entrypoints.pooling.scoring.typing import ScoringData
...
def test_online_forwards_truncate_prompt_tokens_to_proxy(monkeypatch):
    ...
    proc.valid_inputs_online = MagicMock(return_value=ScoringData(data_1=["query"], data_2=["doc"]))
