...
This test suite validates Aphrodite's automatic chunking functionality for handling
...
def server_with_chunked_processing():
    ...
    args = [
        ...
        "--pooler-config",
        ('{"pooling_type": "MEAN", "normalize": true, "enable_chunked_processing": true, "max_embed_len": 10000}'),
