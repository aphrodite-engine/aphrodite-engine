...
def test_dflash_correctness(
    ...
    with aphrodite_runner(
        ...
        context = f"DFlash target={config.model}, draft={config.draft_model}, MRV2={use_mrv2}"
        print(f"{context}: GSM8K accuracy={accuracy:.3f}, acceptance_len={acceptance_len:.2f}")
