...
def test_sliding_window_retrieval(model, batch_size, seed, disable_hybrid_kv_cache_manager, aphrodite_runner):
    """
...
def test_hybrid_kv_cache_manager_output_equivalence(model, aphrodite_runner):
