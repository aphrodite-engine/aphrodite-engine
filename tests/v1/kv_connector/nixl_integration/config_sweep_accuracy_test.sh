...
hybrid_ssm_configs=(
  "APHRODITE_SSM_CONV_STATE_LAYOUT=DS GPU_MEMORY_UTILIZATION=0.8 MODEL_NAMES=ibm-granite/granite-4.0-h-tiny APHRODITE_SERVE_EXTRA_ARGS=--max-model-len,8192,--trust-remote-code"
  "APHRODITE_SSM_CONV_STATE_LAYOUT=DS PREFILLER_TP_SIZE=2 DECODER_TP_SIZE=2 GPU_MEMORY_UTILIZATION=0.8 MODEL_NAMES=ibm-granite/granite-4.0-h-tiny APHRODITE_SERVE_EXTRA_ARGS=--max-model-len,8192,--trust-remote-code"
  "APHRODITE_SSM_CONV_STATE_LAYOUT=DS PREFILLER_TP_SIZE=2 DECODER_TP_SIZE=1 GPU_MEMORY_UTILIZATION=0.8 MODEL_NAMES=ibm-granite/granite-4.0-h-tiny APHRODITE_SERVE_EXTRA_ARGS=--max-model-len,8192,--trust-remote-code"
  # GDN (Qwen3.5)
  "APHRODITE_SSM_CONV_STATE_LAYOUT=DS GPU_MEMORY_UTILIZATION=0.8 MODEL_NAMES=Qwen/Qwen3.5-0.8B"
  "APHRODITE_SSM_CONV_STATE_LAYOUT=DS PREFILLER_TP_SIZE=1 DECODER_TP_SIZE=2 GPU_MEMORY_UTILIZATION=0.8 MODEL_NAMES=Qwen/Qwen3.5-0.8B"
  "APHRODITE_SSM_CONV_STATE_LAYOUT=DS ENFORCE_EAGER=0 GPU_MEMORY_UTILIZATION=0.8 MODEL_NAMES=Qwen/Qwen3.5-0.8B APHRODITE_SERVE_EXTRA_ARGS=--spec-method,mtp,--spec-tokens,1"
  # Mamba1 (Jamba)
  "APHRODITE_SSM_CONV_STATE_LAYOUT=DS GPU_MEMORY_UTILIZATION=0.8 MODEL_NAMES=ai21labs/AI21-Jamba2-3B APHRODITE_SERVE_EXTRA_ARGS=--max-model-len,8192"
)
sw_attn_configs=(
  # NOTE: gemma3 does not work with FlashInfer
  "GPU_MEMORY_UTILIZATION=0.8 MODEL_NAMES=google/gemma-3-4b-it APHRODITE_SERVE_EXTRA_ARGS=--max-model-len,8192" # SW model
  "GPU_MEMORY_UTILIZATION=0.8 MODEL_NAMES=google/gemma-3-4b-it PREFILLER_TP_SIZE=1 DECODER_TP_SIZE=2 APHRODITE_SERVE_EXTRA_ARGS=--max-model-len,8192"
  "GPU_MEMORY_UTILIZATION=0.8 MODEL_NAMES=google/gemma-3-4b-it PREFILLER_TP_SIZE=2 DECODER_TP_SIZE=1 APHRODITE_SERVE_EXTRA_ARGS=--max-model-len,8192"
  # Gemma4: SW + cross-layer KV sharing
  "GPU_MEMORY_UTILIZATION=0.8 MODEL_NAMES=google/gemma-4-E2B-it APHRODITE_SERVE_EXTRA_ARGS=--max-model-len,8192"
)
