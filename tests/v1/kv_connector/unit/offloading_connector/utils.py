    ...
    def _run(
        ...
        while True:
            ...
            if self.async_scheduling:
                ...
                engine_outputs = self.scheduler.update_from_output(scheduler_output, model_runner_output)
                self._record_kv_connector_stats(engine_outputs)
            ...
            if (
                ...
                and (self.scheduler.requests or self.connector_scheduler._jobs or self.scheduler.finished_req_ids)
            ):
