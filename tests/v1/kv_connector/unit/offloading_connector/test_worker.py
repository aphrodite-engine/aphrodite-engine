...
def _make_worker(kv_cache_config: KVCacheConfig):
    ...
    """
    from aphrodite.distributed.kv_transfer.kv_connector.v1.offloading.worker import (
    ...
    worker = OffloadingConnectorWorker(spec=spec, kv_cache_config=kv_cache_config)
