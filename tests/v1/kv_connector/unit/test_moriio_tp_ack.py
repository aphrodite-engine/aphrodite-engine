...
def test_requested_cudagraph_mode_is_never_overridden():
    ...
    assert MoRIIOConnector.requires_piecewise_for_cudagraph({"read_mode": True}) is False
    assert MoRIIOConnector.requires_piecewise_for_cudagraph({"read_mode": False}) is False
