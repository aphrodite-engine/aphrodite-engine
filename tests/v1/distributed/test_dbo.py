...
MIN_ACCURACY = 0.62  # Expected 0.64 with 2% buffer (based on Aphrodite test data)
...
def test_dbo_dp_ep_gsm8k(all2all_backend: str, num_gpus_available):
    ...
    with RemoteOpenAIServer(
        ...
        results = lm_eval.simple_evaluate(
            ...
            model_args=(f"pretrained={MODEL_NAME},base_url={base_url},num_concurrent=512,max_retries=3"),
            tasks=["gsm8k"],
