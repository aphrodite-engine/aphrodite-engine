...
async def test_dp_pause_late_request_does_not_block_drain():
    ...
    with ExitStack() as after:
        ...
        assert await _poll_flag(engine, True, timeout=5), "the late request did not notify the coordinator"
...
async def test_dp_sleep_late_request_does_not_block_drain():
    ...
    with ExitStack() as after:
        ...
        assert await _poll_flag(engine, True, timeout=5), "the request did not notify the coordinator"
