...
from aphrodite.model_executor.determinism.batch_invariant import matmul_batch_invariant
...
def test_matmul_batch_invariance_across_tuned_m_buckets(m, transpose_b):
    ...
    capability = current_platform.get_device_capability() if current_platform.is_cuda() else None
