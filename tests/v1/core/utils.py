...
def create_scheduler(
    ...
    if isinstance(use_kv_connector, MockKVConfig):
        kv_transfer_config = KVTransferConfig(
            ...
            kv_connector_extra_config={
                ...
                "num_defers_before_matching": (use_kv_connector.num_defers_before_matching),
            },
        )
    ...
    if num_speculative_tokens is not None:
        ...
        if num_speculative_tokens_per_batch_size is not None:
            spec_kwargs["num_speculative_tokens_per_batch_size"] = num_speculative_tokens_per_batch_size
