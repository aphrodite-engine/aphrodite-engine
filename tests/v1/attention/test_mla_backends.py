...
from aphrodite.v1.kv_cache_interface import KVQuantMode, MLAAttentionSpec
...
def create_and_prepopulate_kv_cache(
    ...
    if fp8_attention:
        ...
        kv_cache = torch.zeros(num_blocks, block_size, kv_entry_size, dtype=torch.uint8, device=device)
        scale_tensor = (
