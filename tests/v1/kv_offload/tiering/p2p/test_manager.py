...
from aphrodite.v1.kv_offload.base import LookupResult, ReqContext, ScheduleEndContext
...
class TestBindHostPortDefaults:
    ...
    def _construct(monkeypatch, dp_index=0, **kwargs) -> P2PSecondaryTierManager:
        ...
        monkeypatch.setattr(
            manager_module,
            "ZmqTransport",
            lambda local_id, host, port, *a, **k: calls.update(zmq_id=local_id, zmq_host=host, zmq_port=port)
            or SimpleNamespace(),
        )
