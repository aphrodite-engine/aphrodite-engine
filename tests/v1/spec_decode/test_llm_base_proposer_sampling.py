...
from aphrodite.v1.spec_decode.llm_base_proposer import (
...
def test_mtp_model_returns_tuple(architecture: str, expected: bool):
    ...
    proposer.method = "mtp"
    proposer.draft_model_config = SimpleNamespace(hf_config=SimpleNamespace(architectures=[architecture]))
