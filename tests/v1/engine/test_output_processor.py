...
from aphrodite.logprobs import FlatLogprobs, Logprob, PromptLogprobs, SampleLogprobs
...
def test_request_stream_interval_raises_but_not_below_engine_default(
    ...
    requests = [
        ...
        for idx, prompt_tokens in enumerate(dummy_test_vectors.prompt_tokens[: len(request_stream_intervals)])
    ]
