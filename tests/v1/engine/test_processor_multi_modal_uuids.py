...
from aphrodite.config import (AphroditeConfig, CacheConfig, DeviceConfig,
                              ModelConfig)
from aphrodite.platforms.interface import UnspecifiedPlatform
...
def _mk_processor(monkeypatch,
    ...
    monkeypatch.setattr(processor_mod,
                        ...
                        lambda aphrodite_config, mm_registry: None,
                        raising=True)

    monkeypatch.setattr(AphroditeConfig,
                        "__post_init__",
                        lambda self: None,
                        raising=True)
    ...
    return Processor(aphrodite_config, tokenizer=None)  # type: ignore[arg-type]
