...
def test_model_tpu_int8(
    ...
    monkeypatch.setenv("APHRODITE_XLA_CACHE_PATH", "")
    ...
    with aphrodite_runner(model, dtype=dtype, hf_overrides=hf_overrides) as aphrodite:
        ...
        aphrodite.apply_model(check_model)
        outputs = aphrodite.generate_greedy(prompts, max_tokens)
