...
pallas_attention_backend_patcher = mock.patch(
    "aphrodite.v1.worker.tpu_model_runner.PallasAttentionBackend", )
...
def model_runner():
    ...
    with mock.patch("aphrodite.v1.worker.tpu_model_runner.torch"), \
         mock.patch("aphrodite.v1.worker.tpu_model_runner.xm"), \
         mock.patch("aphrodite.v1.worker.tpu_model_runner.xr"):
