...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(SamplingParams(thinking_token_budget=3), True, id="thinking-budget"),
        ...
        pytest.param(SamplingParams.for_sampler_warmup(), True, id="all-logits-processors"),
    ],
)
def test_logits_processing_cache_matches_request_features(sampling_params: SamplingParams, expected: bool):
