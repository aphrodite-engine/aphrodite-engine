...
def test_auto_gptq_quantization_method(model_id: str, monkeypatch, dist_init, workspace_init):
...
def test_routed_experts_loads_per_expert_biases():
    class Loader:
        ...
        _narrow_expert_data_for_padding = staticmethod(RoutedExperts._narrow_expert_data_for_padding)
