...
def test_modelopt_mixed_precision_composes_gemma4_mappers():
    ...
    config.apply_aphrodite_mapper(Gemma4ForConditionalGeneration.hf_to_aphrodite_mapper.get_unstacked_mapper())
    config.apply_aphrodite_mapper(Gemma4ForCausalLM.hf_to_aphrodite_mapper.get_unstacked_mapper())
