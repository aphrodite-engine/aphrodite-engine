...
def test_compressed_tensors_2of4_quant_fp8(aphrodite_runner, args_2of4):
...
def test_compressed_tensors_2of4_quant_fp8_compressed(aphrodite_runner, args_2of4):
    model, weight_strategy, input_strategy = args_2of4
    with aphrodite_runner(model, enforce_eager=True) as llm:
...
def test_compressed_tensors_2of4_quant_int8_compressed(aphrodite_runner, args_2of4):
    model, weight_strategy, input_strategy = args_2of4
    with aphrodite_runner(model, enforce_eager=True) as llm:
...
def test_compressed_tensors_2of4_quant_int8(aphrodite_runner, args_2of4):
    model, weight_strategy, input_strategy = args_2of4
    with aphrodite_runner(model, enforce_eager=True) as llm:
...
def test_compressed_tensors_2of4_sparse(aphrodite_runner, args_2of4):
    model = args_2of4
    with aphrodite_runner(model, enforce_eager=True) as llm:
...
def test_compressed_tensors_nvfp4(aphrodite_runner, args):
    model, scheme = args
    with aphrodite_runner(model, enforce_eager=True) as llm:
