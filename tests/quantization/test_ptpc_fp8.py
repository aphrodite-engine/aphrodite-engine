...
import pytest
import torch
from aphrodite.quantization.fp8 import Fp8KVCacheMethod
from aphrodite.quantization.ptpc_fp8 import PTPCFp8LinearMethod
...
def test_ptpc_fp8_rocm(aphrodite_runner, dtype: str, kv_cache_dtype: str) -> None:
    try:
        llm = aphrodite_runner(
            "facebook/opt-125m",
            dtype=dtype,
