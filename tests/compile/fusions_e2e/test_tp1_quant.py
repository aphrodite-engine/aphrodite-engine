...
from aphrodite.config import PassConfig
from aphrodite.platforms import current_platform
from aphrodite.utils.flashinfer import is_flashinfer_fp8_blockscale_gemm_supported
...
def test_tp1_fp4_fusions(
    ...
    if nvfp4_kernel_exposes_input_quant_key():
        pytest.skip("NVFP4 kernel exposes input_quant_key; manual fusion fires instead of compiler pass-based fusion")
