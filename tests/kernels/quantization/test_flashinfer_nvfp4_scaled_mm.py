...
from aphrodite.model_executor.kernels.linear.nvfp4 import NvFp4LinearLayerConfig
...
def test_flashinfer_cutedsl_nvfp4_w4a16_linear(
    ...
    weight_quant_scale = (FLOAT8_E4M3_MAX * FLOAT4_E2M1_MAX / weight.abs().max()).to(torch.float32)
