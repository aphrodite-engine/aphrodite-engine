...
if current_platform.is_cuda_alike() and not current_platform.has_device_capability((7, 0)):
...
def test_w8a8_fp8_fused_moe(default_aphrodite_config, M, N, K, E, topk, dtype, seed):
