...
def test_gptq_shuffle_opcheck():
    weight = torch.randint(-2000000, 2000000, (1792, 4096), device="cuda", dtype=torch.int32)
...
def test_gptq_gemm_opcheck():
    ...
    weight = torch.randint(-2000000, 2000000, (512, 6144), device="cuda", dtype=torch.int32)
    ...
    opcheck(torch.ops._C.gptq_gemm, (a, weight, zeros, scales, idx, use_exllama, True, bit))
    opcheck(torch.ops._C.gptq_gemm, (a, weight, zeros, scales, idx, use_exllama, False, bit))
