...
from aphrodite.model_executor.layers import utils as layer_utils
from aphrodite.utils.flashinfer import is_flashinfer_cutedsl_bf16_gemm_supported
...
def test_flashinfer_bf16_cutedsl_correctness(
    ...
    bias = torch.randn(n, device="cuda", dtype=torch.bfloat16) * 0.1 if use_bias else None

    actual = layer_utils.cuda_flashinfer_bf16_gemm_impl(x, weight, bias, pdl, "flashinfer_cutedsl")
