...
from aphrodite.model_executor.layers.rotary_embedding.mrope import apply_interleaved_rope
...
@pytest.mark.skipif(not current_platform.is_cuda_alike(), reason="Skipping CUDA/ROCm only test.")
