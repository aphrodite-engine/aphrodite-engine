...
def ref_impl(
    ...
    return ref_dynamic_per_token_quant(rms_norm_layer, x, quant_dtype, residual, scale_ub)
...
def test_rms_norm(
    ...
    ref_out, ref_scales, ref_residual = ref_impl(layer, x, quant_dtype, residual, scale_ub)
    ops_out, ops_scales, ops_residual = ops_impl(layer.weight, x, quant_dtype, residual, scale_ub)
