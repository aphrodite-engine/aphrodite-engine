...
def test_flex_attention_vs_default_backend(aphrodite_runner, monkeypatch):
    ...
    with monkeypatch.context() as m:
        m.setenv("APHRODITE_ATTENTION_BACKEND", "FLEX_ATTENTION")
...
def test_encoder_flex_attention_vs_default_backend(aphrodite_runner, monkeypatch):
    """Test that FlexAttention produces the same outputs as the default backend.
