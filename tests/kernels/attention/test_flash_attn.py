...
def test_varlen_with_paged_kv(
    ...
    if q_dtype is not None and (dtype != torch.bfloat16 or fa_version == 2):
        pytest.skip("Flash attention with quantized inputs is only supported on version 3 with bfloat16 base type")
    set_random_seed(0)
...
def test_fa4_hd256_paged_call_shape(
    ...
    from aphrodite.v1.attention.backends.fa_utils import FA4_HD256_PAGE_SIZE
    ...
    block_tables = torch.randint(0, num_blocks, (len(seq_lens), num_pages + 3), dtype=torch.int32)
