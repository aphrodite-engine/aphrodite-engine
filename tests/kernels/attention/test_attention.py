...
@pytest.mark.skipif(not current_platform.is_rocm(), reason="ROCm-only paged attention kernel")
...
def test_paged_attention(
    ...
    if current_platform.is_navi() and (kv_cache_dtype == "fp8" or head_size != 128 or block_size != 16 or use_alibi):
        pytest.skip()
...
def test_paged_attention_unsupported_head_sizes(kv_cache_factory, head_size: int) -> None:
