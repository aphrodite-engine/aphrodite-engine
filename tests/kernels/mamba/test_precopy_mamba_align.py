...
from aphrodite.model_executor.layers.mamba import mamba_utils as layer_mamba_utils
from aphrodite.platforms import current_platform
from aphrodite.v1.worker import mamba_utils as worker_mamba_utils
from aphrodite.v1.worker.mamba_utils import _TEMPORAL_TILES, precopy_mamba_align_fused_kernel
...
def test_preprocess_fused_align_matches_scalar_bookkeeping(monkeypatch, token_bias):
    ...
    monkeypatch.setattr(worker_mamba_utils, "do_mamba_copy_block", lambda copy_bufs: None)
...
if __name__ == "__main__":
    ...
    for nr, tb, mapping, dim_first, tt in _CASES:
        ...
        print(
            f"OK num_reqs={nr} token_bias={tb} has_idx_mapping={mapping} conv_dim_first={dim_first} temporal_tiles={tt}"
        )
