...
def _pplx_moe(
    ...
    try:
        ...
        with set_current_aphrodite_config(aphrodite_config), override_config(moe_config):
            topk_weight, topk_ids, _ = fused_topk(a, score, topk, False)
...
def _pplx_test_loop(
    ...
    if use_shared_experts:
        ...
        new_aphrodite_config = copy.deepcopy(aphrodite_config)
        new_aphrodite_config.parallel_config.data_parallel_size = pgi.world_size
        new_aphrodite_config.parallel_config.enable_expert_parallel = True
