...
def test_zero_expert_moe_forward(zero_expert_moe, num_tokens):
    """Run a forward pass through FusedMoEFactory with zero experts and verify output shape."""
...
def test_zero_expert_moe_output_decomposition(zero_expert_moe, num_tokens):
    ...
    torch.testing.assert_close(
        ...
        atol=4e-3,
        rtol=4e-3,
        msg="FusedMoEFactory output should equal plain FusedMoEFactory output plus zero expert contribution",
    )
