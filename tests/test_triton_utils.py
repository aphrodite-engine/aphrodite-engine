...
from aphrodite.triton_utils import importing as triton_importing
...
def test_no_triton_fallback():
    ...
    sys.modules.pop("aphrodite.triton_utils", None)
    sys.modules.pop("aphrodite.triton_utils.importing", None)
