...
def test_fused_input_norm_matches_reference(num_patches: int):
    ...
    set_random_seed(0)
    pixel_values = torch.randint(0, 256, (num_patches, channel * patch_size), dtype=torch.float32)
    ...
    expected = _reference_input_norm(pixel_values, image_mean, image_std, rescale_factor, channel, torch.float32)
