...
def test_qwen4_exp_model_state_prepares_ngram_context() -> None:
    ...
    torch.testing.assert_close(model_inputs["query_start_loc"], expected_query_start_loc)
...
def test_qwen4_exp_model_state_prepares_stable_dummy_ngram_inputs() -> None:
    ...
    torch.testing.assert_close(second["ngram_context"], torch.full((8, 3), 99, dtype=torch.int32))
