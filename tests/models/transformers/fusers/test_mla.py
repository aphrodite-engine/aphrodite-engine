...
from aphrodite.model_executor.models.transformers.fusers import MLAFuser
...
def test_q_lora_stacks_qkv_a_proj():
    ...
    assert fuser.packed_modules_mapping == {_FUSED_QKV_A_PROJ: ["q_a_proj", "kv_a_proj_with_mqa"]}
...
class RenamedMLA(nn.Module):
    ...
    def forward(self, hidden_states):
        ...
        kv_lora, k_pe = torch.split(self.beta(hidden_states), [self.kv_lora, self.rope], dim=-1)
