...
from aphrodite.models.deepseek_v32.nvidia import model as deepseek_v32_model
from aphrodite.models.deepseek_v32.nvidia import mtp as deepseek_v32_mtp
...
def test_mtp_projects_sequence_shard_and_restores_full_output(monkeypatch):
    ...
    norm = Mock(side_effect=lambda hidden_states, residual: (hidden_states + residual, None))
