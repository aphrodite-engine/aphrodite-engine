...
def aphrodite_model(aphrodite_runner):
    with aphrodite_runner(MODEL_NAME, runner="pooling", max_model_len=max_model_len) as model:
        yield model
...
def test_max_truncation_size(aphrodite_model):
