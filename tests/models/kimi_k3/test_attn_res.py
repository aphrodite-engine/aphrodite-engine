...
from aphrodite.models.kimi_k3.common.mtp import fused_mtp_input
...
MAX_BLOCKS = 8
EPS = 1e-5
attn_res_module = importlib.import_module("aphrodite.models.kimi_k3.nvidia.ops.attn_res")
...
def test_sm100_variants_do_not_fall_back_to_triton(
    ...
    if not current_platform.is_device_capability_family(100) or not hasattr(torch.ops._C, "kimi_k3_attn_res"):
...
def test_fused_mtp_input(num_tokens: int):
    ...
    previous_hidden_states = _randn_with_row_padding(num_tokens, HIDDEN_SIZE, padding=11)
