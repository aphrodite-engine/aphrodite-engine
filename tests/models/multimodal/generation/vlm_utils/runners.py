    ...
    *,
    ...
    inputs = list(
        itertools.chain.from_iterable(
            builders.build_single_image_inputs_from_test_info(model_test_info, image_assets, size_wrapper, tmp_path)
...
def run_multi_image_test(
    *,
    ...
    inputs = list(
        itertools.chain.from_iterable(
            builders.build_multi_image_inputs_from_test_info(model_test_info, image_assets, size_wrapper, tmp_path)
            for size_wrapper in test_case.size_wrappers
        )
    )
...
def run_embedding_test(
    *,
    ...
    inputs_and_embeddings = [
        builders.build_embedding_inputs_from_test_info(model_test_info, image_assets, size_wrapper)
        for size_wrapper in test_case.size_wrappers
    ]
    inputs = list(itertools.chain.from_iterable(inputs for inputs, _ in inputs_and_embeddings))
    aphrodite_embeddings = list(itertools.chain.from_iterable(embeddings for _, embeddings in inputs_and_embeddings))
