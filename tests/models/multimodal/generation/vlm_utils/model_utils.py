...
from aphrodite.transformers_utils.tokenizer import patch_padding_side
...
def blip2_aphrodite_to_hf_output(aphrodite_output: RunnerOutput,
...
def fuyu_aphrodite_to_hf_output(aphrodite_output: RunnerOutput,
                           model: str) -> RunnerOutput:
...
def llava_image_aphrodite_to_hf_output(aphrodite_output: RunnerOutput,
                                  model: str) -> RunnerOutput:
...
def _llava_aphrodite_to_hf_output(aphrodite_output: RunnerOutput, model: str,
...
def llava_onevision_aphrodite_to_hf_output(aphrodite_output: RunnerOutput,
                                      model: str) -> RunnerOutput:
...
def mantis_aphrodite_to_hf_output(aphrodite_output: RunnerOutput,
                             model: str) -> RunnerOutput:
    """Sanitize aphrodite output [mantis] to compare with hf output."""
    output_ids, output_str, out_logprobs = aphrodite_output
...
def phi3v_aphrodite_to_hf_output(aphrodite_output: RunnerOutput,
                            model: str) -> RunnerOutput:
...
def paligemma_aphrodite_to_hf_output(aphrodite_output: RunnerOutput,
                                model: str) -> RunnerOutput:
