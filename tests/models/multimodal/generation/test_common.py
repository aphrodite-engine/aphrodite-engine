...
image, embedding, and video support for different VLMs in Aphrodite.
"""
import math
import os
...
from aphrodite.common.utils import identity

from ....conftest import (IMAGE_ASSETS, HfRunner, ImageTestAssets,
                          VideoTestAssets, AphroditeRunner)
...
VLM_TEST_SETTINGS = {
    ...
    "paligemma": VLMTestInfo(
        ...
        dtype="bfloat16",
        marks=[pytest.mark.skip(reason="Aphrodite does not support PrefixLM attention mask")],  # noqa: E501
    ),
...
def test_video_models(model_type: str, test_case: ExpandableVLMTestArgs,
                      hf_runner: type[HfRunner], aphrodite_runner: type[AphroditeRunner],
