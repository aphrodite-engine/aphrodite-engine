...
def test_ppl(hf_runner, aphrodite_runner, model_info: GenerateModelInfo, mm_device_do_normalize: bool):
    vqa_ppl_test(
        hf_runner,
        aphrodite_runner,
        model_info,
        aphrodite_extra_kwargs={"mm_device_do_normalize": mm_device_do_normalize},
