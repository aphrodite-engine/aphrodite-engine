...
from aphrodite.model_executor.models.cohere_asr import CohereAsrForConditionalGeneration
...
def test_get_num_audio_tokens_streaming_estimate(audio_duration_s, expected_tokens):
    ...
    got = CohereAsrForConditionalGeneration.get_num_audio_tokens(audio_duration_s, stt_config, model_config)
