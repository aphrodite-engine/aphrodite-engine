...
from aphrodite.model_executor.models.deepseek_ocr import DeepseekOCRImagePixelInputs
from aphrodite.transformers_utils.processors.deepseek_ocr import DeepseekOCRProcessor
