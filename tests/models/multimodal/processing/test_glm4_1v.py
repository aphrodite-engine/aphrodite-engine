...
from aphrodite.multimodal.video import DynamicVideoBackend, VideoBackend
...
def test_get_max_video_frames_matches_glm_resize(
    ...
    info._get_vision_info.side_effect = lambda **kwargs: (Glm4vProcessingInfo._get_vision_info(info, **kwargs))
