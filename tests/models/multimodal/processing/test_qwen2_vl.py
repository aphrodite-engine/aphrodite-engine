...
from aphrodite.model_executor.models.vision import FusedInputNorm
from aphrodite.multimodal import MULTIMODAL_REGISTRY
from aphrodite.multimodal.cache import MultiModalProcessorOnlyCache
from aphrodite.multimodal.inputs import batched_tensors_equal
...
@pytest.mark.parametrize("model_id", ["Qwen/Qwen2-VL-2B-Instruct", "Qwen/Qwen2.5-VL-3B-Instruct"])
@pytest.mark.parametrize("num_imgs", [1, 2])
def test_mm_device_do_normalize(
    ...
    pixel_values_with_normalize = processed_inputs_with_normalize["mm_kwargs"].get_data()["pixel_values"]
    ...
    pixel_values_without_normalize = processed_inputs_without_normalize["mm_kwargs"].get_data()["pixel_values"]
    ...
    pixel_values_do_input_norm = input_norm(pixel_values_without_normalize.to(dtype), dtype)
