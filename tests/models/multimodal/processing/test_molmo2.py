...
from aphrodite.model_executor.models.molmo2 import (
...
def test_dummy_video_num_frames_override_honors_min_of_two(num_frames_override, expected_frames):
    ...
    builder.info = SimpleNamespace(
        get_hf_processor=lambda: SimpleNamespace(video_processor=SimpleNamespace(size={"width": 64, "height": 64})),
