...
from aphrodite.model_executor.models.transformers.base import Base as TransformersBase
...
def test_cosmos3_edge_checkpoint_weights_mapper():
    ...
    mapper = Cosmos3EdgeForConditionalGeneration.hf_to_aphrodite_mapper
