...
class _HfExamplesInfo:
    ...
    v0_only: bool = False
    """The model is only available with the Aphrodite V0 engine."""
...
_TEXT_GENERATION_EXAMPLE_MODELS = {
    ...
    "Plamo2ForCausalLM": _HfExamplesInfo("pfnet/plamo-2-1b",
                                         ...
                                         transformers_version_reason="Aphrodite impl inherits PreTrainedModel and clashes with get_input_embeddings",  # noqa: E501
                                        trust_remote_code=True),
...
_SPECULATIVE_DECODING_EXAMPLE_MODELS = {
    "MedusaModel": _HfExamplesInfo("JackFram/llama-68m",
                                   speculative_model="abhigoyal/aphrodite-medusa-llama-68m-random"),  # noqa: E501
