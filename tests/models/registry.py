...
_MULTIMODAL_EXAMPLE_MODELS = {
    ...
    "FireRedASR2ForConditionalGeneration": _HfExamplesInfo(
        "allendou/FireRedASR2-LLM-aphrodite",
        trust_remote_code=True,
    ...
    "FireRedLIDForConditionalGeneration": _HfExamplesInfo(
        "PatchyTisa/FireRedLID-aphrodite",
        trust_remote_code=True,
        max_transformers_version="5.1",
        transformers_version_reason={
            "aphrodite": "Incompatible with transformers v5.2+ (dict object has no attribute '__name__').",
    ...
    "FunASRForConditionalGeneration": _HfExamplesInfo(
        "allendou/Fun-ASR-Nano-2512-aphrodite",
        trust_remote_code=True,
        max_transformers_version="5.1",
        transformers_version_reason={
            "aphrodite": "Incompatible with transformers v5.2+ (dict object has no attribute '__name__').",
...
_SPECULATIVE_DECODING_EXAMPLE_MODELS = {
    ...
    "MedusaModel": _HfExamplesInfo(
        "JackFram/llama-68m", speculative_model="abhigoyal/aphrodite-medusa-llama-68m-random"
    ),
