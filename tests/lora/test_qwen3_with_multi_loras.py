...
def set_mrv2_env():
    original = os.environ.get("APHRODITE_USE_V2_MODEL_RUNNER", "0")
    os.environ["APHRODITE_USE_V2_MODEL_RUNNER"] = "1"
    yield

    if original is None:
        os.environ.pop("APHRODITE_USE_V2_MODEL_RUNNER", None)
    else:
        os.environ["APHRODITE_USE_V2_MODEL_RUNNER"] = original
