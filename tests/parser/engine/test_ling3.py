...
def test_ling3_defaults_thinking_on():
    ...
    reasoning, content = parser.extract_reasoning("<think>reason</think>answer", _test_request())
...
def test_ling3_enable_thinking_keeps_open_reasoning_as_content():
    ...
    reasoning, content = parser.extract_reasoning("<think>only reasoning", _test_request())
