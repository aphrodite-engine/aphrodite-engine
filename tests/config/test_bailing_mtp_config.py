...
from aphrodite.config.speculative import MTPModelTypes, SpeculativeConfig
...
def test_bailing_hybrid_mtp_model_arch_config():
    ...
    model_arch_config = BailingHybridMTPModelArchConfigConvertor(config, config).convert()
