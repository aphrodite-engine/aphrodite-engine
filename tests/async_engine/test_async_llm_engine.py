...
class MockAsyncLLMEngine(AsyncAphrodite):
...
def start_engine():
    ...
    return AsyncAphrodite.from_engine_args(
...
async def async_engine():
    ...
    previous_value = os.getenv("APHRODITE_USE_V1", None)
    ...
    try:
        ...
        if previous_value:
            os.environ["APHRODITE_USE_V1"] = previous_value
        else:
            del os.environ["APHRODITE_USE_V1"]
