...
from aphrodite.plugins.lora_resolvers.hf_hub_resolver import HfHubResolver
...
LIB_DOWNLOAD_DIR = os.path.join(HF_HUB_CACHE, "models--ibm-granite--granite-3.3-8b-rag-agent-lib")
...
REPO_DOWNLOAD_DIR = os.path.join(HF_HUB_CACHE, "models--yard1--llama-2-7b-sql-lora-test")
...
async def test_nonlora_adapter():
    ...
    readme_request = await hf_resolver.resolve_lora(LORA_LIB_MODEL_NAME, NON_LORA_SUBPATH)
