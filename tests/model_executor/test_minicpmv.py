...
from aphrodite.model_executor.models.minicpmv import MiniCPMV2_6
from aphrodite.model_executor.models.minicpmv4_6 import (
...
def make_model_4_6() -> MiniCPMV4_6ForConditionalGeneration:
    ...
    model._process_vision_input = lambda vision_input, use_vit_merger=None: [vision_input["image_embeds"]]
    return model
