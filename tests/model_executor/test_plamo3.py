...
from aphrodite.model_executor.models import plamo3 as plamo3_mod
...
def test_plamo3_returns_dflash_selected_auxiliary_hidden_states(monkeypatch):
    ...
    spec_config = SimpleNamespace(
        draft_model_config=SimpleNamespace(hf_config=SimpleNamespace(dflash_config={"target_layer_ids": [0, 1]}))
    )
