...
def _mm_config(
    *,
    ...
    video_kwargs: dict[str, object] = {} if video_backend is None else {"video_backend": video_backend}
...
def _pynvvideocodec_decoder_budget(
    ...
    return api_process_count * (
        PYNVVIDEOCODEC_DECODER_GPU_MEMORY_BYTES * hw_decoders + PYNVVIDEOCODEC_CUDA_CONTEXT_BYTES
    )
