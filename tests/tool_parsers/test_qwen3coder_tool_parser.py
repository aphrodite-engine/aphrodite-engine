...
from aphrodite.tool_parsers.qwen3_engine_tool_parser import (
...
true
    ...
    assert args["query"] == "aphrodite tool parser"
...
class TestParameterWhitespace:
    ...
    def test_whitespace_preserved(self, qwen3_tokenizer):
        ...
        request = ChatCompletionRequest(model=MODEL, messages=[], tools=WRITE_FILE_TOOLS)
    ...
    def test_whitespace_preserved_streaming(self, qwen3_tokenizer):
        ...
        streamed = ""
        for delta_message in stream_delta_message_generator(parser, qwen3_tokenizer, WRITE_FILE_OUTPUT, request):
