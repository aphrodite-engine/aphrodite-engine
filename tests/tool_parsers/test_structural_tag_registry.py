...
def test_kimi_k3_registered_as_aphrodite_builtin():
    assert "kimi_k3" in APHRODITE_BUILTIN_STRUCTURAL_TAG_MODELS
...
@pytest.mark.parametrize(
    ...
    [
        # single required arg
        _k3_response() + _k3_tools(_k3_call("get_weather", _k3_arg("city", "string", "Paris"))),
        ...
        _k3_response() + _k3_tools(_k3_call("run_command", _k3_arg("command", "string", "grep -E 'a|b{2,}' x.py"))),
        # trailing message-close marker (model's natural turn terminator)
        _k3_response() + _k3_tools(_k3_call("get_weather", _k3_arg("city", "string", "Paris"))) + _K3_MESSAGE_CLOSE,
        # non-thinking mode: response-open is the prompt prefix, so it is absent
        _K3_RESPONSE_CLOSE + _k3_tools(_k3_call("get_weather", _k3_arg("city", "string", "Paris"))),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # unknown tool name
        _k3_response() + _k3_tools(_k3_call("get_temperature", _k3_arg("city", "string", "x"))),
        # number arg given a non-numeric JSON value
        _k3_response() + _k3_tools(_k3_call("get_weather", _k3_arg("days", "number", "abc"))),
        ...
        _k3_response() + _K3_TOOLS_OPEN + _k3_call("get_weather", _k3_arg("city", "string", "Paris")),
...
def test_kimi_k3_string_enum_accepts_exact_values(value: str):
    ...
    body = _k3_response() + _k3_tools(_k3_call("set_unit", _k3_arg("unit", "string", value)))
    assert _is_grammar_accept_string(grammar, body)
...
def test_kimi_k3_string_maxlength_bounds_raw_channel():
    ...
    def body(val: str) -> str:
        return _k3_response() + _k3_tools(_k3_call("set_note", _k3_arg("note", "string", val)))
...
def test_kimi_k3_forced_tool_choice_builds_single_mandatory_call():
    ...
    ok = _k3_response() + _k3_tools(_k3_call("get_weather", _k3_arg("city", "string", "Paris")))
