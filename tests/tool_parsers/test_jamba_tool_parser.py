...
from aphrodite.entrypoints.generate.base.protocol import DeltaMessage, FunctionCall, ToolCall
...
from aphrodite.tool_parsers.jamba_tool_parser import JambaToolParser
