...
def use_v0_only(monkeypatch: pytest.MonkeyPatch):
    """
    This module relies on V0 internals, so set APHRODITE_USE_V1=0.
    """
...
def test_mixed_requests(
    ...
    with monkeypatch.context() as m:
        ...
        with aphrodite_runner(
            ...
            req_outputs = aphrodite_model.model.generate(example_prompts,
                                                    greedy_params)
    ...
    with monkeypatch.context() as m:
        ...
        with aphrodite_runner(
            ...
            for prompt in UNSTABLE_PROMPT_SEQUENCE:
                aphrodite_model.generate(TokensPrompt(prompt_token_ids=prompt),
...
def test_fully_cached_prefill_needs_uncached_token(model):
    ...
    engine: AphroditeEngine = runner.model.llm_engine
