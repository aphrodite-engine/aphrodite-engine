...
def run_model(
    ...
    location_coords = torch.tensor(location_coords[0]).unsqueeze(0) if location_coords else None
...
def create_visualization(pred_file: str, output_dir: str, data_file: str):
    """Create a PNG visualization of the prediction TIFF file."""
