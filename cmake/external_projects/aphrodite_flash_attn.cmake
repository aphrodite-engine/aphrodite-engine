...
#
# IMPORTANT: This has to be the last thing we do, because aphrodite-flash-attn
# uses the same macros/functions as Aphrodite.
# Because functions all belong to the global scope, aphrodite-flash-attn's
# functions overwrite Aphrodite's.
# They should be identical but if they aren't, this is a massive footgun.
#
# The aphrodite-flash-attn install rules are nested under aphrodite to make
# sure the library gets installed in the correct place.
# To only install aphrodite-flash-attn, use --component _vllm_fa2_C (for FA2),
# --component _vllm_fa3_C (for FA3),
...
# If APHRODITE_FLASH_ATTN_SRC_DIR is set, aphrodite-flash-attn is installed
# from that directory instead of downloading. This is to enable local
# development of aphrodite-flash-attn within Aphrodite.
...
elseif(DEFINED ENV{APHRODITE_FLASH_ATTN_SRC_DIR})
  set(APHRODITE_FLASH_ATTN_SRC_DIR $ENV{APHRODITE_FLASH_ATTN_SRC_DIR})
endif()
