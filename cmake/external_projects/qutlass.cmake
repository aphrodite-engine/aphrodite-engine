...
if(QUTLASS_SRC_DIR)
  ...
  string(SHA256 _qutlass_cache_key "${_QUTLASS_UPSTREAM_TAG}")
  string(SUBSTRING "${_qutlass_cache_key}" 0 12 _qutlass_cache_key)
  set(_qutlass_src "${_qutlass_fc_root}/qutlass-${_qutlass_cache_key}-src")
  set(_qutlass_bin "${_qutlass_fc_root}/qutlass-${_qutlass_cache_key}-build")
  set(_qutlass_sub "${_qutlass_fc_root}/qutlass-${_qutlass_cache_key}-subbuild")
...
if(${CMAKE_CUDA_COMPILER_VERSION} VERSION_GREATER_EQUAL 12.8 AND QUTLASS_ARCHS)
  ...
  elseif(EXISTS "${qutlass_SOURCE_DIR}/qutlass/third_party/cutlass/include/cutlass/cutlass.h")
    ...
    message(STATUS "[QUTLASS] Using QuTLASS vendored CUTLASS headers (no Aphrodite CUTLASS detected).")
  else()
