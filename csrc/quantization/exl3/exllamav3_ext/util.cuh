...
typedef struct __align__(8) half4 {
  ...
  __device__ half4(half h0, half h1, half h2, half h3)
      : x(__halves2half2(h0, h1)), y(__halves2half2(h2, h3)) {}
} half4;
...
typedef struct __align__(8) bfloat164 {
  ...
  __device__ bfloat164(__nv_bfloat16 b0, __nv_bfloat16 b1, __nv_bfloat16 b2,
                       __nv_bfloat16 b3)
      : x(__halves2bfloat162(b0, b1)), y(__halves2bfloat162(b2, b3)) {}
} bfloat164;
...
typedef struct __align__(16) half8 {
  ...
  __device__ half8(half2 x_, half2 y_, half2 z_, half2 w_)
      : x(x_), y(y_), z(z_), w(w_) {}
  __device__ half8(half h0, half h1, half h2, half h3, half h4, half h5,
                   half h6, half h7)
