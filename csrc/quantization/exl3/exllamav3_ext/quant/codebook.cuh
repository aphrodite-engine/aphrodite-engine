...
// Force integer MAD on sm<=86. For some reason this performs better than
// letting the compiler emit IMUL
// TODO: Keep an eye on new behavior in future versions of nvcc. While this is
// faster on RTX 3090, it really shouldn't be.
template <uint32_t w>
