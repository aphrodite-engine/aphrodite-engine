...
use aphrodite_tokenizer::{DecodedText, Tokenizer};

/// Tokenizer stub used by unified-parser benchmarks.
struct BenchTokenizer;

impl Tokenizer for BenchTokenizer {
    fn encode(&self, text: &str, _add_special_tokens: bool) -> aphrodite_tokenizer::Result<Vec<u32>> {
