...
use aphrodite_engine_core_client::protocol::request::{EngineCoreRequest, ReasoningParserKwargs};
...
pub struct GenerateRequest {
    ...
    /// Optional multimodal features already prepared by `aphrodite-chat`.
