...
use crate::protocol::output::{
    ...
    EngineCoreOutputs, RequestBatchOutputs, UtilityCallOutput, decode_engine_core_outputs,
};
...
async fn client_fail_closes_when_main_output_path_receives_dp_control() {
    ...
    assert_eq!(client.aphrodite_version(), "test-aphrodite-version");
...
fn python_msgpack_fixtures_match_rust_encoding() {
    ...
    let kv_events_config = ready_response
        .kv_events_config
        .expect("KV events config should decode");
