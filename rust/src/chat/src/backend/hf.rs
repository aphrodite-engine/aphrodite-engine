...
use tracing::info;
use aphrodite_text::backend::hf::{HfTextBackend, ResolvedModelFiles, load_model_config};
use aphrodite_text::tokenizer::DynTokenizer;
use aphrodite_text::{DynTextBackend, TextBackend as _};
...
mod tests {
    ...
    use aphrodite_text::backend::hf::TokenizerSource;
    use aphrodite_text::tokenizer::DynTokenizer;
    ...
    ) -> aphrodite_text::backend::hf::ResolvedModelFiles {
