...
use aphrodite_engine_core_client::protocol::tensor::{ShapeExt as _, WireArrayData, WireTensor};
...
impl KwargValue {
    ...
    /// axis in the per-feature value, matching Aphrodite's batched-field semantics.
