...
use aphrodite_engine_core_client::protocol::multimodal::PlaceholderRange;
use aphrodite_engine_core_client::protocol::tensor::WireTensor;
...
mod tests {
    ...
    use aphrodite_engine_core_client::protocol::tensor::WireArrayData;
