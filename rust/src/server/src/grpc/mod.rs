...
//! gRPC Generate service backed by the shared [`aphrodite_text::TextLlm`] facade.
...
use tracing::info;
use aphrodite_text::{DecodedTextEvent, TextOutputStreamExt as _};

use self::convert::ResponseOpts;
use crate::state::AppState;

/// Generated protobuf/gRPC types for the `aphrodite` package.
pub mod pb {
    tonic::include_proto!("aphrodite");
}
