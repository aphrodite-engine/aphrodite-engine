...
#[derive(Debug, Parser)]
#[command(
    about = "Smoke-test the Rust OpenAI server with async-openai against an external Qwen Aphrodite engine."
)]
struct Args {
    #[arg(long)]
...
async fn stream_completion(
    ...
    // route tests and in the `aphrodite-chat` smoke example.
