...
/// Normalize Aphrodite's signed `top_k` domain into [`SamplingParams::top_k`].
///
/// Aphrodite uses both `-1` and `0` to disable top-k sampling. The text sampling
...
/// User-facing sampling parameters accepted by `aphrodite-text`.
///
