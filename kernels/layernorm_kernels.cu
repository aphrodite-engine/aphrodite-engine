...
void fused_add_rms_norm(torch::Tensor& input,     // [..., hidden_size]
  ...
  bool batch_invariant_launch = aphrodite::aphrodite_kernel_override_batch_invariant();
...
#define LAUNCH_FUSED_POLY_NORM(width)                                         \
  APHRODITE_DISPATCH_FLOATING_TYPES(input.scalar_type(), "poly_norm_kernel", [&] { \
    aphrodite::poly_norm_kernel<scalar_t, width><<<grid, block, 0, stream>>>(      \
