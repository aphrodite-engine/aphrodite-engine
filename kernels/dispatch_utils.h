...
#define APHRODITE_DISPATCH_CASE_BYTE_TYPES(...) \
  AT_DISPATCH_BYTE_CASE(at::ScalarType::Byte, __VA_ARGS__)

#define APHRODITE_DISPATCH_BYTE_TYPES(TYPE, NAME, ...) \
  AT_DISPATCH_SWITCH(TYPE, NAME, APHRODITE_DISPATCH_CASE_BYTE_TYPES(__VA_ARGS__))
