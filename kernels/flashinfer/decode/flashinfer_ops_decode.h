...
#include <../utils/attention/handler.cuh>
...
class BatchDecodeWithPagedKVCachePyTorchWrapper {
 public:
  void Plan(torch::Tensor float_workspace_buffer, torch::Tensor int_workspace_buffer,
  ...
  std::vector<torch::Tensor> Run(torch::Tensor q, std::optional<torch::Tensor> paged_kv_cache,
