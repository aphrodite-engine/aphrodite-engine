...
//
template <>
__device__ inline void dequant<half2, aphrodite::kU4B8.id()>(int q, half2* frag_b) {
...
template <>
__device__ inline void dequant<half2, aphrodite::kU4.id()>(int q, half2* frag_b) {
  const int LO = 0x000f000f;
  const int HI = 0x00f000f0;
  const int EX = 0x64006400;
  // Guarantee that the `(a & b) | c` operations are LOP3s.
...
template <>
__device__ inline void dequant<nv_bfloat162, aphrodite::kU4B8.id()>(
...
template <>
__device__ inline void dequant<nv_bfloat162, aphrodite::kU4.id()>(
    int q, nv_bfloat162* frag_b) {
  static constexpr uint32_t MASK = 0x000f000f;
  static constexpr uint32_t EX = 0x43004300;
...
//
template <>
__device__ inline void dequant<half2, aphrodite::kU8B128.id()>(int q,
                                                          half2* frag_b) {
...
template <>
__device__ inline void dequant<half2, aphrodite::kU8.id()>(int q, half2* frag_b) {
  static constexpr uint32_t mask_for_elt_01 = 0x5250;
  static constexpr uint32_t mask_for_elt_23 = 0x5351;
  static constexpr uint32_t start_byte_for_fp16 = 0x64646464;
...
template <>
__device__ inline void dequant<nv_bfloat162, aphrodite::kU8B128.id()>(
    int q, nv_bfloat162* frag_b) {
...
template <>
__device__ inline void dequant<nv_bfloat162, aphrodite::kU8.id()>(
    int q, nv_bfloat162* frag_b) {
  float fp32_intermediates[4];
  uint32_t* fp32_intermediates_casted =
      reinterpret_cast<uint32_t*>(fp32_intermediates);
...
template <>
__device__ inline void dequant<half2, aphrodite::kFE4M3fn.id()>(int q,
                                                           half2* frag_b) {
...
template <>
__device__ inline void dequant<nv_bfloat162, aphrodite::kFE4M3fn.id()>(
    int q, nv_bfloat162* frag_b) {
