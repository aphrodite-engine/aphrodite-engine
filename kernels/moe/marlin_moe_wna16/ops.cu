...
void marlin_mm(const void* A, const void* B, void* C, void* C_tmp, void* s,
  ...
  if (has_zp) {
    TORCH_CHECK(q_type == aphrodite::kU4,
                "q_type must be u4 when has_zp = True. Got = ", q_type.str());
  } else {
    TORCH_CHECK(q_type == aphrodite::kU4B8 || q_type == aphrodite::kU8B128 ||
                    q_type == aphrodite::kFE4M3fn,
