...
MarlinFuncPtr get_marlin_kernel(const aphrodite::ScalarType q_type,
  ...
  COMMON_GET_IF(aphrodite::kU4)
  COMMON_GET_IF(aphrodite::kU4B8)
  COMMON_GET_IF(aphrodite::kU8B128)

  NVFP4_GET_IF(aphrodite::kFE2M1f)

  BIGGROUP_GET_IF(aphrodite::kFE4M3fn)

  ACT_GET_IF(aphrodite::kU4B8)
  ACT_GET_IF(aphrodite::kU8B128)
  if (std::is_same<scalar_t, nv_bfloat16>::value) {
    if (false) {
    }
    MXFP4_GET_IF(aphrodite::kFE2M1f)
  }
...
void marlin_mm(const void* A, const void* B, void* C, void* C_tmp, void* b_bias,
               ...
               aphrodite::ScalarType const& q_type, bool has_bias,
  ...
  if (has_zp) {
    ...
    TORCH_CHECK(
        q_type == aphrodite::kU4B8 || q_type == aphrodite::kU8B128 ||
            q_type == aphrodite::kFE4M3fn || q_type == aphrodite::kFE2M1f,
...
torch::Tensor moe_wna16_marlin_gemm(
  ...
  if (global_scale_or_none.has_value()) {
    ...
    TORCH_CHECK(b_q_type == aphrodite::kFE2M1f && group_size == 16,
