...
if TYPE_CHECKING:
    ...
    APHRODITE_USE_CUTE_DSL_KERNELS: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Whether to use CuTE-DSL kernels
    "APHRODITE_USE_CUTE_DSL_KERNELS":
    lambda: bool(int(os.getenv("APHRODITE_USE_CUTE_DSL_KERNELS", "0"))),
}
