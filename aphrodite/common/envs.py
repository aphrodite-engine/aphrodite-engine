...
if TYPE_CHECKING:
    ...
    APHRODITE_BUILD_WITH_QAIC: bool = False
...
environment_variables: Dict[str, Callable[[], Any]] = {
    ...
    # If set, Aphrodite will build with QAIC support.
    "APHRODITE_BUILD_WITH_QAIC":
    lambda: bool(int(os.getenv("APHRODITE_BUILD_WITH_QAIC", "0"))),
}
