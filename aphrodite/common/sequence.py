...
def array_full(token_id: int, count: int):
    ...
    return array(APHRODITE_TOKEN_ID_ARRAY_TYPE, [token_id]) * count
...
class SequenceData(msgspec.Struct,
    ...
    def from_seqs(
        ...
        *,
        ...
        output_token_ids_arr = array(APHRODITE_TOKEN_ID_ARRAY_TYPE,
                                     output_token_ids)
...
class Sequence:
    ...
    [`DecoderOnlyInputs`][aphrodite.inputs.data.DecoderOnlyInputs] (for decoder-only)
    or [`EncoderDecoderInputs`][aphrodite.inputs.data.EncoderDecoderInputs]
