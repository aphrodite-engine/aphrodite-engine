...
from typing import (Any, AsyncGenerator, Awaitable, Callable, Dict, Generator,
                    Generic, Hashable, Iterable, List, Literal, Mapping,
...
def memory_profiling(
    ...
    baseline_memory_in_bytes: memory used by all the components other than
        the current Aphrodite instance. It contains: memory used by other processes, memory
        used by another Aphrodite instance in the same process, etc. It is usually measured
        before the current Aphrodite instance initialize the device. And we assume it is
        constant during the profiling of the current Aphrodite instance.
