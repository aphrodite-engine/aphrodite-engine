...
# 1. ArchConfig contains all fields from diffuser's/transformer's config.json
#    (i.e. all fields related to the architecture of the model)
...
class ModelConfig:
    ...
    # Aphrodite-specific parameters here
