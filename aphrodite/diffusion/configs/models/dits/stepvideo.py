...
from aphrodite.diffusion.configs.models.dits.base import DiTArchConfig, DiTConfig
...
class StepVideoArchConfig(DiTArchConfig):
    ...
    norm_eps: float = 1e-6
    caption_channels: int | list[int] | tuple[int, ...] | None = field(default_factory=lambda: [6144, 1024])
