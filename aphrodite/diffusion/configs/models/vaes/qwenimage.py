...
from aphrodite.diffusion.configs.models.vaes.base import VAEArchConfig, VAEConfig
...
class QwenImageVAEConfig(VAEConfig):
    ...
    def post_init(self):
        self.arch_config.vae_scale_factor = 2 ** (len(self.arch_config.temperal_downsample))
