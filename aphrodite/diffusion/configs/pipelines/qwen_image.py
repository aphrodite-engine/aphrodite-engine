...
from aphrodite.diffusion.configs.models.dits.qwenimage import QwenImageDitConfig
from aphrodite.diffusion.configs.models.encoders.qwen_image import Qwen2_5VLConfig
from aphrodite.diffusion.configs.models.vaes.qwenimage import QwenImageVAEConfig
...
def qwen_image_postprocess_text(outputs, _text_inputs, drop_idx=34):
    ...
    split_hidden_states = _extract_masked_hidden(hidden_states, _text_inputs.attention_mask)
...
class QwenImagePipelineConfig(PipelineConfig):
    ...
    # Text encoding stage
    text_encoder_configs: tuple[EncoderConfig, ...] = field(default_factory=lambda: (Qwen2_5VLConfig(),))
    ...
    def prepare_pos_cond_kwargs(self, batch, device, rotary_emb, dtype):
        ...
        return {
            ...
            "freqs_cis": QwenImagePipelineConfig.get_freqs_cis(img_shapes, txt_seq_lens, rotary_emb, device, dtype),
        }
