...
from aphrodite.diffusion.runtime.architectures.preprocess.preprocess_pipeline_base import (
    BasePreprocessPipeline,
)
from aphrodite.diffusion.runtime.models.schedulers.scheduling_self_forcing_flow_match import (
        ...
        for batch_idx, data in enumerate(self.pbar):
            ...
            with torch.inference_mode():
                ...
                for i, (prompt_embed, prompt_attention_mask) in enumerate(
                    ...
                    result_batch = self.latent_preparation_stage(result_batch, server_args)
