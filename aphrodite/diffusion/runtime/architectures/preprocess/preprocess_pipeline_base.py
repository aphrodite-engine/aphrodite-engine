...
import torch
from aphrodite.diffusion.dataset import getdataset
from aphrodite.diffusion.dataset.dataloader.parquet_io import (
    ParquetDatasetWriter,
    records_to_table,
)
from aphrodite.diffusion.dataset.preprocessing_datasets import PreprocessBatch
...
class BasePreprocessPipeline(ComposedPipelineBase):
    ...
    def get_extra_features(self, valid_data: dict[str, Any], server_args: ServerArgs) -> dict[str, Any]:
