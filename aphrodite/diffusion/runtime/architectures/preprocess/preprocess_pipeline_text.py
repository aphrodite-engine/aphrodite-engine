...
import torch
from aphrodite.diffusion.dataset import gettextdataset
from aphrodite.diffusion.dataset.dataloader.parquet_io import (
...
from aphrodite.diffusion.dataset.dataloader.schema import pyarrow_schema_text_only
from aphrodite.diffusion.runtime.pipelines.preprocess.preprocess_pipeline_base import (
...
from aphrodite.diffusion.runtime.pipelines.stages import TextEncodingStage
...
class PreprocessPipeline_Text(BasePreprocessPipeline):
    ...
    # Text-only record creation moved to aphrodite.diffusion.dataset.dataloader.record_schema
