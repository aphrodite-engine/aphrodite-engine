...
from aphrodite.diffusion import PipelineConfig
from aphrodite.diffusion.configs.models.vaes import WanVAEConfig
from aphrodite.diffusion.runtime.architectures.preprocess.preprocess_pipeline_i2v import (
    PreprocessPipeline_I2V,
)
from aphrodite.diffusion.runtime.architectures.preprocess.preprocess_pipeline_ode_trajectory import (
    PreprocessPipeline_ODE_Trajectory,
)
from aphrodite.diffusion.runtime.architectures.preprocess.preprocess_pipeline_t2v import (
    PreprocessPipeline_T2V,
)
from aphrodite.diffusion.runtime.architectures.preprocess.preprocess_pipeline_text import (
...
from aphrodite.diffusion.runtime.utils.hf_diffusers_utils import maybe_download_model
...
def main(args) -> None:
    ...
    if args.preprocess_task == "t2v":
        ...
        raise ValueError(
            f"Invalid preprocess task: {args.preprocess_task}. Valid options: t2v, i2v, ode_trajectory, text_only"
        )
