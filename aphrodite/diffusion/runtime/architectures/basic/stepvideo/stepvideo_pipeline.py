...
from aphrodite.diffusion.runtime.models.encoders.bert import (
    HunyuanClip,  # type: ignore
)
from aphrodite.diffusion.runtime.models.encoders.stepllm import STEP1TextEncoder
...
class StepVideoPipeline(LoRAPipeline, ComposedPipelineBase):
    ...
    def build_llm(self, model_dir, device) -> torch.nn.Module:
        text_encoder = STEP1TextEncoder(model_dir, max_length=320).to(torch.bfloat16).eval()
        return text_encoder
