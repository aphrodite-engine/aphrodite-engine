...
# isort: on
from aphrodite.diffusion.runtime.models.schedulers.scheduling_flow_unipc_multistep import (
...
class WanImageToVideoPipeline(LoRAPipeline, ComposedPipelineBase):
    ...
    def initialize_pipeline(self, server_args: ServerArgs):
        self.modules["scheduler"] = FlowUniPCMultistepScheduler(shift=server_args.pipeline_config.flow_shift)
