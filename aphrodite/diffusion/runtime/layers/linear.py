...
# yapf: disable
from aphrodite.diffusion.runtime.models.parameter import (
    BasevLLMParameter,
...
# yapf: enable
from aphrodite.diffusion.runtime.models.utils import set_weight_attrs
...
class UnquantizedLinearMethod(LinearMethodBase):
    ...
    def apply(self, layer: torch.nn.Module, x: torch.Tensor, bias: torch.Tensor | None = None) -> torch.Tensor:
        # NOTE: this line assumes that we are using amp when using cuda and is needed
        # to account for the fact that amp isn't supported in mps
        output = (
