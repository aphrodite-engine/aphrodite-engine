...
from aphrodite.diffusion.utils import get_mixed_precision_state
...
class BaseLayerWithLoRA(nn.Module):
    ...
    def merge_lora_weights(self) -> None:
        ...
        if isinstance(self.base_layer.weight, DTensor):
            ...
            data += self.slice_lora_b_weights(self.lora_B).to(data) @ self.slice_lora_a_weights(self.lora_A).to(data)
