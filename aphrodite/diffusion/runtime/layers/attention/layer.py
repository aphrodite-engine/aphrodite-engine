...
from aphrodite.diffusion.runtime.layers.attention.selector import (
    backend_name_to_enum,
    get_attn_backend,
)
from aphrodite.diffusion.runtime.layers.usp import (
...
from aphrodite.diffusion.utils import get_compute_dtype
...
class UlyssesAttention_VSA(UlyssesAttention):
    ...
    def forward(
        ...
        output = self.attn_impl.forward(q, k, v, gate_compress=gate_compress, attn_metadata=ctx_attn_metadata)  # type: ignore[call-arg]
