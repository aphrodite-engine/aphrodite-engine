...
from aphrodite.diffusion.configs.pipelines import WanI2V480PConfig
from aphrodite.diffusion.configs.pipelines.qwen_image import (
    QwenImageEditPipelineConfig,
)
from aphrodite.diffusion.runtime.models.vision_utils import load_image, load_video
...
from aphrodite.diffusion.utils import best_output_size
...
class InputValidationStage(PipelineStage):
    ...
    def forward(
        ...
        if isinstance(server_args.pipeline_config, QwenImageEditPipelineConfig):
            ...
            width, height = server_args.pipeline_config.set_width_and_height(height, width, batch.pil_image)
            batch.width = width
            batch.height = height
        elif (
            server_args.pipeline_config.ti2v_task or server_args.pipeline_config.ti2i_task
            ...
            vae_stride = server_args.pipeline_config.vae_config.arch_config.scale_factor_spatial
    ...
    def verify_input(self, batch: Req, server_args: ServerArgs) -> VerificationResult:
        ...
        result.add_check("num_videos_per_prompt", batch.num_outputs_per_prompt, V.positive_int)
        result.add_check(
            "prompt_or_embeds",
            None,
