...
class TimestepPreparationStage(PipelineStage):
    ...
    def __init__(
        self,
        scheduler,
        prepare_extra_set_timesteps_kwargs: list[Callable[[Req, ServerArgs], tuple[str, Any]]] | None = None,
    ) -> None:
        self.scheduler = scheduler
        self.prepare_extra_set_timesteps_kwargs = (
            prepare_extra_set_timesteps_kwargs if prepare_extra_set_timesteps_kwargs is not None else []
        )
