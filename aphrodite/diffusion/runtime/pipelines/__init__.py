...
"""
Diffusion pipelines for aphrodite.diffusion.
...
from aphrodite.diffusion.runtime.pipelines.pipeline_registry import (
    PipelineType,
...
def build_pipeline(
    ...
    pipeline_cls = pipeline_registry.resolve_pipeline_cls(pipeline_name, pipeline_type, server_args.workload_type)
