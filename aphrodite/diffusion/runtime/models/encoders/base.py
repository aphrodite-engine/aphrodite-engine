...
class TextEncoder(nn.Module, ABC):
    ...
    _supported_attention_backends: set[AttentionBackendEnum] = TextEncoderConfig()._supported_attention_backends
...
class ImageEncoder(nn.Module, ABC):
    _supported_attention_backends: set[AttentionBackendEnum] = ImageEncoderConfig()._supported_attention_backends
