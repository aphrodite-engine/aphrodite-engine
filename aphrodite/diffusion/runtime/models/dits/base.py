...
from aphrodite.diffusion.configs.models import DiTConfig
...
class BaseDiT(nn.Module, ABC):
    ...
    _supported_attention_backends: set[AttentionBackendEnum] = DiTConfig()._supported_attention_backends
