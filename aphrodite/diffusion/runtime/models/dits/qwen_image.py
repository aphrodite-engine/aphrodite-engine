...
from aphrodite.diffusion.runtime.layers.layernorm import LayerNorm, RMSNorm
...
class QwenImageTransformer2DModel(CachableDiT):
    ...
    def __init__(
        ...
        self.rotary_emb = QwenEmbedRope(theta=10000, axes_dim=list(axes_dims_rope), scale_rope=True)
