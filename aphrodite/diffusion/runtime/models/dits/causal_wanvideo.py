...
from aphrodite.diffusion.configs.models.dits import WanVideoConfig  # noqa: E402
from aphrodite.diffusion.runtime.distributed.parallel_state import get_sp_world_size  # noqa: E402
from aphrodite.diffusion.runtime.layers.attention import LocalAttention  # noqa: E402
from aphrodite.diffusion.runtime.layers.layernorm import (  # noqa: E402
    FP32LayerNorm,
    LayerNormScaleShift,
    RMSNorm,
    ScaleResidual,
...
from aphrodite.diffusion.runtime.layers.linear import ReplicatedLinear  # noqa: E402
from aphrodite.diffusion.runtime.layers.mlp import MLP  # noqa: E402
from aphrodite.diffusion.runtime.layers.rotary_embedding import (  # noqa: E402
    _apply_rotary_emb,
    get_rotary_pos_embed,
)
from aphrodite.diffusion.runtime.layers.visual_embedding import PatchEmbed  # noqa: E402
from aphrodite.diffusion.runtime.models.dits.base import BaseDiT  # noqa: E402
from aphrodite.diffusion.runtime.models.dits.wanvideo import (  # noqa: E402
    WanT2VCrossAttention,
    WanTimeTextImageEmbedding,
)
from aphrodite.diffusion.runtime.platforms import (  # noqa: E402
    ...
    def forward(
        ...
        if kv_cache is None:
            ...
            if (
                ...
                # logger.info(
                #     "kv_cache['k'] is in comp graph: %s",
                #     kv_cache["k"].requires_grad or kv_cache["k"].grad_fn is not None
                # )
                kv_cache["k"][:, local_start_index:local_end_index] = roped_key
                kv_cache["v"][:, local_start_index:local_end_index] = v
            x = self.attn(
...
class CausalWanTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        norm_hidden_states = (
            (
                self.norm1(hidden_states.float()).unflatten(dim=1, sizes=(num_frames, frame_seqlen)) * (1 + scale_msa)
                + shift_msa
            )
            .flatten(1, 2)
            .to(orig_dtype)
        ...
        null_shift = null_scale = torch.zeroes((1,), device=hidden_states.device, dtype=hidden_states.dtype)
    ...
    def _forward_inference(
        ...
        **kwargs,
        ...
        encoder_hidden_states = (
            encoder_hidden_states.to(orig_dtype) if current_platform.is_mps() else encoder_hidden_states
