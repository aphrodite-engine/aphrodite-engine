...
from aphrodite.diffusion.configs.models.dits import HunyuanVideoConfig
from aphrodite.diffusion.configs.sample.teacache import TeaCacheParams
...
from aphrodite.diffusion.runtime.models.utils import modulate
...
class HunyuanVideoTransformer3DModel(CachableDiT):
    ...
    def forward(
        ...
        **kwargs,
        ...
        should_skip_forward = self.should_skip_forward_for_cached_states(img=img, vec=vec)
    ...
    def should_skip_forward_for_cached_states(self, **kwargs) -> bool:
        ...
        assert isinstance(teacache_params, TeaCacheParams), "teacache_params is not a TeaCacheParams"
        ...
        vec_ = torch.distributed.tensor.DTensor.from_local(
            vec_,
            torch.distributed.DeviceMesh("cuda", list(range(get_sp_world_size())), mesh_dim_names=("dp",)),
