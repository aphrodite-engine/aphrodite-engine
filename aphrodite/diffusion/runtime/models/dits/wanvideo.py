...
from aphrodite.diffusion.configs.models.dits import WanVideoConfig
from aphrodite.diffusion.configs.sample.wan import WanTeaCacheParams
from aphrodite.diffusion.runtime.distributed.parallel_state import get_sp_world_size
from aphrodite.diffusion.runtime.layers.attention import (
    LocalAttention,
    UlyssesAttention_VSA,
    USPAttention,
)
from aphrodite.diffusion.runtime.layers.layernorm import (
    FP32LayerNorm,
    LayerNormScaleShift,
    RMSNorm,
    ScaleResidual,
...
from aphrodite.diffusion.runtime.layers.visual_embedding import (
    ModulateProjection,
    PatchEmbed,
    TimestepEmbedder,
)
...
class WanTransformer3DModel(CachableDiT):
        ...
        self.blocks = nn.ModuleList(
            [
                transformer_block(
                    ...
                    self._supported_attention_backends | {AttentionBackendEnum.VIDEO_SPARSE_ATTN},
    ...
    def forward(
        ...
        **kwargs,
        ...
        should_skip_forward = self.should_skip_forward_for_cached_states(timestep_proj=timestep_proj, temb=temb)
    ...
    def maybe_cache_states(self, hidden_states: torch.Tensor, original_hidden_states: torch.Tensor) -> None:
        if self.is_even:
    ...
    def should_skip_forward_for_cached_states(self, **kwargs) -> bool:
        ...
        assert isinstance(teacache_params, WanTeaCacheParams), "teacache_params is not a WanTeaCacheParams"
