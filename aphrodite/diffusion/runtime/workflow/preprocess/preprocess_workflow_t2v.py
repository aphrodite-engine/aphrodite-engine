...
from aphrodite.diffusion.runtime.pipelines.pipeline_batch_info import PreprocessBatch
...
class PreprocessWorkflowT2V(PreprocessWorkflow):
    ...
    def run(self) -> None:
        ...
        for batch in tqdm(
            ...
            forward_batch = self.preprocess_pipeline.forward(forward_batch, self.server_args)
