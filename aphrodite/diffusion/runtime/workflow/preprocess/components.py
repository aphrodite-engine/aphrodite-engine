...
from aphrodite.diffusion.configs.configs import (
    DatasetType,
    PreprocessConfig,
    VideoLoaderType,
)
from aphrodite.diffusion.configs.sample.base import DataType
...
class PreprocessingDataValidator:
    ...
    def _filter_resolution(self, h: int, w: int, max_h_div_w_ratio: float, min_h_div_w_ratio: float) -> bool:
