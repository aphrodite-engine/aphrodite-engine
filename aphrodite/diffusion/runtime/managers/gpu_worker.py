...
from aphrodite.diffusion.runtime.pipelines import build_pipeline
...
class GPUWorker:
    ...
    def init_device_and_model(self) -> None:
        ...
        logger.info("Worker %s: Initialized device, model, and distributed environment.", self.rank)
...
def run_scheduler_process(
    ...
    from aphrodite.diffusion.runtime.managers.scheduler import Scheduler
