...
from aphrodite.diffusion.runtime.platforms.interface import (  # noqa: F401
...
def mps_platform_plugin() -> str | None:
    ...
    return "aphrodite.diffusion.runtime.platforms.mps.MpsPlatform" if is_mps else None


def cpu_platform_plugin() -> str | None:
    """Detect if CPU platform should be used."""
    # CPU is always available as a fallback
    return "aphrodite.diffusion.runtime.platforms.cpu.CpuPlatform"
...
def __getattr__(name: str):
    if name == "current_platform":
        ...
        # 1. out-of-tree platform plugins need `from aphrodite.diffusion.runtime.platforms import
