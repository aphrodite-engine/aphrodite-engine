...
from aphrodite.diffusion.runtime.platforms.interface import (
...
class CudaPlatformBase(Platform):
    ...
    def get_attn_backend_cls_str(
        ...
        if selected_backend == AttentionBackendEnum.SLIDING_TILE_ATTN:
            try:
                ...
                from aphrodite.diffusion.runtime.layers.attention.backends.sliding_tile_attn import (  # noqa: F401
                ...
                return (
                    "aphrodite.diffusion.runtime.layers.attention.backends."
                    "sliding_tile_attn.SlidingTileAttentionBackend"
                )
            except ImportError as e:
                logger.error("Failed to import Sliding Tile Attention backend: %s", str(e))
                raise ImportError("Sliding Tile Attention backend is not installed. ") from e
        elif selected_backend == AttentionBackendEnum.SAGE_ATTN:
            try:
                from sageattention import sageattn  # noqa: F401

                from aphrodite.diffusion.runtime.layers.attention.backends.sage_attn import (  # noqa: F401
                    SageAttentionBackend,
                )

                logger.info("Using Sage Attention backend.")

                return "aphrodite.diffusion.runtime.layers.attention.backends.sage_attn.SageAttentionBackend"
            except ImportError as e:
                logger.info(e)
            ...
            try:
                from aphrodite.diffusion.runtime.layers.attention.backends.sageattn.api import (  # noqa: F401
                    sageattn_blackwell,
                )

                from aphrodite.diffusion.runtime.layers.attention.backends.sage_attn3 import (  # noqa: F401
                    SageAttention3Backend,
                )

                logger.info("Using Sage Attention 3 backend.")

                return "aphrodite.diffusion.runtime.layers.attention.backends.sage_attn3.SageAttention3Backend"
            except ImportError as e:
                logger.info(e)
            ...
            try:
                ...
                from aphrodite.diffusion.runtime.layers.attention.backends.video_sparse_attn import (  # noqa: F401
                ...
                return (
                    "aphrodite.diffusion.runtime.layers.attention.backends."
                    "video_sparse_attn.VideoSparseAttentionBackend"
                )
            except ImportError as e:
            ...
            try:
                ...
                from aphrodite.diffusion.runtime.layers.attention.backends.vmoba import (  # noqa: F401
                    VMOBAAttentionBackend,
                )

                logger.info("Using Video MOBA Attention backend.")

                return "aphrodite.diffusion.runtime.layers.attention.backends.vmoba.VMOBAAttentionBackend"
            except ImportError as e:
            ...
            return "aphrodite.diffusion.runtime.layers.attention.backends.aiter.AITerBackend"
        ...
        if target_backend == AttentionBackendEnum.FA3:
            try:
                from aphrodite.diffusion.runtime.layers.attention.backends.flash_attn import (  # noqa: F401
    ...
    def get_device_communicator_cls(cls) -> str:
        return "aphrodite.diffusion.runtime.distributed.device_communicators.cuda_communicator.CudaCommunicator"  # noqa
