...
def prepare_sampling_params(
    ...
    if sampling_params.negative_prompt is not None and not sampling_params.negative_prompt.isspace():
    ...
    if server_args.pipeline_config.is_image_gen:
        logger.debug("Setting num_frames to 1 because this is a image-gen model")
