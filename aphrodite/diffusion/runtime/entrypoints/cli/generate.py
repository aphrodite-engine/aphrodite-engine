...
from aphrodite.diffusion import DiffGenerator
...
from aphrodite.diffusion.runtime.entrypoints.cli.utils import (
...
def generate_cmd(args: argparse.Namespace):
    ...
    generator = DiffGenerator.from_pretrained(model_path=server_args.model_path, server_args=server_args)
