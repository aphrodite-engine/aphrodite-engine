...
class MQAphroditeEngine:
    ...
    The :class:`AphroditeEngine` generate or encode process is kicked off when a new
    ...
    def __init__(self,
                 ...
                 **kwargs) -> None:
        # For MQAphroditeEngine, we can use cached outputs, since each new request
    ...
    def from_aphrodite_config(
        ...
        return cls(
            ...
            executor_class=AphroditeEngine._get_executor_cls(aphrodite_config),
            ipc_path=ipc_path,
    ...
    def from_engine_args(engine_args: AsyncEngineArgs,
        ...
        return MQAphroditeEngine.from_aphrodite_config(
            ipc_path=ipc_path,
            aphrodite_config=aphrodite_config,
            usage_context=usage_context,
...
def run_mp_engine(aphrodite_config: AphroditeConfig,
    ...
    try:
        ...
        engine = MQAphroditeEngine.from_aphrodite_config(
            aphrodite_config=aphrodite_config,
            usage_context=usage_context,
