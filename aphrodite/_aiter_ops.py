...
class rocm_aiter_ops:
    ...
    _RMSNORM_ENABLED = envs.APHRODITE_ROCM_USE_AITER_RMSNORM
    ...
    def refresh_env_variables(cls):
        ...
        cls._RMSNORM_ENABLED = envs.APHRODITE_ROCM_USE_AITER_RMSNORM
    ...
    def get_rmsnorm_fused_add_op() -> OpOverload:
        return torch.ops.aphrodite.rocm_aiter_rmsnorm2d_fwd_with_add.default

    @staticmethod
    def get_rmsnorm_op() -> OpOverload:
        return torch.ops.aphrodite.rocm_aiter_rms_norm.default
    ...
    def per_tensor_quant(
        ...
        return torch.ops.aphrodite.rocm_aiter_per_tensor_quant(x, quant_dtype, scale)
