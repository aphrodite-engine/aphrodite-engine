...
class CpuPlatform(Platform):
    ...
    def supported_dtypes(self) -> list[torch.dtype]:
        if self.get_cpu_architecture() == CpuArchEnum.POWERPC:
            ...
            # - There is a latent bug in the Aphrodite scheduler that provides
            # invalid
    ...
    def get_attn_backend_cls(
        ...
        return "aphrodite.v1.attention.backends.cpu_attn.TorchSDPABackend"
    ...
    def check_and_update_config(cls, aphrodite_config: AphroditeConfig) -> None:
        ...
        os.environ["APHRODITE_DISABLE_SHARED_EXPERTS_STREAM"] = "0"
