...
class NeuronPlatform(Platform):
    ...
    def check_and_update_config(cls, aphrodite_config: AphroditeConfig) -> None:
        ...
        if aphrodite_config.cache_config and aphrodite_config.model_config:
            # neuron needs block_size = max_model_len
            aphrodite_config.cache_config.block_size = \
                aphrodite_config.model_config.max_model_len  # type: ignore

        if aphrodite_config.model_config and aphrodite_config.model_config.use_mla:
            logger.info(
    ...
    def get_neuron_framework_to_use(self):
        ...
        specified_framework = os.environ.get("APHRODITE_NEURON_FRAMEWORK")
