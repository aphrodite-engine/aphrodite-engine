...
from aphrodite.multimodal.processing import PromptUpdateDetails, cached_encode
            ...
            if image_inputs:
                ...
                for prompt in text:
                    ...
                    while image_token in new_prompt:
                        ...
                        replace_strings.append(self.tokenizer.decode(image_repl.full, skip_special_tokens=False))
                        image_index += 1
            ...
            if video_inputs:
                ...
                for prompt in text:
                    ...
                    while video_token in new_prompt:
                        ...
                        # Convert the token IDs back to text for the
                        # string-based replacement below
                        replace_strings.append(self.tokenizer.decode(video_repl.full, skip_special_tokens=False))
                        video_index += 1
