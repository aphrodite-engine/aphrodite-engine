    ...
    def _resize_image(
        ...
        **kwargs,
        ...
        if aspect_ratio > max_ratio:
            raise ValueError(f"absolute aspect ratio must be smaller than {max_ratio}, got {aspect_ratio}")
...
class Cosmos3EdgeProcessor(Qwen3VLProcessor):
    ...
    # Transformers' auto loaders cannot resolve these Aphrodite-native image and
