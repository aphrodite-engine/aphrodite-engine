...
# see: https://github.com/deepseek-ai/DeepSeek-OCR/blob/8cf003d38821fa1b19c73da3bd1b0dc262ea8136/DeepSeek-OCR-master/DeepSeek-OCR-aphrodite/config.py#L1-L6
...
class DeepseekOCRProcessor(ProcessorMixin):
    ...
    def tokenize_with_images(
        ...
        for text_sep, image in zip(text_splits, images):
            ...
            if num_width_tiles > 1 or num_height_tiles > 1:
                num_tokens_per_row = (
                    num_queries * num_width_tiles + 1 if self.strategy == "v1" else num_queries * num_width_tiles
                )
