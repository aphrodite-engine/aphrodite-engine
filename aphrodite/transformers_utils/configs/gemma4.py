...
def gemma4_layer_config(text_config: PretrainedConfig, layer_idx: int) -> PretrainedConfig:
    ...
    if text_config.layer_types[layer_idx] == "full_attention":
        ...
        if getattr(text_config, "attention_k_eq_v", False):
            ...
            layer.num_key_value_heads = global_kv_heads or text_config.num_key_value_heads
    return layer
