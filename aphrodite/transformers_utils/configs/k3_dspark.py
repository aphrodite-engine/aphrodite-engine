...
class K3DSparkConfig(DeepseekV3Config):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.draft_vocab_size = getattr(self, "draft_vocab_size", None) or self.vocab_size
        ...
        if not target_layer_ids or getattr(self, "num_target_layers", None) != len(target_layer_ids):
            raise ValueError("MLA DSpark requires non-empty target_layer_ids and a matching num_target_layers.")
