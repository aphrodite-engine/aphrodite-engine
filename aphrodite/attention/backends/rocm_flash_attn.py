...
def is_rocm_aiter_paged_attn_enabled() -> bool:
    return envs.APHRODITE_ROCM_USE_AITER_PAGED_ATTN \
...
def _get_paged_attn_module() -> PagedAttention:
    ...
    if is_rocm_aiter_paged_attn_enabled():
        ...
        from aphrodite.attention.ops.rocm_aiter_paged_attn import (
            AITERPagedAttention)
...
class ROCmFlashAttentionImpl(AttentionImpl):
    ...
    def __init__(
        ...
        if self.use_triton_flash_attn:
            ...
            log_once("DEBUG", "Using Triton FA in ROCmBackend")
            if self.sliding_window != (-1, -1):
                log_once("WARNING", "ROCm Triton FA does not currently support "
            ...
            if not current_platform.has_device_capability(90):
                ...
                try:
                    ...
                    log_once("DEBUG", "Using CK FA in ROCmBackend")
        ...
        self.force_fp8_attention = (
            get_current_aphrodite_config() is not None
            and get_current_aphrodite_config().model_config.override_attention_dtype
            == "fp8")
    ...
    def forward(
        ...
        * For cross-attention:
        ...
        if (decode_meta := attn_metadata.decode_metadata) and (
            ...
            from aphrodite.platforms.rocm import (
