...
from aphrodite.utils import (async_tensor_h2d, cdiv, make_tensor_with_pad,
                             round_down)
...
class MLACommonImpl(MLAAttentionImpl[T], Generic[T]):
    ...
    def _flash_attn_varlen_diff_headdims(self, q, k, v, softmax_scale,
        ...
        if is_hip and envs.APHRODITE_USE_TRITON_FLASH_ATTN \
        ...
        # aphrodite_flash_attn returns (output, softmax_lse) when
        #  `return_softmax_lse = True`
