...
from aphrodite.quantization.awq import AWQLinearMethod, is_layer_skipped_awq
from aphrodite.quantization.base_config import QuantizationConfig
from aphrodite.quantization.fp8 import Fp8Config, Fp8LinearMethod
...
class IPEXGPTQLinearMethod(GPTQLinearMethod):
    ...
    def process_weights_after_loading(self, layer: torch.nn.Module) -> None:
        ...
        try:
            ...
            if version.parse(ipex.__version__) < version.parse(
                    MIN_IPEX_VERSION):
                raise ImportError(
