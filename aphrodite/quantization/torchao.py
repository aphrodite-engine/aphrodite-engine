...
class TorchAOConfig(QuantizationConfig):
    ...
    def __init__(
        ...
        if is_torch_equal_or_newer("2.8.0.dev"):
            os.environ["APHRODITE_TEST_STANDALONE_COMPILE"] = "1"
            logger.info(
                "Using TorchAO: Setting APHRODITE_TEST_STANDALONE_COMPILE=1")
        ...
        if is_torch_equal_or_newer(
            ...
            os.environ["APHRODITE_DISABLE_COMPILE_CACHE"] = "1"
            logger.info("Using TorchAO: Setting APHRODITE_DISABLE_COMPILE_CACHE=1")
        """
        super().__init__()
