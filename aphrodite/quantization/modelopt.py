...
from aphrodite.quantization.utils.flashinfer_utils import (
    ...
    is_flashinfer_supporting_global_sf, register_moe_scaling_factors,
...
from aphrodite.utils.flashinfer import (flashinfer_scaled_fp4_mm,
                                        has_flashinfer, has_flashinfer_moe)
...
class ModelOptFp8MoEMethod(FusedMoEMethodBase):
    ...
    def __init__(
        ...
        if (
            envs.APHRODITE_USE_FLASHINFER_MOE_FP8
...
class ModelOptNvFp4FusedMoE(FusedMoEMethodBase):
    ...
    def __init__(
        ...
        from aphrodite.quantization.utils.nvfp4_moe_support import (  # noqa: E501
