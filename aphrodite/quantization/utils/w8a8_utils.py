...
from aphrodite.config import CompilationLevel, get_current_aphrodite_config
...
from aphrodite.utils.flashinfer import flashinfer_scaled_fp8_mm, has_flashinfer
...
def rocm_per_tensor_w8a8_scaled_mm_impl(
    ...
    if envs.APHRODITE_ROCM_USE_SKINNY_GEMM and on_mi3xx(
