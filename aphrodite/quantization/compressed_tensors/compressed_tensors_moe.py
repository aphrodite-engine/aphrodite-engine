...
from aphrodite.modeling.layers.fused_moe.flashinfer_cutlass_prepare_finalize import (  # noqa
...
class CompressedTensorsW4A4MoeMethod(CompressedTensorsMoEMethod):
    ...
    def select_gemm_impl(self, prepare_finalize, moe):
        ...
        from aphrodite.quantization.utils.flashinfer_fp4_moe import (  # noqa: E501
...
class CompressedTensorsW8A8Fp8MoEMethod(CompressedTensorsMoEMethod):
    ...
    def select_gemm_impl(
        ...
        # cutlass path
        if self.use_cutlass:
            from aphrodite.modeling.layers.fused_moe import CutlassExpertsFp8
