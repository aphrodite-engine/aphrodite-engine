...
def init_vision_tower_for_tarsier(
    ...
    *,
    ...
    if isinstance(feature_layers, int):
        num_hidden_layers_to_init = get_layer_index(feature_layers, base_num_hidden_layers)
    elif isinstance(feature_layers, (list, tuple)):
        num_hidden_layers_to_init = max(get_layer_index(idx, base_num_hidden_layers) for idx in feature_layers)
    else:
...
class TarsierForConditionalGeneration(nn.Module, SupportsMultiModal, SupportsPP):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = "") -> None:
        ...
        config: TarsierHfConfig = aphrodite_config.model_config.hf_config
    ...
    def _image_pixels_to_features(
        ...
        # From Aphrodite LLaVA, vision tower output handling
        return vision_tower(
            pixel_values,
