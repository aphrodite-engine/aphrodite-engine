...
# Adapted from:
# aphrodite.model_executor.layers.mamba.mamba_mixer2.MambaMixer2
...
class Plamo2MambaMixer(MambaBase, PluggableLayer):
    ...
    def __init__(self, aphrodite_config: AphroditeConfig, *, prefix: str = "", **kwargs) -> None:
        ...
        self.is_lora_enabled = bool(aphrodite_config.lora_config)
...
class Plamo2AttentionMixer(nn.Module):
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = "", **kwargs) -> None:
        ...
        if hasattr(aphrodite_config.model_config, "max_model_len") and isinstance(
            ...
            max_position = min(max_position, aphrodite_config.model_config.max_model_len)
...
class Plamo2Model(torch.nn.Module):
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        self.layers = Plamo2Decoder(aphrodite_config=aphrodite_config, prefix=f"{prefix}.layers")
...
class Plamo2ForCausalLM(torch.nn.Module, HasInnerState, SupportsLoRA, SupportsPP, IsHybrid):
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]):
        ...
        for name, loaded_weight in weights:
            ...
            if any(substr in name for substr in AutoWeightsLoader.ROTARY_EMBEDS_UNUSED_WEIGHTS):
                continue
