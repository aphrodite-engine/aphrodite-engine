...
from aphrodite.model_executor.models.interns1_vit import InternS1VisionModel
...
class InternS1MultiModalProcessor(BaseMultiModalProcessor[InternS1ProcessingInfo]):
    ...
    def _apply_hf_processor_main(
        ...
        prompt_text = re.sub(hf_processor.image_token, "<image_placeholder>", prompt_text)
        prompt_text = re.sub(hf_processor.video_token, "<video_placeholder>", prompt_text)
        ...
        if images:
            ...
            for image in images:
                ...
                prompt_text = prompt_text.replace("<image_placeholder>", image_placeholder, 1)
        ...
        if videos:
            ...
            for video in videos:
                ...
                prompt_text = prompt_text.replace("<video_placeholder>", video_placeholder, 1)
        ...
        prompt_text = re.sub("<image_placeholder>", hf_processor.image_token, prompt_text)
        prompt_text = re.sub("<video_placeholder>", hf_processor.video_token, prompt_text)
    ...
    def _get_prompt_updates(
        ...
        video_token_ids = cached_encode(tokenizer, video_token, add_special_tokens=False)
        ...
        def get_replacement_interns1_image(item_idx: int):
            ...
            return PromptUpdateDetails.select_token_id(repl_full_ids, img_context_token_id)
...
class InternS1ForConditionalGeneration(nn.Module, SupportsMultiModal, SupportsPP, SupportsLoRA):
    ...
    def _parse_and_validate_multimodal_inputs(self, **kwargs: object) -> InternS1MultiModalInputs:
