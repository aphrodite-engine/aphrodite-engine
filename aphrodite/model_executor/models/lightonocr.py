...
from aphrodite.model_executor.models.mistral3 import (
    ...
    def _postprocess_hf_mm_data(
        ...
        if input_ids is not None:
            ...
            if "attention_mask" in processed_data:
                processed_data["attention_mask"] = processed_data["attention_mask"][keep_mask].unsqueeze(0)
        ...
        if pixel_values is not None:
            ...
            processed_data["pixel_values"] = [p[:, :h, :w] for p, (h, w) in zip(pixel_values, image_sizes)]
