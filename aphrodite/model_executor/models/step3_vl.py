...
from aphrodite.transformers_utils.configs.step3_vl import Step3VisionEncoderConfig
from aphrodite.transformers_utils.processors.step3_vl import (
    MAX_IMAGE_SIZE,
...
class Step3VLMultiModalProcessor(BaseMultiModalProcessor[Step3VLProcessingInfo]):
    ...
    def _get_mm_fields_config(
        ...
        return dict(
            ...
            patch_newline_mask=MultiModalFieldConfig.flat_from_sizes("image", num_patches, keep_on_cpu=True),
        )
...
class Step3VLForConditionalGeneration(nn.Module, SupportsMultiModal, SupportsPP, SupportsEncoderCudaGraph):
    ...
    def get_encoder_cudagraph_config(self):
        ...
        return EncoderCudaGraphConfig(
            ...
            paths={
                "global": EncoderCudaGraphPathConfig(min_token_budget=self.img_output_tokens),
