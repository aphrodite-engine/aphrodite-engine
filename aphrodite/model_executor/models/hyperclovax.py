...
from aphrodite.transformers_utils.configs.hyperclovax import HyperCLOVAXConfig
...
class HyperCLOVAXDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        # The residual parameter is kept for interface consistency with other aphrodite
        # decoder layers.
