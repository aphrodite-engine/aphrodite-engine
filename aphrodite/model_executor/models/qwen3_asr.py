...
from aphrodite.transformers_utils.processors.qwen3_asr import (
    Qwen3ASRProcessor,
)
...
class Qwen3ASRStreamingPostProcessor(StreamingTranscriptionPostProcessor):
    ...
    def process_delta(self, text_delta: str, finished: bool) -> str:
        ...
        processed_text = _post_process_qwen3_asr_output(self.raw_text) if self.is_structured_output else self.raw_text
...
class Qwen3ASRForConditionalGeneration(
    ...
    def get_generation_prompt(cls, stt_params: SpeechToTextParams) -> PromptType:
        ...
        prompt = f"{system_turn}<|im_start|>user\n{audio_placeholder}<|im_end|>\n<|im_start|>assistant\n"
