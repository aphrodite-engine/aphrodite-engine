...
from aphrodite.transformers_utils.configs.colmodernvbert import ColModernVBertConfig
...
class ColModernVBertForRetrieval(
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        super().__init__()
        config: ColModernVBertConfig = aphrodite_config.model_config.hf_config
        self.config = config
        ...
        # ``aphrodite_config.model_config.hf_config`` which would be
    ...
    # Checkpoint prefix → Aphrodite param prefix.
