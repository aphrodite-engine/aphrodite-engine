...
from aphrodite.model_executor.models.longcat_flash import FlashConfig
...
class LongCatMultiTokenPredictorLayer(nn.Module):
    def __init__(
        ...
        self.mtp_block = DeepseekV2DecoderLayer(aphrodite_config, prefix)
...
class LongCatMultiTokenPredictor(nn.Module):
    def __init__(
        ...
        *,
        ...
        aphrodite_config.model_config.hf_config.intermediate_size = config.intermediate_size
...
class LongCatFlashMTP(nn.Module):
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        object.__setattr__(aphrodite_config.model_config.hf_config, "n_routed_experts", None)
