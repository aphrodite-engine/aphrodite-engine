...
class HCXVisionV2MultiModalProcessor(BaseMultiModalProcessor[HCXVisionV2ProcessingInfo]):
    ...
    def _apply_hf_processor_main(
        ...
        # Token expansion is handled by Aphrodite via _get_prompt_updates.
...
class HCXVisionV2ForCausalLM(nn.Module, SupportsMultiModal, SupportsPP):
    ...
    hf_to_aphrodite_mapper = WeightsMapper(
        ...
        orig_to_new_substr={
            # Ignore modules not implemented in Aphrodite
    ...
    def _parse_and_validate_multimodal_inputs(self, **kwargs: object) -> HCXVisionV2MultiModalInputs:
