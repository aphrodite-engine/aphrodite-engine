...
class InternS2PreviewForConditionalGeneration(Qwen3_5MoeForConditionalGeneration):
    ...
    hf_to_aphrodite_mapper = Qwen3_5MoeForConditionalGeneration.hf_to_aphrodite_mapper | (
        WeightsMapper(orig_to_new_prefix={"model.time_series.": None, "time_series.": None})
    )
