...
from aphrodite.model_executor.models.transformers.utils import replace_linear_class
...
class DeepseekVL2MultiModalProcessor(BaseMultiModalProcessor[DeepseekVL2ProcessingInfo]):
    ...
    def _postprocess_hf_mm_data(
        ...
        processed_data["num_patches"] = processed_data["images_spatial_crop"].prod(-1) + 1
    ...
    def _get_mm_fields_config(
        ...
        return dict(
            ...
            images_spatial_crop=MultiModalFieldConfig.batched("image", keep_on_cpu=True),
...
class DeepseekVLV2ForCausalLM(nn.Module, SupportsMultiModal, SupportsPP):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        super().__init__()
        config: DeepseekVLV2Config = aphrodite_config.model_config.hf_config
    ...
    def patch_vit_for_tp(self, vit: torch.nn.Module, quant_config: QuantizationConfig | None):
        try:
            import timm
