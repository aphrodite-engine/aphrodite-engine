...
class BailingMoeForCausalLM(nn.Module, SupportsPP, SupportsLoRA):
    ...
    def __init__(
        ...
        *,
        ...
        aphrodite_config.model_config.hf_config = config
        quant_config = aphrodite_config.quant_config
    ...
    def _normalize_lm_head(self, weights: Iterable[tuple[str, torch.Tensor]]) -> Iterable[tuple[str, torch.Tensor]]:
        norm_head = getattr(self.config, "norm_head", False)
