...
from aphrodite.v1.attention.backends.cpu_attn import CPUAttentionBackend
...
def create_whisper_attention_backend_with_block_pooling(
    ...
    if not issubclass(underlying_attn_backend, (CPUAttentionBackend, FlashAttentionBackend)):
        logger.info(
...
class WhisperCausalAttentionWithBlockPooling(Attention):
    ...
    def get_kv_cache_spec(self, aphrodite_config: AphroditeConfig):
        kv_cache_spec = super().get_kv_cache_spec(aphrodite_config)
