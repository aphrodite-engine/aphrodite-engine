...
from aphrodite.utils.collection_utils import flatten_2d_lists
...
class MiniCPMV(MiniCPMVBaseModel, SupportsMultiModal, SupportsLoRA):
    ...
    def __new__(cls, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        if instance_cls is None:
            ...
            raise ValueError(f"Currently, MiniCPMV only supports versions {supported_versions}. Got version: {version}")
