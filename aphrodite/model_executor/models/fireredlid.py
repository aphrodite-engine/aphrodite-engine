...
"""
FireRedLID – Language Identification model adapted for Aphrodite.
...
This implementation follows the Whisper-style encoder-decoder pattern:
  ...
  • Aphrodite's generation loop handles beam search / sampling
"""
...
class FireRedLIDDecoderLayer(nn.Module):
    """Aphrodite-native decoder layer while preserving FireRedLID parameter names."""
...
class FireRedLIDForConditionalGeneration(
    ...
    def embed_multimodal(self, **kwargs: object) -> MultiModalEmbeddings:
        ...
        # When audio items have different time lengths, Aphrodite's
