...
# Adapted from https://github.com/vllm-project/vllm/blob/94d8ec8d2bcb4ec55e33022b313c7e978edf05e1/aphrodite/model_executor/models/bamba.py
...
class NemotronHModel(nn.Module, EagleModelMixin):
    def __init__(
        ...
        *,
        ...
        config: NemotronHConfig = aphrodite_config.model_config.hf_config
        ...
        def get_layer(prefix: str):
            ...
            if layer_type not in layer_types:
                raise ValueError(f"Unsupported layer type {layer_type!r} at layer {layer_idx}")
...
class NemotronHForCausalLM(
    ...
    def get_mamba_state_dtype_from_config(
        ...
        if cache_config.use_replayssm:
            return MambaStateDtypeCalculator.append_replayssm_ring(base_dtype, aphrodite_config.model_config.dtype)
        return base_dtype
