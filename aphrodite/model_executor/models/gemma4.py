...
"""Gemma 4 model implementation for Aphrodite."""
...
class Gemma4MoE(nn.Module):
    """Mixture of Experts for Gemma4 using Aphrodite's FusedMoEFactory.
...
class Gemma4Attention(nn.Module):
    def __init__(
        ...
        self.is_kv_shared_layer = num_kv_shared_layers > 0 and layer_idx >= first_kv_shared_layer_idx
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        ...
        def _weight_iterator():
            ...
            for name, weight in weights:
                ...
                # Remap new HF checkpoint naming to internal Aphrodite
