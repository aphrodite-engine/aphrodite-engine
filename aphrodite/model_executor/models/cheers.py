...
For Aphrodite, we focus on the image understanding (vision-to-text) capabilities.
...
from aphrodite.transformers_utils.processors.cheers import CheersProcessor
...
class CheersForConditionalGeneration(
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        # 1_000_000, but this isn't stored in the JSON.  Aphrodite's standard
