...
from aphrodite.transformers_utils.processors.internvl import (
...
class BaseInternVLMultiModalProcessor(BaseMultiModalProcessor[_I]):
    ...
    def _get_image_fields_config(self, hf_inputs: BatchFeature):
        ...
        return dict(
            ...
            image_token_id=MultiModalFieldConfig.shared("image", num_images, keep_on_cpu=True),
        )
...
class InternVLProcessingInfo(BaseInternVLProcessingInfo):
    ...
    def get_hf_processor(self, **kwargs: object) -> InternVLProcessor:
        ...
        video_processor = self.get_video_processor(**kwargs) if ctx_video_token else None
...
class InternVLMultiModalProcessor(BaseInternVLMultiModalProcessor[InternVLProcessingInfo]):
    ...
    def _get_video_fields_config(self, hf_inputs: BatchFeature):
        ...
        return dict(
            ...
            video_token_id=MultiModalFieldConfig.shared("video", num_videos, keep_on_cpu=True),
        )
...
class InternVLChatModel(
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = "") -> None:
        ...
        multimodal_config = aphrodite_config.model_config.get_multimodal_config()
    ...
    def _parse_and_validate_video_input(self, **kwargs: object) -> InternVLVideoInputs | None:
    ...
    def _parse_and_validate_multimodal_inputs(self, **kwargs: object) -> InternVLMultiModalInputs:
    ...
    def select_encoder_cudagraph_items(
        ...
        pv_key = "pixel_values_flat" if modality == "image" else "pixel_values_flat_video"
        patches_key = "image_num_patches" if modality == "image" else "video_num_patches"
    ...
    def prepare_encoder_cudagraph_capture_inputs(
        ...
        dummy_pixel_values = torch.randn(total_tiles, 3, image_size, image_size, device=device, dtype=dtype)
