...
from aphrodite.transformers_utils.configs.AXK1 import AXK1Config
...
class AXK1Model(nn.Module):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        config: AXK1Config = aphrodite_config.model_config.hf_config
        quant_config = aphrodite_config.quant_config
        self.config = config
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda prefix: AXK1DecoderLayer(aphrodite_config, prefix),
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        ...
        expert_params_mapping = fused_moe_make_expert_params_mapping(
            ...
            + ((self.config.n_shared_experts or 0) if self.is_fused_shared_expert_enabled else 0),
