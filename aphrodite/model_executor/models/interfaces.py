...
from .interfaces_base import AphroditeModel
...
class SupportsMultiModal(Protocol):
    ...
    def get_language_model(self) -> AphroditeModel:
        ...
        raise NotImplementedError(
            f"No language model found in {type(self).__name__}! You should initialize it via `_mark_language_model`."
        )
...
class SupportsQuant:
    ...
    def _maybe_apply_model_mapping(self):
        ...
        if (hf_to_aphrodite_mapper := self.hf_to_aphrodite_mapper) is not None:
            self.quant_config.apply_aphrodite_mapper(hf_to_aphrodite_mapper)
