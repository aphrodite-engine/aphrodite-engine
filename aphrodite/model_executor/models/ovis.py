...
from aphrodite.model_executor.models.aimv2 import AIMv2Model
...
class OvisMultiModalProcessor(BaseMultiModalProcessor[OvisProcessingInfo]):
    ...
    def _postprocess_hf_mm_data(
        ...
        image_indicators = [hf_processor.construct_image_indicators(grid) for grid in processed_data["grids"]]
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        with self._mark_language_model(aphrodite_config):
            self.llm = init_aphrodite_registered_model(
                aphrodite_config=aphrodite_config.with_hf_config(config.get_text_config()),
