...
from aphrodite.model_executor.layers.activation import get_act_and_mul_fn, get_act_fn
from aphrodite.model_executor.layers.attention import (
    EncoderOnlyAttention,
)
from aphrodite.model_executor.layers.fused_moe import activation_without_mul, fused_topk
...
class NomicMoE(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        ...
        final_hidden_states = torch.ops.aphrodite.outplace_fused_experts(
