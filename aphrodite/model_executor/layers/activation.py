...
from aphrodite.utils.collection_utils import LazyDict
...
class SiluAndMul(CustomOp):
    ...
    def __init__(self, *, compile_native: bool = True, enforce_enable: bool = False):
        super().__init__(
...
class SituAndMul(CustomOp):
    ...
    def forward_cuda(self, x: torch.Tensor) -> torch.Tensor:
        ...
        self.op(out, x, self.beta, -1.0 if self.linear_beta is None else self.linear_beta)
        return out
