...
def hpc_gated_mla_supported(gating_type: str | None, attn_output_gate: torch.nn.Module | None) -> bool:
    ...
    logger.info_once("HPC gated MLA enabled by set APHRODITE_ENABLE_HPC_OPS.")
    return True
