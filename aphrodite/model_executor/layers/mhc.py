...
import aphrodite.model_executor.kernels.mhc as mhc_kernels
...
def _aiter_mhc_supported(
    ...
    *,
    ...
    return HAS_AITER_MHC and hidden_size % 256 == 0 and hc_mult == 4 and (norm_weight is None or supports_norm)
...
class MHCPreOp(CustomOp):
    ...
    def forward_cuda(
        ...
        return torch.ops.aphrodite.mhc_pre_tilelang(
            residual,
            fn,
            hc_scale,
            hc_base,
    ...
    def forward_hip(
        ...
        if _aiter_mhc_supported(
            ...
            return torch.ops.aphrodite.mhc_pre_aiter(
                residual,
                fn,
                hc_scale,
                hc_base,
...
class MHCPostOp(CustomOp):
    ...
    def forward_hip(
        ...
        if _aiter_mhc_supported(residual, None, supports_norm=True):
            return torch.ops.aphrodite.mhc_post_aiter(
                x,
                residual,
                post_layer_mix,
                comb_res_mix,
...
class HCHeadOp(CustomOp):
    ...
    def forward_xpu(
        ...
        torch.ops._xpu_C.hc_head_fused(hs_flat, hc_fn, hc_scale, hc_base, out, rms_norm_eps, hc_eps)
        return out.view(*outer_shape, hidden_size)
...
class MHCFusedPostPreOp(CustomOp):
    ...
    def forward_cuda(
        ...
        return torch.ops.aphrodite.mhc_fused_post_pre_tilelang(
            x,
            residual,
            post_layer_mix,
            comb_res_mix,
    ...
    def forward_hip(
        ...
        if HAS_AITER_MHC_FUSED and _aiter_mhc_supported(
            ...
            return torch.ops.aphrodite.mhc_fused_post_pre_aiter(
                x,
                residual,
                post_layer_mix,
                comb_res_mix,
