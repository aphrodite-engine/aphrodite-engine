...
def apply_moe_activation(
    ...
    *,
    ...
    if activation == MoEActivation.SILU:
        ...
        assert activation_situ_beta is not None, "SITU requires activation_situ_beta from FusedMoEConfig"
        torch.ops._C.situ_and_mul(
            output,
            input,
            activation_situ_beta,
            -1.0 if activation_situ_linear_beta is None else activation_situ_linear_beta,
        )
