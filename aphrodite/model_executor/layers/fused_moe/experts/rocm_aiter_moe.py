...
def rocm_aiter_fused_experts(
    ...
    if quant_config.per_act_token_quant and apply_router_weight_on_input and quant_config.use_fp8_w8a8:
        ...
        return rocm_aiter_ops.fused_moe(
            ...
            swiglu_limit=(0.0 if moe_config.swiglu_limit is None else float(moe_config.swiglu_limit)),
    ...
    def is_supported_config(cls, moe_config, weight_key, activation_key, activation_format):
        ...
        if not is_supported and not rocm_aiter_ops.is_fused_moe_enabled():
            reason = (
                ...
                "set APHRODITE_ROCM_USE_AITER=1 and APHRODITE_ROCM_USE_AITER_MOE=1 "
                "to enable it"
            )
