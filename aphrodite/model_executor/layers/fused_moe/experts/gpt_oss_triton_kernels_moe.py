...
def _triton_kernel_moe_supports_current_device() -> bool:
    ...
    if p.is_rocm():
        from aphrodite.platforms.rocm import on_gfx1x, on_gfx9
...
def _patch_legacy_routing_for_nonpow2_topk() -> None:
    ...
    # `aphrodite.third_party.triton_kernels.routing` path is a *different* module
...
#   - v3.5.1 (the version bundled with Aphrodite): exposes `routing()` and
