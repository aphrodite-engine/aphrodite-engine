...
class TritonExperts(LoRAExpertsMixin, mk.FusedMoEExpertsModular):
    ...
    def is_supported_config(
        ...
        if padded_num_experts >= 1024:
            return False, ("kernel's moe_align_block_size requires fewer than 1024 padded experts")
        return True, None
    ...
    def _supports_quant_scheme(
        ...
        # provide native INT8 matrix-core support.
    ...
    def activation(
        ...
        **kwargs,
        ...
        if activation == MoEActivation.SILU and activation_config.clamp_limit is not None:
        ...
        if activation == MoEActivation.SWIGLUOAI_UNINTERLEAVE:
            assert activation_config.clamp_limit is not None, "SWIGLUOAI_UNINTERLEAVE requires gemm1_clamp_limit"
    ...
    def apply(
        ...
        input_scale = (
            a1q_scale if self.quantization_emulation else (a1q_scale if a1q_scale is not None else self.a1_scale)
        )
