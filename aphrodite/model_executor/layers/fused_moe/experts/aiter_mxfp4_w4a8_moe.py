...
# https://github.com/ROCm/aiter/pull/4530 is released and consumed by Aphrodite.
...
def patch_gating_output(gating_output: torch.Tensor, global_num_experts: int) -> torch.Tensor:
