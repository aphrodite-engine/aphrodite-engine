...
class CPUExpertsInt4(mk.FusedMoEExpertsMonolithic):
    ...
    def is_supported_config(
        ...
        if not current_platform.is_cpu() or current_platform.get_cpu_architecture() != CpuArchEnum.ARM:
        ...
        try:
            ...
            return (
                False,
                f"PyTorch {torch.__version__} does not support _dyn_quant_* 4bit ops. Install a newer version",
            )
