...
from aphrodite.model_executor.layers.quantization.utils.mxfp6_utils import (
    quant_dequant_mxfp6,
)
...
def is_model_fused_shared_expert_compatible(
    ...
    enabled = [getattr(layer, "is_fused_shared_expert_enabled", False) for layer in moe_layers]
...
def _mxfp4_quantize(
    ...
    # TODO: native mxfp4 is currently not integrated in aphrodite,
...
def _mxfp6_e3m2_quantize(
    ...
    # TODO: native mxfp6 is currently not integrated in aphrodite,
    # so simulating even on devices supporting this data type natively.
...
def fi_moe_largest_bucket(moe_config: "FusedMoEConfig") -> int:
    ...
    floor to avoid underestimating.
