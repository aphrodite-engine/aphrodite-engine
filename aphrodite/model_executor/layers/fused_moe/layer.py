...
from aphrodite.distributed.eplb.eplb_state import EplbLayerState, EplbState
...
class FusedMoE(PluggableLayer):
    ...
    def __init__(
        ...
        self.expert_placement_strategy: ExpertPlacementStrategy = (
            aphrodite_config.parallel_config.expert_placement_strategy
        )
        ...
        self.runner = create_moe_runner(
            ...
            enable_dbo=self.aphrodite_config.parallel_config.enable_dbo,
