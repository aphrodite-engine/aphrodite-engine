...
class FallbackExperts(mk.FusedMoEExpertsModular, ABC):
    ...
    def supports_expert_map(self) -> bool:
        assert self.experts.supports_expert_map() == self.fallback_experts.supports_expert_map()
        return self.experts.supports_expert_map() and self.fallback_experts.supports_expert_map()
