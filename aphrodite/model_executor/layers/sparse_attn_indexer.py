...
if current_platform.is_cuda_alike():
    from aphrodite import _custom_ops as _custom_ops
...
def sparse_attn_indexer(
    ...
    attn_metadata = cast(dict[str, Any], attn_metadata)[k_cache_prefix]
    ...
    if has_prefill:
        ...
        for chunk in prefill_metadata.chunks:
            ...
            if current_platform.is_xpu():
                ...
                torch.ops._C.top_k_per_row_prefill(  # type: ignore[attr-defined]
                    logits,
                    chunk.cu_seqlen_ks,
                    chunk.cu_seqlen_ke,
                    topk_indices,
    ...
    if has_decode:
        ...
        if current_platform.is_cuda() and topk_tokens in (512, 2048):
            ...
            torch.ops._C.persistent_topk(  # type: ignore[attr-defined]
                logits,
                seq_lens,
                topk_indices,
                topk_workspace,
            ...
            if current_platform.is_xpu():
                ...
                torch.ops._C.top_k_per_row_decode(  # type: ignore[attr-defined]
                    logits,
                    next_n,
                    seq_lens,
                    topk_indices,
...
class SparseAttnIndexer(CustomOp):
    ...
    def forward_hip(
        ...
        assert not self.skip_k_cache_insert, "AMD platform doesn't support skip cache insert yet"
