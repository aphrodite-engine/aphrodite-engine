...
class Mxfp4MoEMethod(FusedMoEMethodBase):
    ...
    def _setup_kernel(
        ...
        # AITER backend requires weights to be marked as shuffled.
        if self.mxfp4_backend == Mxfp4MoeBackend.AITER_MXFP4_BF16 and not uses_triton_weight_format:
            layer.w13_weight.is_shuffled = True
            layer.w2_weight.is_shuffled = True
    ...
    def _setup_kernel_k3_situ(self, layer: RoutedExperts) -> None:
        ...
        w13 = rocm_aiter_ops.shuffle_weight_a16w4(layer.w13_weight.data.view(fp4_dtype), 16, guinterleave)
        w2 = rocm_aiter_ops.shuffle_weight_a16w4(layer.w2_weight.data.view(fp4_dtype), 16, False)
