...
class GPTQMarlinMoEMethod(FusedMoEMethodBase):
    ...
    def __init__(
        ...
        self.wna16_moe_backend, self.experts_cls = select_wna16_moe_backend(moe, weight_key, quant_config.weight_bits)
    ...
    def process_weights_after_loading(self, layer: torch.nn.Module) -> None:
        ...
        if w13_bias is not None:
            if hasattr(layer, "w13_bias"):
                ...
                layer.register_parameter("w13_bias", torch.nn.Parameter(w13_bias, requires_grad=False))
