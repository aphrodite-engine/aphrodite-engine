...
from aphrodite.model_executor.kernels.linear import init_mxfp4_linear_kernel
...
from aphrodite.model_executor.layers.quantization.utils.quant_utils import kMxfp4Dynamic
...
class Mxfp4OnlineLinearMethod(OnlineLinearBase):
    ...
    def __init__(self):
        super().__init__()
        self.kernel = init_mxfp4_linear_kernel(activation_quant_key=self.activation_quant_key)
...
class Mxfp4OnlineMoEMethod(OnlineMoEMethodBase):
    ...
    def create_weights(
        ...
        **extra_weight_attrs,
        ...
        if hidden_size % MXFP4_BLOCK_SIZE != 0 or intermediate_size_per_partition % MXFP4_BLOCK_SIZE != 0:
            raise ValueError(f"Online MXFP4 MoE requires hidden/intermediate sizes divisible by {MXFP4_BLOCK_SIZE}.")
