...
class Nvfp4OnlineMoEMethod(OnlineMoEMethodBase):
    ...
    def __init__(
        ...
        *,
        ...
        if not current_platform.is_device_capability_family(100):
            raise ValueError("nvfp4_per_token online quantization requires a Blackwell (SM100) GPU.")
        super().__init__(moe)
    ...
    def _quantize_weights(self, layer: Module) -> None:
        ...
        w13, w13_scale, w13_scale_2 = _quantize_moe_weight_to_nvfp4(layer.w13_weight, moe_tp_size)
        w2, w2_scale, w2_scale_2 = _quantize_moe_weight_to_nvfp4(layer.w2_weight, moe_tp_size)
