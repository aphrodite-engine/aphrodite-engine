...
class INCXPUW4A8LinearMethod(INCXPULinearMethod):
    ...
    Opt in with ``APHRODITE_XPU_INC_WNA16_BACKEND=w4a8``. Whether this beats ARK is
        ...
        **extra_weight_attrs,
        ...
        if unaligned:
            raise NotImplementedError(
                "APHRODITE_XPU_INC_WNA16_BACKEND=w4a8 requires partitioned in/out "
    ...
    def process_weights_after_loading(self, layer: torch.nn.Module) -> None:
        ...
        layer.scales_fp16 = Parameter(layer.scales.data.to(torch.float16), requires_grad=False)
