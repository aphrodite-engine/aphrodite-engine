...
class CompressedTensorsW4A16FlydslMoEMethod(CompressedTensorsMoEMethod):
    def __init__(
        ...
        assert weight_quant.symmetric, "Only symmetric quantization is supported for MoE. Try --moe-backend emulation."
    ...
    def apply(
        ...
        from aphrodite.model_executor.layers.fused_moe.fused_flydsl_moe import (
            fused_flydsl_moe,
        )
