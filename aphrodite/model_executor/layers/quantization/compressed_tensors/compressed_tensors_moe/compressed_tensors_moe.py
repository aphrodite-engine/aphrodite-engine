        ...
        if quant_config._is_wNa16_group_channel(weight_quant, input_quant):
            ...
            if current_platform.is_rocm():
                ...
                if rocm_moe_rdna.is_supported(weight_quant):
                    return rocm_moe_rdna.make_method(weight_quant, input_quant, layer.moe_config)
                ...
                if (
                    ...
                    return CompressedTensorsW4A16FlydslMoEMethod(weight_quant, input_quant, layer.moe_config)
                elif moe_backend == "emulation":
                    logger.info_once("Using CompressedTensorsWNA16MoEMethod (emulation backend requested)")
