...
class INCConfig(QuantizationConfig):
    ...
    def apply_awq_quant_layer(self, layer, prefix: str, backend: str = "auto"):
        ...
        if backend == "auto" or "marlin" in backend:
            ...
            use_marlin = False
        if use_marlin:
            from aphrodite.model_executor.layers.quantization.awq_marlin import (
                AWQMarlinConfig,
            ...
            from aphrodite.model_executor.layers.quantization.awq import (
                AWQConfig,
                AWQLinearMethod,
            )
    ...
    def apply_gptq_quant_layer(self, layer, prefix: str, backend: str = "auto"):
        ...
        if use_marlin:
            ...
            from aphrodite.model_executor.layers.quantization.gptq import (
                GPTQConfig,
                GPTQLinearMethod,
            )
