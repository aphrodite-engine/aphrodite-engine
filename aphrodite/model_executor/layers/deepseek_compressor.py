...
from aphrodite.v1.attention.backends.mla.flashmla_sparse import FlashMLASparseMetadata
from aphrodite.v1.attention.ops.deepseek_v4_ops.fused_compress_quant_cache import (
    _fused_kv_compress_norm_rope_insert_indexer_attn,
    _fused_kv_compress_norm_rope_insert_indexer_mxfp4_attn,
    _fused_kv_compress_norm_rope_insert_sparse_attn,
)
from aphrodite.v1.attention.ops.deepseek_v4_ops.fused_indexer_q import (
    MXFP4_BLOCK_SIZE,
)
...
class DeepseekCompressor(nn.Module):
    def __init__(
        ...
        if self.head_dim == 512:
            ...
            if use_fp4_cache:
                self._fused_kernel = _fused_kv_compress_norm_rope_insert_indexer_mxfp4_attn
    ...
    def forward(
        ...
        k_cache_metadata = cast(FlashMLASparseMetadata, attn_metadata[self.k_cache_prefix])
...
def _save_partial_states_kernel(
    ...
    # by Aphrodite). During CUDA graph replay the batch may contain padding
