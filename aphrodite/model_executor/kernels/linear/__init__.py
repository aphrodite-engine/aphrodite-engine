...
# Maps APHRODITE_NVFP4_GEMM_BACKEND env var values to kernel classes.
...
def init_nvfp4_linear_kernel() -> NvFp4LinearKernel:
    ...
    elif envs.APHRODITE_USE_NVFP4_CT_EMULATIONS:
        force_kernel = EmulationNvFp4LinearKernel
    elif envs.APHRODITE_NVFP4_GEMM_BACKEND is not None:
        backend_name = envs.APHRODITE_NVFP4_GEMM_BACKEND
        force_kernel = _NVFP4_BACKEND_TO_KERNEL.get(backend_name)
        if force_kernel is None:
            raise ValueError(
                f"Unknown APHRODITE_NVFP4_GEMM_BACKEND={backend_name!r}. "
