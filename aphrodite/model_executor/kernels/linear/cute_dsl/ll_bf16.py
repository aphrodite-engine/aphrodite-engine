...
class LLBf16Gemm:
    ...
    def dispatch(self, *, M: int, K: int, N: int) -> CompileKey:
        ...
        split_k, num_stages = tuned_splitk.get((K, N), {}).get(M, _DEFAULT_SPLITK_CONFIG)
...
def ll_bf16_gemm(
    ...
    kernel = ll_bf16_gemm_c1_pdl_kernel if hidden_states.shape[0] == 1 else ll_bf16_gemm_kernel
