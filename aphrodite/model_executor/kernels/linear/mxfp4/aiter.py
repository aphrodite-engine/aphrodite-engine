...
class AiterMxfp4LinearKernel(MxFp4LinearKernel):
    ...
    def is_supported(cls, compute_capability: int | None = None) -> tuple[bool, str | None]:
        ...
        from aphrodite.model_executor.kernels.linear import _get_linear_backend
        ...
        if (
            ...
            and "AiterMxfp4LinearKernel" not in envs.APHRODITE_DISABLED_KERNELS
    ...
    def process_weights_after_loading(self, layer: torch.nn.Module) -> None:
        if self.use_asm_gemm:
            ...
            layer.weight_scale = Parameter(layer.weight_scale.data.T.contiguous(), requires_grad=False)
