...
from aphrodite.utils.import_utils import has_quark

from .base import MxFp4LinearKernel, MxFp4LinearLayerConfig

logger = init_logger(__name__)

_ACTIVATION_QUANT_DEQUANT_FUNCS: dict[QuantKey, Callable[[torch.Tensor], torch.Tensor]] = {
...
class EmulationMxfp4LinearKernel(MxFp4LinearKernel):
    ...
    def __init__(self, config: MxFp4LinearLayerConfig) -> None:
        ...
        if config.activation_quant_key is None:
            ...
            self.quant_dequant_func: Callable[[torch.Tensor], torch.Tensor] = lambda x: x
        else:
            self.quant_dequant_func = _ACTIVATION_QUANT_DEQUANT_FUNCS[config.activation_quant_key]
    ...
    def can_implement(cls, config: MxFp4LinearLayerConfig) -> tuple[bool, str | None]:
        ...
        if (
            ...
            logger.warning_once(
                ...
                f"are not yet integrated in Aphrodite. Using EmulationMxfp4LinearKernel, "
