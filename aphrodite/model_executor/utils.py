...
_weights_pre_processed: ContextVar[bool] = ContextVar("weights_pre_processed", default=False)
...
def replace_parameter(
    ...
    # `BaseAphroditeParameter`'s backing field for its `weight_loader` property, so
