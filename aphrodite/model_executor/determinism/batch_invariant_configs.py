...
def resolve_tuned_matmul_configs() -> None:
    ...
    # Normal Aphrodite initialization resolves this before torch.compile tracing.
...
def _get_descriptor_matmul_config(M: int, N: int, K: int, dtype: torch.dtype) -> dict[str, int]:
