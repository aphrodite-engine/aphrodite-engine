...
# profile run. APHRODITE_USE_V2_MODEL_RUNNER=1 still forces V2.
...
class AphroditeConfig:
    ...
    def __post_init__(self):
        ...
        if self.use_v2_model_runner:
            ...
            raise ValueError(
                "Prefill context parallelism requires Model Runner V2. Remove APHRODITE_USE_V2_MODEL_RUNNER=0."
            )
    ...
    def _get_v2_model_runner_unsupported_features(self) -> list[str]:
        ...
        if speculative_config is not None:
            ...
            if speculative_config.method == "eagle3" and self.parallel_config.pipeline_parallel_size > 1:
