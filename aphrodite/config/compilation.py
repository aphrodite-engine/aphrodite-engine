...
class CompilationConfig:
    ...
    - Top-level Compilation control:
        - [`level`][aphrodite.config.CompilationConfig.level]
    ...
    - CudaGraph capture:
        ...
        - [`cudagraph_mode`]
        [aphrodite.config.CompilationConfig.cudagraph_mode]
    ...
    def set_splitting_ops_for_v1(self):
        ...
        if self.splitting_ops is None:
            ...
            log_once("WARNING", "Using piecewise compilation with empty "
                                "splitting_ops.")
            if self.cudagraph_mode == CUDAGraphMode.PIECEWISE:
                log_once("WARNING", "When compilation level is piecewise with empty "
