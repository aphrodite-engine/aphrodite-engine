...
class CompilationConfig:
    ...
    - CudaGraph capture:
        - [`use_cudagraph`][aphrodite.config.CompilationConfig.use_cudagraph]
        ...
        - [`full_cuda_graph`][aphrodite.config.CompilationConfig.full_cuda_graph]
    - Inductor compilation:
        - [`use_inductor`][aphrodite.config.CompilationConfig.use_inductor]
    ...
    disabled when running with Inductor: mode>=APHRODITE_COMPILE and use_inductor=True.
    ...
    This setting is ignored if mode<APHRODITE_COMPILE.
    ...
    _attention_ops: ClassVar[list[str]] = [
        ...
        "aphrodite::unified_mla_attention",
    ...
    def init_backend(self, aphrodite_config: "AphroditeConfig") -> str | Callable:
        """
        ...
        # https://github.com/aphrodite-project/aphrodite/issues/27045
    ...
    def set_splitting_ops_for_v1(self):
        ...
        if self.splitting_ops is None:
            ...
            # captured. see https://github.com/aphrodite-project/aphrodite/pull/20059
