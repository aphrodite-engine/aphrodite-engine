...
class ParallelConfig:
    ...
    the value from APHRODITE_ALL2ALL_BACKEND environment variable. Available options:
    ...
    def __post_init__(self) -> None:
        ...
        if self.all2all_backend is None:
            self.all2all_backend = envs.APHRODITE_ALL2ALL_BACKEND
            if envs.is_set("APHRODITE_ALL2ALL_BACKEND"):
                logger.warning_once(
                    "APHRODITE_ALL2ALL_BACKEND environment variable is deprecated and "
