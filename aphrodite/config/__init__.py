...
_SUFFIX_TO_DEFAULTS: list[tuple[str, tuple[RunnerType, ConvertType]]] = [
    ...
    # UNet models
    ("UNet2DConditionModel", ("unet", "none")),
...
class ModelConfig:
    ...
    - `"weights"`: Within the same Aphrodite engine, split the weights of
        each layer across TP ranks. (default TP behavior)
    - `"data"`: Within the same Aphrodite engine, split the batched input data
...
class LoRAConfig:
    ...
    LoRA adapter. Will be removed in a future release."""
...
class PoolerConfig:
    ...
    APHRODITE_ALLOW_LONG_MAX_MODEL_LEN environment variable. When an input exceeds
    ...
    def __post_init__(self):
        ...
        if current_platform.is_cuda_alike() or current_platform.is_xpu():
            ...
            if self.compilation_config.cudagraph_mode is None:
                if envs.APHRODITE_USE_V1 and self.compilation_config.level \
        ...
        if envs.APHRODITE_USE_V1 and current_platform.is_cuda_alike():
