...
class AphroditeInductorPass(InductorPass):
    ...
    def time_and_log(call_fn):
        ...
        def wrapped(self: AphroditeInductorPass, graph: torch.fx.Graph):
            self.begin()
...
class AphroditePatternMatcherPass(AphroditeInductorPass):
    ...
    def dump_patterns(self, config: AphroditeConfig, pm_pass: PatternMatcherPass):
        """
...
class PrinterInductorPass(AphroditeInductorPass):
    def __init__(self, name: str, config: AphroditeConfig):
