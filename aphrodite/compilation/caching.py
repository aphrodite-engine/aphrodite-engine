...
class AphroditeSerializableFunction(SerializableCallable):
    """
    ...
    def deserialize_compile_artifacts(cls, data: bytes) -> "AphroditeSerializableFunction":
        ...
        aphrodite_backend = AphroditeBackend(get_current_aphrodite_config(), state["prefix"])
...
def compilation_config_hash_factors(aphrodite_config: AphroditeConfig) -> list[str]:
    factors = []
