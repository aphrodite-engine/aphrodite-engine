...
from aphrodite.quantization.utils.quant_utils import kFp8StaticTensorSym
...
class GEMMReduceScatterPattern(BasePattern):
    ...
    def register(self, pm_pass: PatternMatcherPass):
        def pattern(mul: torch.Tensor, mm_weight: torch.Tensor):
            ...
            reduce_scatter = torch.ops.aphrodite.reduce_scatter.default(
                mm,
                dim=0,
...
class ScaledMMReduceScatterPattern(BasePattern):
    ...
    def register(self, pm_pass: PatternMatcherPass):
        ...
        def replacement(
            ...
            scatter_dim = 0
            gemm_rs = torch.ops.aphrodite.patched_fused_scaled_matmul_reduce_scatter(
                input,
                mat2,
                scale_a,
                scale_b,
        ...
        _FI_MAX_SIZES.update(
            {
                ...
                for k, v in envs.APHRODITE_FLASHINFER_ALLREDUCE_FUSION_THRESHOLDS_MB.items()
            }
        )
    except Exception as e:
        raise ValueError(
            "Failed to parse APHRODITE_FLASHINFER_ALLREDUCE_FUSION_THRESHOLDS_MB: " + str(e)
        ) from e
