...
ALLREDUCE_OP = torch.ops.aphrodite.all_reduce.default
...
class AsyncTPPass(AphroditeInductorPass):
    ...
    def __call__(self, graph: fx.Graph):
        ...
        logger.debug("Replaced {} patterns with async TP pass.", count)
...
class AllReduceFusionPass(AphroditeInductorPass):
