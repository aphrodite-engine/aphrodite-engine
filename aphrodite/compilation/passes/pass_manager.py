...
if current_platform.is_cuda_alike() or current_platform.is_xpu():
    from .fusion.add_rms_fusion import AddRMSNormFusionPass, RMSNormReshapeFusionPass
...
class PostGradPassManager(CustomGraphPass):  # type: ignore[misc]
    ...
    def __call__(self, graph: fx.Graph) -> None:
        ...
        AphroditePatternMatcherPass.log_match_summary()

    def configure(self, config: AphroditeConfig) -> None:
