...
if hasattr(torch.ops._C, "minimax_allreduce_rms_qk"):
    ...
    def _minimax_qk_norm_fused(
        ...
        from aphrodite.model_executor.layers.mamba.lamport_workspace import (
    ...
    _MINIMAX_QK_NORM_FUSED_OP = torch.ops.aphrodite.minimax_qk_norm_fused.default
...
class MiniMaxQKNormPattern:
    ...
    def register(self, pm_pass: PatternMatcherPass) -> None:
        ...
        def replacement(
            ...
            q_out, k_out = torch.ops.aphrodite.minimax_qk_norm_fused(
                qkv,
                q_weight,
                k_weight,
                q_size,
...
class MiniMaxQKNormPass(AphroditePatternMatcherPass):
    ...
    def uuid(self) -> str:
        return AphroditeInductorPass.hash_source(self, MiniMaxQKNormPattern)
