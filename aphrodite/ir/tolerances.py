...
DEFAULT_TOLERANCES: ToleranceSpec = {
    ...
    # Standard tolerance used across Aphrodite kernel tests.
    ...
    # Derived from Aphrodite fp8 kernel tests (merge_attn_states, silu_mul_fp8).
    ...
    # Derived from Aphrodite fp4 tests (test_silu_mul_nvfp4_quant: atol=3e-1).
