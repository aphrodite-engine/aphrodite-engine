...
def is_blackwell_deep_gemm_e8m0_used() -> bool:
    ...
    """
    if not (envs.APHRODITE_USE_DEEP_GEMM):
        log_once(
            "DEBUG",
            "DeepGEMM E8M0 disabled: APHRODITE_USE_DEEP_GEMM=0.")
        return False
    ...
    if not envs.APHRODITE_USE_DEEP_GEMM_E8M0:
        log_once(
            "DEBUG",
            "DeepGEMM E8M0 disabled: APHRODITE_USE_DEEP_GEMM_E8M0=0.")
        return False
