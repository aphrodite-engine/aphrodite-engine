...
def _missing(*_: Any, **__: Any) -> NoReturn:
    ...
    raise RuntimeError(
        "DeepGEMM backend is unavailable in the current Aphrodite environment, "
...
def _paged_mqa_logits_schedule_slots(num_sms: int, next_n: int) -> int:
    ...
    """
    num_kv_multicast = 2 if next_n == 4 and current_platform.is_device_capability_family(90) else 1
...
def get_paged_mqa_logits_metadata(
    ...
    return _get_paged_mqa_logits_metadata_impl(context_lens, block_size, num_slots, **kwargs)
