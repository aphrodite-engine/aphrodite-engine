...
class FlexibleArgumentParser(ArgumentParser):
    ...
    def error(self, message: str) -> NoReturn:
        if (
            ...
            message += (
                "\n\nHint: --task is not a aphrodite serve option. "
    ...
    def parse_args(  # type: ignore[override]
        ...
        if args is None:
            args = sys.argv[1:]
        self._show_serve_task_hint = args[:1] == ["serve"] and any(re.match(r"^--task(=.+|$)", arg) for arg in args[1:])
        ...
        if args and args[0] == "serve":
            ...
            try:
                ...
                # [Before]
                # aphrodite serve -tp 2 --model <model> --enforce-eager --port 8001
                # [After]
                # aphrodite serve <model> -tp 2 --enforce-eager --port 8001
                args = [
                    "serve",
                    model_tag,
                    *args[1:model_idx],
