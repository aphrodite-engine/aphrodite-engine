...
from typing import (TYPE_CHECKING, Any, Generic, Literal, NamedTuple,
                    TypeAlias, TypeGuard, TypeVar)
...
class MultiModalDataItems(UserDict[str, ModalityDataItems[Any, Any]]):
    """
    As [`MultiModalDataDict`][aphrodite.multimodal.inputs.MultiModalDataDict], but
...
class MultiModalDataParser:
    """
    Parses [`MultiModalDataDict`][aphrodite.multimodal.inputs.MultiModalDataDict]
