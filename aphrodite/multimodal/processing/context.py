...
# ``audio_kwargs`` in addition to a shared flat namespace. Aphrodite's token-budget
...
class InputProcessingContext:
    ...
    def get_merged_mm_kwargs(
        ...
        *,
        ...
        onto the flat namespace for Aphrodite-side reads (token budgets, dummy
    ...
    def call_hf_processor(
        ...
        # Aphrodite needs the full untruncated sequence to keep multi-modal
...
class BaseProcessingInfo:
    ...
    def parse_mm_data(
        ...
        *,
        ...
        """
        Normalize [`MultiModalDataDict`][aphrodite.inputs.MultiModalDataDict]
