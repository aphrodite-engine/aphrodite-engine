...
from aphrodite.transformers_utils.processor import call_hf_processor_mm_only
...
def _apply_matches(
    ...
    mm_found_counts = {m: sum(r is not None for r in res) for m, res in out_result.items()}
