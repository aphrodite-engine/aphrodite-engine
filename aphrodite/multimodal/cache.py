...
class ShmObjectStoreSenderCache(BaseMultiModalProcessorCache):
    ...
    def __init__(self, aphrodite_config: "AphroditeConfig") -> None:
        ...
        self.world_size = aphrodite_config.parallel_config.world_size
        ...
        ring_buffer = SingleWriterShmRingBuffer(
            ...
            name=envs.APHRODITE_OBJECT_STORAGE_SHM_BUFFER_NAME,
...
def _enable_mm_input_shm_cache(aphrodite_config: "AphroditeConfig") -> bool:
    """Whether the shared memory based cache should be enabled."""

    if not _enable_ipc_cache(aphrodite_config):
        return False
...
def processor_cache_from_config(
    ...
    if not _enable_mm_input_shm_cache(aphrodite_config):
