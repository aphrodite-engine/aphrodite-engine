...
DEEPSTREAM_VIDEO_BACKEND: Final = "deepstream"
...
class VideoLoader:
    ...
    def read_frames(
        ...
        *,
        ...
        from aphrodite.multimodal.video_decoders.opencv import OpenCVVideoBackendMixin
...
class Glm5NextVideoBackend(VideoBackend):
    ...
    def read_frames(
        ...
        *,
        ...
        if frame_recovery:
            return super().read_frames(cap, frame_idx, total_frames_num, frame_recovery=frame_recovery)
        ...
        for target in wanted:
            ...
            ok, frame = cap.read()
            if ok:
                frames[len(valid_frame_indices)] = cv2.cvtColor(frame, cv2.COLOR_BGR2RGB)
