...
def decode_deepstream(
    ...
    *,
    ...
    source = loader_cls._prepare_source(VideoSourceMetadata(total_frames, original_fps, duration))
    frame_idx = loader_cls.compute_frames_index_to_sample(source=source, target=target, **sampling_kwargs)
