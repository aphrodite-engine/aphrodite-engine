...
class MultiModalFieldElem:
    ...
    in [`MultiModalKwargs`][aphrodite.multimodal.inputs.MultiModalKwargs].
    """
...
class BaseMultiModalField(ABC):
    ...
    [`MultiModalKwargs`][aphrodite.multimodal.inputs.MultiModalKwargs] for multiple
...
class MultiModalKwargs(UserDict[str, NestedTensors]):
    ...
    [`MultiModalDataItems`][aphrodite.multimodal.parse.MultiModalDataItems], via
    [`get_item`][aphrodite.multimodal.inputs.MultiModalKwargs.get_item] and
    [`get_items`][aphrodite.multimodal.inputs.MultiModalKwargs.get_items].
    """
