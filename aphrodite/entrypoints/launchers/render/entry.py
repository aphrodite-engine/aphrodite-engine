...
from aphrodite import AsyncEngineArgs, envs
...
logger = init_logger("aphrodite.entrypoints.launchers.render.entry")
...
if __name__ == "__main__":
    ...
    from aphrodite.entrypoints.serve.utils.api_utils import cli_env_setup
    ...
    parser = FlexibleArgumentParser(
        description="Starts a GPU-less rendering server for preprocessing and postprocessing only"
    )
