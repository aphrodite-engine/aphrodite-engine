...
def __getattr__(name: str):
    if name == "resolve_hf_chat_template":
        ...
        warnings.warn(
            "`aphrodite.entrypoints.chat_utils.resolve_hf_chat_template` has been moved to "
            "`aphrodite.renderers.hf.resolve_chat_template`. "
...
class AsyncMultiModalContentParser(BaseMultiModalContentParser):
    ...
    def parse_image_embeds(
        ...
        future = asyncio.Future[tuple[torch.Tensor | dict[str, torch.Tensor] | None, str | None]]()
