...
from aphrodite.entrypoints.openai.realtime.protocol import (
    ErrorEvent,
...
from aphrodite.entrypoints.openai.realtime.serving import OpenAIServingRealtime
...
class RealtimeConnection:
    ...
    def __init__(self, websocket: WebSocket, serving: OpenAIServingRealtime):
        ...
        self._max_audio_filesize_mb = envs.APHRODITE_MAX_AUDIO_CLIP_FILESIZE_MB
        ...
        if event_type == "session.update":
            ...
            try:
                ...
                if len(audio_array) == 0:
                    raise APHRODITEValidationError("Can't process empty audio.")
