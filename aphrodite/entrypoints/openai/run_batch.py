...
from aphrodite.entrypoints.openai.cli_args import BaseFrontendArgs
        ...
        if result is not None:
            ...
            response_futures.append(
                make_async_error_request_output(
                    ...
                    " /rerank. See aphrodite/entrypoints/openai/api_server.py "
...
async def main(args: Namespace):
    from aphrodite.entrypoints.openai.api_server import build_async_engine_client
