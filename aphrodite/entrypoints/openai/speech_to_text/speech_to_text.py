...
from aphrodite.entrypoints.utils import get_max_tokens
from aphrodite.exceptions import APHRODITEValidationError
from aphrodite.inputs import EncoderDecoderInput, EngineInput
from aphrodite.logger import init_logger
from aphrodite.logprobs import FlatLogprobs, Logprob
from aphrodite.model_executor.models import SupportsTranscription
from aphrodite.multimodal.audio import get_audio_duration, split_audio
...
class OpenAISpeechToText(OpenAIServing):
    ...
    async def _create_speech_to_text(
        ...
        input_len = OpenAISpeechToText._get_decoder_prompt_len(engine_inputs) if request.use_beam_search else 0
