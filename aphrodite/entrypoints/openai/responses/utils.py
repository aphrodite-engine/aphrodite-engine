...
from aphrodite.entrypoints.generate.base.protocol import FunctionCall, FunctionDefinition
...
def convert_tool_responses_to_completions_format(
    ...
    return ChatCompletionToolsParam(
        type="function",
        function=FunctionDefinition.model_validate({k: v for k, v in tool.items() if k != "type"}),
    )
