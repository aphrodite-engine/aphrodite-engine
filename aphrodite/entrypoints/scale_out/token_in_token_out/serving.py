...
from aphrodite.entrypoints.chat_utils import AsyncMultiModalItemTracker
...
from aphrodite.inputs import EngineInput, TokensPrompt, mm_input
...
class ServingTokens(GenerateBaseServing):
    ...
    async def serve_tokens(
        ...
        max_num_seqs = self.engine_client.aphrodite_config.scheduler_config.max_num_seqs
        ...
        sampling_params.output_kind = RequestOutputKind.DELTA if request.stream else RequestOutputKind.FINAL_ONLY
        ...
        try:
            async for res in result_generator:
                ...
                for output in res.outputs:
                    ...
                    routed_experts_b64 = (
                        numpy2base64(output.routed_experts) if output.routed_experts is not None else None
                    )
