...
from aphrodite.entrypoints.offline_utils import OfflineInferenceMixin
from aphrodite.inputs import DataPrompt, PromptType
...
from aphrodite.tasks import SCORE_TYPE_MAP, PoolingTask, SupportedTask
...
class PoolingOfflineMixin(OfflineInferenceMixin):
    ...
    def encode(
        ...
        *,
        ...
        outputs = self._run_tiling_engine(io_processor, request_factory, num_requests, use_tqdm=use_tqdm)
    ...
    def score(
        ...
        *,
        ...
        if pooling_params.task is None:
            ...
            msg = f"You cannot overwrite {pooling_params.task=!r} with {pooling_task=!r}!"
