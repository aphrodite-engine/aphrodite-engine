...
from aphrodite.inputs.data import TextPrompt as EngineTextPrompt
from aphrodite.inputs.data import TokensPrompt as EngineTokensPrompt
from aphrodite.inputs.parse import get_prompt_components, parse_raw_prompts
...
class BaseRenderer(ABC):
    ...
    async def render_prompt(
        ...
        *,
        ...
        list of [`TokensPrompt`][aphrodite.inputs.data.TokensPrompt] objects
        for the engine.
