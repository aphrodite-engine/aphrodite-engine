...
# Cannot use __name__ (https://github.com/aphrodite-project/aphrodite/pull/4765)
logger = init_logger("aphrodite.endpoints.anthropic.api_server")
...
def setup_server(args):
    ...
    # see https://github.com/aphrodite-project/aphrodite/issues/8204
...
async def run_server_worker(listen_address, sock, args, client_config=None, **uvicorn_kwargs) -> None:
    ...
    async with build_async_engine_client(
        ...
        logger.info("Starting Aphrodite API server %d on %s", server_index, listen_address)
