        ...
        if request.url == "/v1/chat/completions":
            ...
            response_futures.append(
                make_async_error_request_output(
                    ...
                    " /score, /rerank ."
                    "See aphrodite/endpoints/openai/api_server.py for supported "
...
async def main(args: Namespace):
    async with build_async_engine_client(
        ...
        await run_batch(engine_client, aphrodite_config, args)


if __name__ == "__main__":
    args = parse_args()

    logger.info("Aphrodite batch processing API version {}", APHRODITE_VERSION)
