...
class StreamingXMLToolCallParser:
    ...
    def parse_single_streaming_chunks(self, xml_chunk: str) -> DeltaMessage:
        ...
        if found_elements:
            ...
            try:
                ...
                if self.current_call_id is not None and self.function_end_token in xml_chunk:
                ...
                if self.current_call_id is not None and self.tool_call_end_token in xml_chunk:
    ...
    def _preprocess_xml_chunk(self, chunk: str) -> str:
        ...
        if chunk.startswith(self.tool_call_start_token) or chunk.startswith(self.tool_call_end_token):
            is_tool_call = True
        if chunk.startswith(self.function_start_token) or chunk.startswith(self.function_end_token):
            is_tool_call = True
