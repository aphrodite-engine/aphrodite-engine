...
from aphrodite.common.sampling_params import (BeamSearchParams,
                                              RequestOutputKind,
                                              SamplingParams)
from aphrodite.config import (CompilationConfig, ModelDType, TokenizerMode,
                              is_init_field)
...
from aphrodite.utils import Counter, Device, as_iter, is_list_of
...
class LLM:
    ...
    Note:
        ...
        serving, use the [AsyncAphrodite][aphrodite.AsyncAphrodite] class instead.
    """
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.llm_engine = AphroditeEngine.from_engine_args(
    ...
    def get_metrics(self) -> list["Metric"]:
        ...
        from aphrodite.v1.engine.llm_engine import (
            AphroditeEngine as V1LLMEngine)
