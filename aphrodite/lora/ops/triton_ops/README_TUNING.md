...
**Note**: The LoRA configuration folder should be specified by exporting `APHRODITE_TUNED_CONFIG_FOLDER=/path/to/configs`. Without this, the shrink/expand kernels will use default configurations.
...
For example, we can aquire those info by simply checking [add_lora_linear](https://github.com/li2haipeng/vllm/blob/multi_lora_v01011/aphrodite/lora/punica_wrapper/punica_gpu.py#L192):
