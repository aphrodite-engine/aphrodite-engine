...
class FusedMoEWithLoRA(BaseLayerWithLoRA):
    def __init__(self, base_layer: MoERunner) -> None:
        ...
        self._enable_aux_cuda_stream = envs.APHRODITE_LORA_ENABLE_DUAL_STREAM
    ...
    def create_lora_weights(
        ...
        for lora_id in range(max_loras):
            for experts_id in range(self.local_num_experts):
                ...
                self.lora_a_stacked.append(self.w13_lora_a_stacked[0][lora_id][w13_a_eid])
                ...
                if self._w13_slices == 2:
                    self.lora_a_stacked.append(self.w13_lora_a_stacked[1][lora_id][w13_a_eid])
    ...
    def _match_expert_dim(self, src: torch.Tensor, buffer: torch.Tensor) -> torch.Tensor:
    ...
    def set_lora(
        ...
        # Shared-loras buffers collapse w13 lora_A and w2 lora_B to expert-dim 1.
