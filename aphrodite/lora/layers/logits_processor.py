...
class LogitsProcessorWithLoRA(BaseLayerWithLoRA):
    ...
    def _get_logits(
        ...
        if skip_gather:
            raise NotImplementedError("Skipping the logits TP gather is not supported with an lm_head LoRA.")
        ...
        logits = self.base_layer._apply_head(actual_lm_head, hidden_states, embedding_bias)
