...
class LoRALayerWeights:
    ...
    def __init__(
        ...
        Args:
            ...
            lora_a: The A matrix of the LoRA.
            lora_b: The B matrix of the LoRA.
            bias: The bias of the LoRA.
            embeddings_tensor: The embeddings tensor of the LoRA.
            scaling: The scaling of the LoRA.

        NOTE: `rank==None` means that we have full rank tensors (ModulesToSave)
              In this case:
                lora_a=None
                lorab_b=full rank tensor
        """
