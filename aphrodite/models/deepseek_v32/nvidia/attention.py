...
from aphrodite.utils.torch_utils import _encode_layer_name, is_quantized_kv_cache
...
class DeepseekV32Attention(MLAAttention):
    ...
    def _decode_m_gemm(self, x: torch.Tensor, weight: torch.Tensor, skinny_max: int) -> torch.Tensor:
