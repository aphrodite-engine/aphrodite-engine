...
def _fused_norm_rope_kernel(
    ...
    if pid == 2:
        ...
        # non-owner ranks have a negative slot mapping but still contribute a
        # query-head shard to the subsequent all-gather.
    ...
    if slot_idx < 0:
        # Padding or a token owned by another DCP rank.
        return
