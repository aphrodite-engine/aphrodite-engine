...
class DeepseekV4SparseMLAMetadataBuilder(AttentionMetadataBuilder[DeepseekV4FlashMLAMetadata]):
...
def build_c128a_topk_metadata(
    ...
    assert 0 < max_compressed_tokens <= min(global_decode_buffer.shape[1], prefill_buffer.shape[1])
