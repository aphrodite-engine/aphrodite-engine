    ...
    def _forward_prefill(
        ...
        for chunk_start, chunk_end, chunk_N, chunk_M in chunk_plan:
            ...
            combined_indices, combined_lens = combine_topk_swa_indices(
                ...
                left_visible=(
                    swa_metadata.prefill_left_visible[num_decode_tokens + query_start : num_decode_tokens + query_end]
                    if swa_metadata.prefill_left_visible is not None
                    else None
                ),
                right_visible=(
                    swa_metadata.prefill_right_visible[num_decode_tokens + query_start : num_decode_tokens + query_end]
