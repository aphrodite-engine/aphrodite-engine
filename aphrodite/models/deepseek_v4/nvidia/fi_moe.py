...
if TYPE_CHECKING:
    ...
    from aphrodite.models.deepseek_v4.nvidia.model import DeepseekV4MLP

_MOE_SKIP_PADDING: bool | None = None


def ckpt_uses_nvfp4_experts(aphrodite_config: AphroditeConfig) -> bool:
    ...
    ``moe_quant_algo``.
    """
    return getattr(aphrodite_config.quant_config, "moe_quant_algo", "") == "NVFP4"
...
def resolve_mega_moe_is_padding(num_tokens: int) -> torch.Tensor | None:
    ...
    if _MOE_SKIP_PADDING is None:
        ...
        _MOE_SKIP_PADDING = bool(envs.APHRODITE_MOE_SKIP_PADDING)
...
class DeepseekV4MegaMoEExpertsFI(DeepseekV4MegaMoEExperts):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._nvfp4_prequant = ckpt_uses_nvfp4_experts(aphrodite_config)
    ...
    def _realloc_nvfp4_params(self) -> None:
        ...
        self.w13_weight_scale = _param((n_e, 2 * inter, hidden // 16), torch.float8_e4m3fn)
    ...
    def finalize_weights(self, shared_experts: DeepseekV4MLP | None = None) -> None:
        ...
        ensure_fi_moe_ep_runtime(self._aphrodite_config)
        ...
        if self._nvfp4_prequant:
            ...
            weights = mega_moe_weight_pack_from_params(
                ...
                megakernel=fi_moe_ep_backend_spec(self._aphrodite_config.kernel_config.moe_backend).megakernel,
            )
