...
class MiniMaxM3SparseMSAMetadataBuilder(MiniMaxM3SparseMetadataBuilder):
    ...
    def __init__(
        ...
        self.decode_backend = aphrodite_config.attention_config.minimax_m3_msa_decode_backend
...
class MiniMaxM3SparseMSAImpl(MiniMaxM3SparseImpl):
    ...
    def should_use_msa_decode(self, layer_name: str) -> bool:
        ...
        return isinstance(decode, MiniMaxM3SparseMSADecodeMetadata) and decode.msa_cutlass is not None
    ...
    def forward(
        ...
        *,
        ...
        if main_md.num_decodes > 0:
            ...
            msa_metadata = d.msa_cutlass if isinstance(d, MiniMaxM3SparseMSADecodeMetadata) else None
        ...
        if main_md.num_prefills > 0:
            from aphrodite.third_party.fmha_sm100.sparse import (
                build_k2q_csr,
                sparse_atten_func,
            )
