...
class MiniMaxM3SparseAttention(nn.Module, AttentionLayerBase):
    ...
    def __init__(
        ...
        self.indexer_kv_dtype = aphrodite_config.attention_config.resolve_indexer_kv_dtype("bf16")
        ...
        self.impl: MiniMaxM3SparseImpl = impl_cls(  # type: ignore[assignment]
            ...
            msa_decode_backend=(aphrodite_config.attention_config.minimax_m3_msa_decode_backend),
        )
...
class MiniMaxM3DecoderLayer(nn.Module):
    def __init__(
        ...
        *,
        ...
        reduce_results = is_mtp_block or aphrodite_config.parallel_config.pipeline_parallel_size > 1
...
class MiniMaxM3Model(nn.Module, EagleModelMixin):
    ...
    def forward(
        ...
        if self.fuse_final_norm_allreduce:
            hidden_states, _ = fused_allreduce_gemma_rms_norm(hidden_states, residual, self.norm)
        else:
