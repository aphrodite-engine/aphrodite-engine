...
from aphrodite.transformers_utils.configs.minimax_m3 import MiniMaxM3Config
from aphrodite.transformers_utils.processors.minimax_m3 import (
...
class MiniMaxM3VLMultiModalProcessor(BaseMultiModalProcessor[MiniMaxM3VLProcessingInfo]):
    ...
    def _call_hf_processor(
        ...
        # pre-resized pipeline) to True for Aphrodite's raw-frame inputs.
