...
"""Aphrodite composition layer for Dots3Note image and audio encoders."""
...
class Dots3NoteForCausalLM(nn.Module, SupportsMultiModal, SupportsPP):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = "") -> None:
        ...
        video_enabled = vision_config_dict is not None and self.multimodal_config.get_limit_per_prompt("video") > 0
        ...
        with self._mark_tower_model(aphrodite_config, {"image", "audio", "video"}):
            ...
            if audio_enabled:
                ...
                self.audio_tower = Dots3NoteAudioModel(Dots3NoteAudioConfig(**audio_config_dict))
            else:
            ...
            # which merely constructing under Aphrodite's default dtype does not.
