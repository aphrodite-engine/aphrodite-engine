...
class Gemma4ReasoningParser(BaseThinkingReasoningParser):
    ...
    (``aphrodite.reasoning.gemma4_utils._strip_thought_label``).
    """
    ...
    def extract_reasoning_streaming(
        ...
        ``skip_special_tokens=True`` (the Aphrodite default) causes the
...
def _strip_thought_label(text: str) -> str:
    ...
    Mirrors ``aphrodite.reasoning.gemma4_utils._strip_thought_label`` from the
    offline parser.
    """
