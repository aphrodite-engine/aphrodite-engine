...
from aphrodite.omni.core.sched.output import OmniCachedRequestData, OmniNewRequestData
...
from aphrodite.v1.core.sched.interface import PauseState
...
class OmniGenerationScheduler(OmniSchedulerMixin, APHRODITEScheduler):
    ...
    def _record_prefill_stats(request: Request) -> None:
        ...
        the first scheduled prompt snapshot. Keep this in sync with Sonar
    ...
    def schedule(self, throttle_prefills: bool = False) -> SchedulerOutput:
        ...
        while req_index < len(self.running) and token_budget > 0:
            ...
            required_tokens = request.num_prompt_tokens - num_computed_tokens
        ...
        while self.waiting and token_budget > 0 and self._pause_state == PauseState.UNPAUSED:
            ...
            # runner slot. Mirror Sonar's treatment of
            ...
            if self.chunk_transfer_adapter is not None and request.num_prompt_tokens == 0:
            ...
            required_tokens = max(request.num_prompt_tokens, 1)
            num_new_tokens = min(required_tokens, token_budget)
            new_blocks = self.kv_cache_manager.allocate_slots(
                request,
                num_new_tokens,
    ...
    def update_from_output(
        ...
        mm_outputs = (
            model_runner_output.multimodal_outputs if isinstance(model_runner_output, OmniModelRunnerOutput) else None
        )
        ...
        for req_id, num_tokens_scheduled in num_scheduled_tokens.items():
            ...
            if stopped:
                ...
                if status_before_stop == cast(RequestStatus, getattr(RequestStatus, "WAITING_FOR_CHUNK")):
