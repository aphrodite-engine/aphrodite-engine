...
from aphrodite.inputs import EmbedsInput, SingletonInput
from aphrodite.logger import init_logger
from aphrodite.omni.inputs.base import InputPreprocessor
...
from aphrodite.renderers.inputs import SingletonDictPrompt
...
class OmniInputPreprocessor(InputPreprocessor):
    ...
    def _process_text(
        ...
        *,
    ...
    ) -> OmniTokenInputs | OmniMultiModalInput:
        ...
        inputs: OmniTokenInputs | OmniMultiModalInput
    ...
    def _prompt_to_llm_inputs(
        ...
        * [`SingletonInput`][aphrodite.inputs.engine.SingletonInput] instance
        """
