...
# Use the native query; Sonar's XPU custom op reports free=0 in spawned workers.
torch.accelerator.get_memory_info = lambda device=None: torch.xpu.mem_get_info(device)

# The XPU sampler kernel is broken for omni on the current Sonar; use the native path.
os.environ.setdefault("APHRODITE_XPU_USE_SAMPLER_KERNEL", "0")


class XPUOmniPlatform(OmniPlatform, XPUPlatform):
    """XPU/Intel GPU implementation of OmniPlatform.

    Inherits all XPU-specific implementations from Sonar's XPUPlatform,
    ...
    def get_omni_ar_worker_cls(cls) -> str:
        return "aphrodite.omni.platforms.xpu.worker.xpu_ar_worker.XPUARWorker"

    @classmethod
    def get_omni_generation_worker_cls(cls) -> str:
        return "aphrodite.omni.platforms.xpu.worker.xpu_generation_worker.XPUGenerationWorker"
    ...
    def get_default_stage_config_path(cls) -> str:
        return "aphrodite/omni/platforms/xpu/stage_configs"
    ...
    def get_profiler_cls(cls) -> str:
        ...
        return "aphrodite.omni.platforms.xpu.profiler.XPUTorchProfilerWrapper"
    ...
    def get_default_ir_op_priority(cls, aphrodite_config: AphroditeConfig) -> IrOpPriorityConfig:
        ...
        otherwise prefer aphrodite_c where available.
        """
