...
import torch_npu
from aphrodite_ascend._310p.attention.attention_mask import AttentionMaskBuilder310
from aphrodite_ascend.sample.sampler import apply_top_k_top_p, random_sample
from aphrodite_ascend.utils import ACL_FORMAT_FRACTAL_NZ, aligned_16, maybe_trans_nz, nd_to_nz_2d

from aphrodite.multimodal.audio import AudioResampler
from aphrodite.omni.model_executor.models.common import qwen3_code_predictor
from aphrodite.omni.model_executor.models.qwen3_tts import (
    prompt_embeds_builder,
    qwen3_tts_code2wav,
    qwen3_tts_code_predictor_aphrodite,
    qwen3_tts_talker,
)
...
class _Qwen3TTSTalkerCodePredictor310P(
    qwen3_tts_code_predictor_aphrodite.Qwen3TTSTalkerCodePredictorForConditionalGenerationAPHRODITE
):
    ...
    def __init__(
        ...
        *,
        ...
        self._projected_codec_embed_weight: torch.Tensor | None = None
    ...
    def forward(
        ...
        assert proj_buf is not None
        assert model_fwd is not None
        assert lm_heads is not None
        ...
        if stored_mode:
            ...
            if use_sampling and top_p != 1.0:
                raise NotImplementedError(
                    "top_p sampling is not implemented for the Sonar-native code predictor; please set top_p=1.0."
                )
        ...
        for step in range(1, num_groups):
            ...
            if step < num_groups - 1:
                assert self._projected_codec_embed_weight is not None
...
def apply_talker_patches() -> None:
    ...
    setattr(qwen3_tts_talker, "Qwen3TTSTalkerForConditionalGeneration", _Qwen3TTSTalker310P)
    setattr(qwen3_tts_talker, "Qwen3TTSPromptEmbedsBuilder", _Qwen3TTSPromptEmbedsBuilder310P)
    setattr(
        qwen3_tts_talker,
        "Qwen3TTSTalkerCodePredictorForConditionalGenerationAPHRODITE",
    ...
    setattr(qwen3_tts_code_predictor_aphrodite, "CodePredictorBaseModel", _Qwen3CodePredictorBaseModel310P)
    setattr(
        qwen3_tts_code_predictor_aphrodite,
        "Qwen3TTSTalkerCodePredictorModelAPHRODITE",
        _Qwen3CodePredictorBaseModel310P,
    )
    setattr(prompt_embeds_builder, "Qwen3TTSPromptEmbedsBuilder", _Qwen3TTSPromptEmbedsBuilder310P)
    setattr(qwen3_code_predictor, "CodePredictorAttention", _Qwen3CodePredictorAttention310P)
    setattr(qwen3_code_predictor, "CodePredictorDecoderLayer", _Qwen3CodePredictorDecoderLayer310P)
    setattr(qwen3_code_predictor, "CodePredictorBaseModel", _Qwen3CodePredictorBaseModel310P)
...
def apply_code2wav_patches() -> None:
    ...
    setattr(qwen3_tts_code2wav, "Qwen3TTSCode2Wav", _Qwen3TTSCode2Wav310P)
