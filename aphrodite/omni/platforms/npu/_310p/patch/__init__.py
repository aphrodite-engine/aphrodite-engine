...
def apply_patches() -> None:
    ...
    from aphrodite.omni.platforms.npu._310p.patch.worker import apply_patch
...
def apply_model_patches(model_config) -> None:
    ...
    if model_arch == _QWEN3_TTS_TALKER_ARCH:
        from aphrodite.omni.platforms.npu._310p.patch.qwen3_tts import apply_talker_patches

        apply_talker_patches()
        return
    elif model_arch == _QWEN3_TTS_CODE2WAV_ARCH:
        from aphrodite.omni.platforms.npu._310p.patch.qwen3_tts import apply_code2wav_patches
