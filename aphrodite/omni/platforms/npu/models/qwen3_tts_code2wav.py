...
def _patched_init(self, *, aphrodite_config: AphroditeConfig, prefix: str = "") -> None:
    _prepare_npu_code2wav_runtime()
    assert _original_init is not None
    _original_init(self, aphrodite_config=aphrodite_config, prefix=prefix)
...
def apply_qwen3_tts_code2wav_patch() -> None:
    ...
    from aphrodite.omni.model_executor.models.qwen3_tts.qwen3_tts_code2wav import Qwen3TTSCode2Wav
