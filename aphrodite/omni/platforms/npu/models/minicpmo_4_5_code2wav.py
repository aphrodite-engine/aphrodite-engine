...
from aphrodite.omni.platforms.npu.graph_tools import NPUExactGraphRunner
...
def _graph_config(model: object) -> dict[str, object]:
    config = getattr(getattr(model, "aphrodite_config", None), "additional_config", None)
...
def apply_minicpmo_4_5_code2wav_patch() -> None:
    ...
    from aphrodite.omni.model_executor.models.minicpmo_4_5.batched_token2wav import (
        BatchedToken2Wav,
    )
    from aphrodite.omni.model_executor.models.minicpmo_4_5.minicpmo_4_5_code2wav import (
        MiniCPMO45Code2Wav,
    )
