...
from aphrodite.omni.platforms.npu.layers.rotary_embedding import (
...
def apply_qwen3_tts_tokenizer_v2_patch() -> None:
    ...
    from aphrodite.omni.model_executor.models.qwen3_tts.tokenizer_12hz import (
        modeling_qwen3_tts_tokenizer_v2,
    )

    modeling_qwen3_tts_tokenizer_v2.apply_rotary_pos_emb = _apply_rotary_pos_emb_npu
    setattr(modeling_qwen3_tts_tokenizer_v2.Qwen3TTSTokenizerV2DecoderRMSNorm, "forward", _rms_norm_forward_npu)
    _PATCHED = True
