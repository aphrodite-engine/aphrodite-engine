...
"""Base NPU worker class for Sonar Omni with OmniProfiler support."""
...
if is_310p():
    from aphrodite_ascend._310p.worker_310p import NPUWorker310 as NPUWorker
else:
    from aphrodite_ascend.worker.worker import NPUWorker


class OmniNPUWorkerBase(NPUWorker):
    """Base NPU worker for Sonar Omni with OmniProfiler support.

    This class replaces aphrodite-ascend's profiler with OmniProfiler for
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Replace aphrodite-ascend's profiler with OmniProfiler
