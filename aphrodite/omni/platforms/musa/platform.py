...
import torch
from aphrodite_musa.platform import MUSAPlatformBase
...
class MUSAOmniPlatform(OmniPlatform, MUSAPlatformBase):
    ...
    Inherits all MUSA-specific implementations from aphrodite-musa's MUSAPlatformBase,
    ...
    def get_default_ir_op_priority(cls, aphrodite_config: AphroditeConfig) -> IrOpPriorityConfig:
        """Prefer native ops while compiling, otherwise prefer Sonar kernels."""
