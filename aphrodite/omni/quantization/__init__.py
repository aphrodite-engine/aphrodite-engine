...
"""Unified quantization framework for Sonar-OMNI.

Delegates to Sonar's quantization registry (35+ methods, all platforms).
...
#   from aphrodite.omni.quantization.mxfp8_config import DiffusionMXFP8Config
