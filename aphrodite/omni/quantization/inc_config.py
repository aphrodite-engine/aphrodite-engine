...
from aphrodite.model_executor.layers.linear import LinearMethodBase
...
class OmniINCConfig(INCConfig):
    ...
    block_name_to_quantize: list[str] | None
    extra_config: dict[str, Any] | None
    SUPPORTED_FORMATS = {"auto_round:auto_gptq", "auto_round:auto_awq", "auto_round:llm_compressor"}

    # ------------------------------------------------------------------
    # Core integration: called by Sonar's configure_quant_config()
    # ------------------------------------------------------------------
    ...
    def apply_aphrodite_mapper(self, hf_to_aphrodite_mapper: WeightsMapper) -> None:
        """Remap HF checkpoint names to Sonar runtime prefixes."""
        prefix_map = getattr(hf_to_aphrodite_mapper, "orig_to_new_prefix", None) or {}
    ...
    # ------------------------------------------------------------------
    # Upgrading a vanilla INCConfig created by Sonar
    # ------------------------------------------------------------------
