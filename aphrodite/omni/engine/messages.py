...
from aphrodite.omni.inputs.data import OmniInteractionPrompt, OmniPromptType, OmniSamplingParams
...
StagePrompt: TypeAlias = EngineCoreRequest | EngineInput | OmniPromptType | list[OmniPromptType]
