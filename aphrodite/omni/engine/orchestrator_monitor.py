...
Optional output path override:
  export APHRODITE_OMNI_ORCH_MONITOR_PATH=/path/to/monitor.json
...
_DEFAULT_OUTPUT_PREFIX = "aphrodite_omni_orch_monitor"
_WINDOW_S = 1.0
...
def _resolve_output_path() -> str:
    env_path = os.environ.get("APHRODITE_OMNI_ORCH_MONITOR_PATH")
    if env_path:
        return env_path
