...
"""Unified stage-local runtime abstraction for Sonar Omni."""
...
from aphrodite.omni.distributed.omni_coordinator.load_balancer import Task
from aphrodite.omni.engine.stage_client import (
    StagePoolClient,
    StagePoolDiffusionClient,
    StagePoolLLMClient,
)
from aphrodite.omni.inputs.data import OmniDiffusionSamplingParams, OmniInteractionPrompt
from aphrodite.omni.metrics import (
    count_audio_frames,
    count_image_pixels,
    count_tokens_from_outputs,
)
from aphrodite.omni.metrics import definitions as defs
from aphrodite.omni.metrics.stats import StageRequestStats as StageRequestMetrics
from aphrodite.omni.metrics.stats import StageStats
...
if TYPE_CHECKING:
    from aphrodite.omni.engine.orchestrator import OrchestratorRequestState
...
class StagePool:
    ...
    def __init__(
        ...
        *,
        ...
        stage_aphrodite_config: Any = None,
    ) -> None:
        ...
        self._stage_aphrodite_config = stage_aphrodite_config
    ...
    @property
    def stage_aphrodite_config(self) -> Any:
        return self._stage_aphrodite_config
    ...
    def build_stage_metrics(
        ...
        *,
        ...
        return StageRequestMetrics(
            ...
            aphrodite_ttft_ms=float(native_text_metrics.get("aphrodite_ttft_ms") or 0.0),
            aphrodite_tpot_ms=float(native_text_metrics.get("aphrodite_tpot_ms") or 0.0),
            aphrodite_itl_ms=float(native_text_metrics.get("aphrodite_itl_ms") or 0.0),
            aphrodite_itls_ms=list(native_text_metrics.get("aphrodite_itls_ms") or []),
        )
    ...
    def _infer_audio_sample_rate(
        ...
        *,
        ...
        sources.extend([self.stage_client, self._stage_aphrodite_config])
        if use_default:
    ...
    async def submit_initial(
        ...
        *,
        ...
        # Direct engine callers may provide plain Sonar SamplingParams.
