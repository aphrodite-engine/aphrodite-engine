...
from aphrodite.omni.distributed.omni_coordinator.messages import ReplicaStatus
from aphrodite.omni.distributed.omni_coordinator.omni_coord_client_for_hub import OmniCoordClientForHub
from aphrodite.omni.engine.messages import EngineQueueMessage, ErrorMessage
...
class MembershipController:
    ...
    def __init__(
        ...
        self._cleanup_callback: Callable[[list[str]], Awaitable[object]] | None = None
    ...
    async def handle_unregister(
        ...
        cleanup_callback: Callable[[list[str]], Awaitable[object]] | None = None,
    ) -> None:
    ...
    def _spawn_task(self, coro: Coroutine[Any, Any, None], *, label: str) -> None:
    ...
    def install_unregister_handlers(
        ...
        *,
        ...
        cleanup_callback: Callable[[list[str]], Awaitable[object]],
