...
from aphrodite.omni.engine.messages import EngineQueueMessage

if TYPE_CHECKING:
    from aphrodite.omni.engine.duplex.session import DuplexSessionRuntimeManager, DuplexSessionRuntimeState
...
class DuplexControlPlanePort(Protocol):
    ...
    def close_sessions_for_request_ids(
        self, request_ids: list[str], *, abort: bool = False, cleanup_in_progress: bool = False
    ) -> dict[str, list[str]]: ...
