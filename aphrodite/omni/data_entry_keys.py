...
REQUEST_ARTIFACT_DIRS_KEY: Final = "_omni_request_artifact_dirs"
TRANSFORM_OWNED_META_KEYS = frozenset({"minimax_h3_prepared_reference_videos"})

if TYPE_CHECKING:
    from aphrodite.omni.engine import AdditionalInformationEntry, AdditionalInformationPayload
...
def _serialize_tensor(t: torch.Tensor) -> AdditionalInformationEntry:
    from aphrodite.omni.engine import AdditionalInformationEntry
...
def serialize_payload(
    ...
    """
    from aphrodite.omni.engine import (
