...
mirrors the OpenAI Images API shape, with sonar-omni extensions for diffusion
...
from aphrodite.omni.entrypoints.openai.image_api_utils import parse_size
from aphrodite.omni.inputs.data import DIFFUSION_QUALITY_LEVELS
...
class VideoGenerationRequest(BaseModel):
    ...
    # sonar-omni extensions for post-generation frame interpolation.
