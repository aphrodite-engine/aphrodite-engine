            ...
            try:
                ...
                if exc.response.has_redirect_location and not allow_redirects:
                    raise InvalidInputReferenceError(
                        ...
                        "APHRODITE_MEDIA_URL_ALLOW_REDIRECTS is disabled."
                    ) from exc
                raise InvalidInputReferenceError(
...
def _encode_prepared_video_bytes_legacy(
    ...
    from aphrodite.omni.diffusion.utils.media_utils import mux_video_audio_bytes
...
def _encode_video_bytes(
    ...
    from aphrodite.omni.diffusion.utils.media_utils import mux_av_video_audio_bytes
...
class FragmentedMP4VideoEncoder:
    ...
    def encode(self, video: Any) -> bytes:
        ...
        from aphrodite.omni.diffusion.utils.media_utils import FragmentedMP4Muxer
