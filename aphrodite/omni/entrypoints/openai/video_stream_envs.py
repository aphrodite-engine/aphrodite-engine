...
if TYPE_CHECKING:
    APHRODITE_VIDEO_AUDIO_DELTA_MODE: Literal["fast", "slow"] = "fast"
    APHRODITE_VIDEO_ASYNC_CHUNK: Literal["on", "off"] = "on"

logger = logging.getLogger(__name__)
_warned_invalid_envs: set[tuple[str, str]] = set()
_VIDEO_AUDIO_DELTA_MODE = "APHRODITE_VIDEO_AUDIO_DELTA_MODE"
_VIDEO_ASYNC_CHUNK = "APHRODITE_VIDEO_ASYNC_CHUNK"
