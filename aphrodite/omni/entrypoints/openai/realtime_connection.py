...
from aphrodite.entrypoints.speech_to_text.realtime.connection import RealtimeConnection as AphroditeRealtimeConnection
from aphrodite.entrypoints.speech_to_text.realtime.protocol import TranscriptionDelta, TranscriptionDone
...
class RealtimeConnection(AphroditeRealtimeConnection):
    """Omni realtime connection with audio-only server events.

    Reuses upstream Sonar websocket/session lifecycle and only customizes
