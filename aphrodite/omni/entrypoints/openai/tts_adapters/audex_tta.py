...
from aphrodite.omni.model_executor.models.audex.prompt import build_tta_cond_prompt
...
class AudexTTAAdapter(ARTTSAdapter):
    ...
    def __init__(self, ctx) -> None:
        ...
        self._tta_rvq: dict[str, object] | None = None
    ...
    def _inject_audex_tta_args(self, request_id: str, prompt: Any, stage0_params: Any) -> Any:
        ...
        from aphrodite.omni.model_executor.models.audex.prompt import build_tta_null_prompt
        from aphrodite.omni.model_executor.models.audex.tta import build_tta_phase_token_ids
