...
from aphrodite.omni.entrypoints.openai.tts_adapters.base import ARTTSAdapter, PreparedRequest, apply_max_new_tokens
from aphrodite.omni.entrypoints.openai.tts_adapters.capabilities import load_precomputed_speakers
from aphrodite.omni.utils.speaker_cache import validate_voxcpm2_profile
...
class VoxCPM2Adapter(ARTTSAdapter):
    ...
    def _encode(self, text: str) -> list[int]:
        ...
        from aphrodite.omni.model_executor.models.voxcpm2.voxcpm2_talker import (
            build_cjk_split_map,
    ...
    async def _build_prompt(
        ...
        """
        from aphrodite.omni.model_executor.models.voxcpm2.voxcpm2_talker import build_voxcpm2_prompt
    ...
    async def build(
        ...
        return PreparedRequest(prompt=prompt, tts_params={}, model_type="voxcpm2")
    ...
    async def warmup(self) -> None:
        ...
        Graph capture requires a Sonar ``ForwardContext`` containing attention
