...
class IndexTTS2Adapter(ARTTSAdapter):
    ...
    async def build(
        ...
        from aphrodite.omni.model_executor.models.indextts2.prompt_utils import (
            estimate_indextts2_prefill_prompt_len,
        )

        prompt_kwargs: dict[str, Any] = {}
        if self.name == "indextts2_5":
            from aphrodite.omni.model_executor.models.indextts2.tokenizer_v2_5 import (
        ...
        prompt = dict(tokens_input(prompt_token_ids=[1] * ph_len))
