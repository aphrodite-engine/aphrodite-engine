...
from aphrodite.omni.model_executor.models.audex.prompt import build_cond_prompt
...
class AudexAdapter(ARTTSAdapter):
    ...
    def _inject_audex_cfg_pair_args(self, request_id: str, prompt: Any, stage0_params: Any) -> Any:
        ...
        from aphrodite.omni.model_executor.models.audex.prompt import build_null_prompt
