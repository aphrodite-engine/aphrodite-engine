...
from aphrodite.omni.entrypoints.openai.tts_adapters.capabilities import load_codec_frame_rate, load_supported_speakers
...
def conditioning_cache_salt(request: "OpenAICreateSpeechRequest", tts_params: dict | None = None) -> str:
    ...
    The talker's Sonar prompt is placeholder token ids; the real inputs are
    rebuilt from text / ref_audio / ref_text into inputs_embeds. Sonar hashes
