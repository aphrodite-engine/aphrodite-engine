...
from aphrodite.omni.model_executor.models.minimax_music3.constants import (
    AUDIO_FRAME_RATE,
    MAX_AUDIO_FRAMES,
    MAX_PROMPT_TOKENS,
)
from aphrodite.omni.model_executor.models.minimax_music3.prompt import (
    build_prompt,
...
class MiniMaxMusic3Adapter(ARTTSAdapter):
    ...
    async def build(
        ...
        if request.instructions is None:
            raise ValueError("MiniMax Music 3 requires instructions describing the music")
