...
class CovoAudioAdapter(ARTTSAdapter):
    ...
    def matches(cls, model_stage: str | None, model_arch: str | None) -> bool:
        ...
        return super().matches(model_stage, model_arch) and model_arch is not None and "CovoAudio" in model_arch
    ...
    async def build(
        ...
        from aphrodite.omni.model_executor.models.covo_audio.prompt_utils import build_covo_audio_prompt_token_ids
