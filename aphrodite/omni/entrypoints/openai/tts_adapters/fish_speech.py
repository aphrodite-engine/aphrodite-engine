...
class FishSpeechAdapter(ARTTSAdapter):
    ...
    def _estimate_ref_code_len(ref_audio: object) -> int | None:
        from aphrodite.omni.model_executor.models.fish_speech.dac_utils import DAC_HOP_LENGTH, DAC_SAMPLE_RATE
    ...
    def _estimate_prompt_len(self, text: str, ref_text: str, ref_audio: object) -> int:
        from aphrodite.omni.model_executor.models.fish_speech.prompt_utils import (
    ...
    def _build_prompt(
        ...
        if ref_audio_data is None or not request.ref_text:
            ...
            prompt = dict(tokens_input(prompt_token_ids=prompt_ids))
