...
from aphrodite.omni.entrypoints.openai.tts_adapters.capabilities import load_supported_speakers
...
class VoxtralTTSAdapter(ARTTSAdapter):
    ...
    def _build_prompt(self, request: "OpenAICreateSpeechRequest") -> dict[str, Any]:
        ...
        if request.voice is not None:
            ...
            prompt = dict(tokens_input(prompt_token_ids=tokenized.tokens))
