...
from aphrodite.omni.utils.speaker_cache import validate_qwen3_tts_profile
...
class Qwen3TTSAdapter(ARTTSAdapter):
    ...
    def _estimate_prompt_len(self, tts_params: dict[str, Any]) -> int:
        ...
        try:
            ...
            from aphrodite.omni.model_executor.models.qwen3_tts.prompt_embeds_builder import (
