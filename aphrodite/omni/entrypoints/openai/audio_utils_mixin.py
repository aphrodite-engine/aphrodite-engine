...
from aphrodite.omni.entrypoints.openai.protocol.audio import DEFAULT_AUDIO_FORMAT, AudioResponse, CreateAudio
...
class AudioMixin:
    ...
    def create_audio(self, audio_obj: CreateAudio) -> AudioResponse:
        ...
        with BytesIO() as buffer:
            ...
            raw_audio_data = buffer.getvalue()

        audio_data: bytes | str = raw_audio_data
        if base64_encode:
            import base64

            audio_data = base64.b64encode(raw_audio_data).decode("utf-8")
