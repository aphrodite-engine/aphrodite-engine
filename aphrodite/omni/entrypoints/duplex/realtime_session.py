...
from aphrodite.omni.entrypoints.duplex import realtime_state as _state
from aphrodite.omni.entrypoints.duplex.realtime_output import (
...
class NativeRealtimeSessionProtocol(RealtimeOutputProjector):
