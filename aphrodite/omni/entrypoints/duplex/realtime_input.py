...
from aphrodite.omni.entrypoints.duplex.protocol import normalize_native_duplex_key
...
from aphrodite.omni.entrypoints.duplex.server_vad import ServerVADConfig, parse_session_turn_detection
...
class RealtimeInputTranslator(RealtimeStateOwner):
    ...
    def _normalize_complete_audio_item_part(
        ...
        if sample_rate_hz != 16_000:
            from aphrodite.omni.entrypoints.openai.audio_utils_mixin import StreamingAudioResampler
