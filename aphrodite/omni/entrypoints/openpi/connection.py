...
from aphrodite.omni.entrypoints.openpi.serving import (
...
def _decode_aphrodite_numpy_marker(obj: dict[Any, Any]) -> Any:
...
def _unpack_numpy(obj: Any) -> Any:
    if isinstance(obj, dict):
        for decoder in (_decode_aphrodite_numpy_marker, _decode_openpi_numpy_marker):
            decoded = decoder(obj)
