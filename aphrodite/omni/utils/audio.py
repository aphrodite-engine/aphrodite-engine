...
from aphrodite.omni.outputs.mm_outputs import MultimodalCompletionOutput
...
def audio_chunk_pcm_bytes(omni_res: OmniRequestOutput) -> int:
    ...
    try:
        ...
        if not isinstance(output, MultimodalCompletionOutput) or output.multimodal_output is None:
            return 0
