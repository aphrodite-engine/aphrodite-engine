...
"""Output modality types for Sonar Omni.
...
class OutputModality(Flag):
    ...
    Note: POOLING is intentionally excluded. Pooling/embedding is Sonar's
    native path (pooling_output → PoolingRequestOutput), handled entirely
    by the base OutputProcessor. Sonar Omni's layer does not participate.
    """
