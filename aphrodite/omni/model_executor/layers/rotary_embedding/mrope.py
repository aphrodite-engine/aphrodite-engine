...
This module extends the upstream Sonar MRotaryEmbedding with additional methods
...
if current_omni_platform.is_npu():
    from aphrodite_ascend.ops.rotary_embedding import AscendMRotaryEmbedding as _BaseMRotaryEmbedding
else:
    from aphrodite.model_executor.layers.rotary_embedding.mrope import MRotaryEmbedding as _BaseMRotaryEmbedding
...
class OmniMRotaryEmbedding(_BaseMRotaryEmbedding):
    ...
    def get_input_positions_tensor(
        ...
        from aphrodite.transformers_utils.config import thinker_uses_mrope
