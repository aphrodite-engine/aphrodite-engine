...
from aphrodite.forward_context import get_forward_context, override_forward_context
...
class VoxCPM2TalkerForConditionalGeneration(nn.Module):
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        self._runtime_config = _VoxCPM2RuntimeConfig.from_aphrodite_config(aphrodite_config)
        ...
        # Eager-init tts_model so it registers in self.state_dict() before Sonar's
        ...
        # for sliding-window streaming decode. 12 matches the nanoaphrodite reference
        ...
        self._max_batch_size = getattr(aphrodite_config.scheduler_config, "max_num_seqs", 4)
    ...
    def _collect_audio(
        ...
        """Per-step sliding-window VAE decode (nanoaphrodite pattern).
        ...
        with _NvtxRange("voxcpm2.vae_decode"), torch.no_grad():
    ...
    def preprocess(
        ...
        **info_dict: Unpack[VoxCPM2PreprocessInput],
        ...
        if is_prefill:
            ...
            # _flush_deferred_cleanup (fed by Sonar scheduler._free_request via
    ...
    hf_to_aphrodite_mapper = WeightsMapper(orig_to_new_prefix={"base_lm.": "model."})
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        ...
        loaded = loader.load_weights(_base_lm_only(weights), mapper=self.hf_to_aphrodite_mapper)
