...
from aphrodite.omni.core.sched.omni_ar_scheduler import OmniARAsyncScheduler
...
class VoxCPM2OmniARAsyncScheduler(OmniARAsyncScheduler):
    ...
    def _unified_decode_graph_enabled(self) -> bool:
        runtime_config = _VoxCPM2RuntimeConfig.from_aphrodite_config(self.aphrodite_config)
