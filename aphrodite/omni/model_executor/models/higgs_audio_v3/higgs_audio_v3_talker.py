...
from aphrodite.omni.transformers_utils.configs.higgs_audio_v3 import (
    HiggsAudioV3Config,
)
...
class HiggsAudioV3TalkerForConditionalGeneration(nn.Module):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        compilation_config = getattr(aphrodite_config, "compilation_config", None)
    ...
    def _resolve_token_ids(self) -> None:
        ...
        model_path = getattr(self.aphrodite_config.model_config, "model", None)
    ...
    def _audio_seed_mask_from_step_input(self, num_rows: int, device: torch.device) -> torch.Tensor | None:
        ...
        output_token_ids. In decode, Sonar feeds the previous sampled token as
