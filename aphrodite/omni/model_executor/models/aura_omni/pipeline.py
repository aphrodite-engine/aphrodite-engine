...
Code2Wav, to reuse the existing Sonar Omni implementation without wrapping or
...
_AURA_PROC = "aphrodite.omni.model_executor.stage_input_processors.aura_omni"
_QWEN3_TTS_PROC = "aphrodite.omni.model_executor.stage_input_processors.qwen3_tts"
