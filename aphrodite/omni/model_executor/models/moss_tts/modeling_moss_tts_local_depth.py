...
Sonar's main scheduler -- mirrors ``MossTTSRealtimeLocalTransformer``
...
not Sonar's neox-style concat-half rotation) rather than Realtime's
...
class _MossTTSLocalAttention(nn.Module):
    ...
    concat-half construction Sonar uses elsewhere.
    """
