...
from aphrodite.omni.diffusion.attention.backends.utils.fa import HAS_FLASH_ATTN, flash_attn_varlen_func
from aphrodite.omni.model_executor.models.whisper_utils import Conv1d, Linear, sinusoids
...
class ResidualAttentionBlock(nn.Module):
    ...
    aphrodite/omni/model_executor/models/qwen3_tts/tokenizer_25hz/vq/whisper_encoder.py
    """
