...
from aphrodite.model_executor.layers.rotary_embedding.mrope import MRotaryEmbedding
from aphrodite.model_executor.layers.vocab_parallel_embedding import ParallelLMHead, VocabParallelEmbedding
...
from aphrodite.omni.transformers_utils.configs.ming_flash_omni import BailingMoeV2Config
...
class BailingMoeV2Attention(nn.Module):
    """Multi-headed attention using Sonar's Attention layer with 3D RoPE support."""
    ...
    def __init__(
        ...
        # apply Sonar RMSNorm here rather than BailingMoeV2RMSNorm, diff might exist
...
class BailingMoeV2DecoderLayer(nn.Module):
    ...
    def __init__(
        ...
        # apply Sonar RMSNorm to replace BailingMoeV2RMSNorm, diff might exist
...
class BailingMoeV2ForCausalLM(nn.Module, CustomProcessMixin):
    """BailingMoeV2 model for causal language modeling, adapted for Sonar.
