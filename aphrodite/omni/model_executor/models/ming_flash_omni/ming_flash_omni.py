...
this wrapper would force it through Sonar's multimodal preprocess path
...
from aphrodite.omni.transformers_utils.configs.ming_flash_omni import (
    BailingMM2Config,
    MingFlashOmniConfig,
)
...
class MingFlashOmniForConditionalGeneration(
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        if self.model_stage == "talker":
            raise ValueError(
                ...
                "preprocess path. See aphrodite/omni/deploy/ming_flash_omni.yaml "
                "stage 1 and aphrodite/omni/deploy/ming_flash_omni_tts.yaml."
            )
        ...
        if self.model_stage == "thinker":
            ...
            raise NotImplementedError(
                ...
                "for the imagegen stage (see aphrodite/omni/deploy/ming_flash_omni_image.yaml)."
            )
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        ...
        if self.model_stage == "thinker" and thinker_weights:
            ...
            # so aphrodite's default loader does not see them via the standard
