...
def _adapt_vision_config(vision_config):
    # Adapt Ming's Qwen3VLMoeVisionConfig to be compatible with Sonar's
...
class MingVisionEncoder(nn.Module):
    """**Wrapper** around Sonar's Qwen3Omni_VisionTransformer for Ming."""
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        ...
        remapped_weights = self.hf_to_aphrodite_mapper.apply(weights)
