...
"""Configuration class for higgs-audio v2 in sonar-omni.
...
class HiggsAudioV2Config(PretrainedConfig):
    ...
    knobs that sonar-omni reads directly are surfaced. Anything extra coming
    ...
    # aphrodite.omni.config.pipeline_registry and aphrodite.omni.model_executor.models.registry.
