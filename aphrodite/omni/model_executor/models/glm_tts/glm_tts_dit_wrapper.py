...
from aphrodite.omni.model_executor.models.glm_tts.glm_tts import (
    resolve_glm_tts_model_dir,
)
from aphrodite.omni.model_executor.models.glm_tts.vocoder import (
    load_vocoder,
    mel_to_audio,
)
...
class GLMTTSDiTForGeneration(nn.Module):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        self.max_num_seqs = int(getattr(aphrodite_config.scheduler_config, "max_num_seqs", 1))
        ...
        self._codec_chunk_frames, self._codec_left_context_frames = self._connector_chunk_config(aphrodite_config)
        ...
        from aphrodite.omni.model_executor.models.glm_tts.glm_tts_dit import GLMTTSDiT
        ...
        self._model_dtype = self._resolve_model_dtype(aphrodite_config)
    ...
    @staticmethod
    def _connector_chunk_config(aphrodite_config: AphroditeConfig) -> tuple[int, int]:
        cc = getattr(aphrodite_config.model_config, "stage_connector_config", None)
    ...
    @staticmethod
    def _resolve_model_dtype(aphrodite_config: AphroditeConfig) -> torch.dtype | None:
