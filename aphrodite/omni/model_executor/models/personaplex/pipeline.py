...
runs it is served as a 2-stage sonar-omni audio->audio pipeline, reusing the
...
``aphrodite.omni.model_executor.stage_input_processors.personaplex`` and are part of
...
_PROC = "aphrodite.omni.model_executor.stage_input_processors.personaplex"
...
PERSONAPLEX_PIPELINE = PipelineConfig(
    ...
    duplex_runtime_extension=(
        "aphrodite.omni.model_executor.models.personaplex.duplex.runtime_extension.PersonaPlexDuplexRuntimeExtension"
    ),
    duplex_serving_adapter=(
        "aphrodite.omni.model_executor.models.personaplex.duplex.serving_adapter.PersonaPlexServingRuntimeAdapter"
    ),
