...
"""Sonar-native PersonaPlex Helium temporal transformer.

The module maps the Moshi temporal LM backbone onto Sonar's Llama-style decoder
...
class HeliumRMSNorm(RMSNorm):
    ...
    input dtype. Sonar's parameter is named `weight`; the loader squeezes alpha.
    """
...
def _get_helium_rope(config: HeliumConfig):
    ...
    try:
        ...
        # Sonar 0.23 uses `rope_parameters`; this fallback is for older local
...
class HeliumModel(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda prefix: layer_type(aphrodite_config=aphrodite_config, prefix=prefix, config=config),
    ...
    def embed_input_ids(self, input_ids: torch.Tensor) -> torch.Tensor:
        raise ValueError(
            ...
            "embeddings are intentionally not part of this Sonar module."
        )
