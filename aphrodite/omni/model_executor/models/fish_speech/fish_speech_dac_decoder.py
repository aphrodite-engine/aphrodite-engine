...
from aphrodite.omni.model_executor.models.fish_speech.dac_utils import (
    DAC_HOP_LENGTH,
    DAC_NUM_CODEBOOKS,
    DAC_SAMPLE_RATE,
    build_dac_codec,
...
def _connector_extra_config(aphrodite_config: AphroditeConfig) -> dict[str, Any]:
...
class FishSpeechDACDecoder(nn.Module):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        extra_cfg = _connector_extra_config(aphrodite_config)
