...
"""MiniMax H3 text encoder on the Sonar Qwen3-VL model runner."""
...
class MiniMaxH3TextEncoder(Qwen3VLForConditionalGeneration):
    ...
    upstream Sonar Qwen3-VL implementation supplies the vision tower,
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = "model"):
        ...
        hf_config = copy.deepcopy(aphrodite_config.model_config.hf_config)
        ...
        # on both levels because AphroditeConfig.with_hf_config propagates the
        ...
        encoder_config = aphrodite_config.with_hf_config(hf_config)
        super().__init__(aphrodite_config=encoder_config, prefix=prefix)
