...
from aphrodite.omni.model_executor.models.common.ming.speaker_extractor import SpeakerEmbeddingExtractor
...
def _load_speaker_extractor(wrapper: MingTTSForConditionalGeneration) -> SpeakerEmbeddingExtractor:
    ...
    with _EXTRACTOR_LOAD_LOCK:
        ...
        if extractor is None:
            model_path = wrapper.aphrodite_config.model_config.model
