...
from aphrodite.omni.model_executor.models.common.ming.audio_vae import AudioVAE
...
class MingAudioVAEModel(nn.Module):
    ...
    def embed_input_ids(self, input_ids: torch.Tensor, **_: Any) -> torch.Tensor:
        ...
        if input_ids is None or input_ids.numel() == 0:
            return torch.empty((0, hidden_size), device=self.aphrodite_config.device_config.device, dtype=torch.float32)
    ...
    def forward(
        ...
        **kwargs: Any,
        ...
        empty = torch.zeros((0,), dtype=torch.float32, device=self.aphrodite_config.device_config.device)
