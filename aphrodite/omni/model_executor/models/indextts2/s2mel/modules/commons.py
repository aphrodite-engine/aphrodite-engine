...
class MyModel(nn.Module):
    def __init__(self, args, use_emovec=False, use_gpt_latent=False):
        super().__init__()
        from aphrodite.omni.model_executor.models.indextts2.s2mel.modules.flow_matching import CFM
        from aphrodite.omni.model_executor.models.indextts2.s2mel.modules.length_regulator import (
