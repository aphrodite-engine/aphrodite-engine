...
from aphrodite.omni.model_executor.models.indextts2.gpt.conformer.attention import (
    MultiHeadedAttention,
    RelPositionMultiHeadedAttention,
)
from aphrodite.omni.model_executor.models.indextts2.gpt.conformer.embedding import (
    PositionalEncoding,
    RelPositionalEncoding,
)
from aphrodite.omni.model_executor.models.indextts2.gpt.conformer.subsampling import (
    Conv2dSubsampling2,
)
from aphrodite.omni.model_executor.models.indextts2.utils.common import make_pad_mask
...
class BaseEncoder(torch.nn.Module):
    def __init__(
        ...
        pos_enc_map = {"abs_pos": PositionalEncoding, "rel_pos": RelPositionalEncoding}
        if pos_enc_layer_type not in pos_enc_map:
            raise ValueError("unknown pos_enc_layer: " + pos_enc_layer_type)
        pos_enc_class = pos_enc_map[pos_enc_layer_type]

        subsampling_map = {"conv2d2": Conv2dSubsampling2}
        if input_layer not in subsampling_map:
            raise ValueError("unknown input_layer: " + input_layer)
        subsampling_class = subsampling_map[input_layer]
