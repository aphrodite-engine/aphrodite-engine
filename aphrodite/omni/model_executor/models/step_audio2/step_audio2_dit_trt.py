...
Ports stepfun-ai/Step-Audio2#70 into Sonar Omni. The upstream PR patches
...
def _default_cache_dir() -> Path:
    ...
    return base / "aphrodite.omni" / "token2wav_trt"
...
def build_dit_trt_stepper(
    ...
    *,
    ...
    or ``$HF_HOME/aphrodite/omni/token2wav_trt``), keyed by dtype/batch/TRT
