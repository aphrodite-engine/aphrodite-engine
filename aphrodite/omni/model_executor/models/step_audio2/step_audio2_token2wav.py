...
from aphrodite.omni.model_executor.models.cosyvoice3.code2wav_core.hifigan import HiFTGenerator
from aphrodite.omni.model_executor.models.cosyvoice3.utils import mel_spectrogram
from aphrodite.omni.model_executor.models.output_templates import OmniOutput
from aphrodite.omni.model_executor.models.step_audio2.step_audio2_constants import (
...
class StepAudio2Token2WavCore(nn.Module):
    ...
    def __init__(
        ...
        if current_omni_platform.is_npu():
            from aphrodite.omni.platforms.npu.models.step_audio2_token2wav import (
    ...
    def enable_trt_spk_embedding(self) -> None:
        ...
        """
        from aphrodite.omni.model_executor.models.cosyvoice3.speaker_embedding_trt import get_campplus_trt
...
class StepAudio2Token2WavForConditionalGeneration(nn.Module, SupportsPP):
    """Sonar-compatible wrapper for Step-Audio2 Token2Wav"""
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        model_name_or_path = aphrodite_config.model_config.model
        ...
        device = "cuda"
        if hasattr(aphrodite_config, "device_config") and aphrodite_config.device_config:
            device = str(aphrodite_config.device_config.device)
    ...
    def get_language_model(self) -> torch.nn.Module:
        # Return the wrapper so Sonar interface helpers resolve
    ...
    def embed_input_ids(
        ...
        hidden_size = self.aphrodite_config.model_config.get_hidden_size()
