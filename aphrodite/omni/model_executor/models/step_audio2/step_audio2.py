...
class StepAudio2ForConditionalGeneration(nn.Module, SupportsMultiModal, SupportsPP):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        raw_model_stage = aphrodite_config.model_config.model_stage
    ...
    def get_language_model(self) -> nn.Module:
        ...
        # Sonar interface helpers resolve embed_input_ids() on the adapter layer.
    ...
    def embed_input_ids(
        ...
        """Explicit Sonar embedding hook for both stages."""
