...
from aphrodite.omni.utils.audio import mel_filter_bank
...
class StepAudio2MultiModalProcessor(BaseMultiModalProcessor[StepAudio2ProcessingInfo]):
    ...
    def _get_mm_fields_config(
        ...
        """Map processor outputs to Sonar multimodal fields.
...
class StepAudio2ThinkerForConditionalGeneration(nn.Module, SupportsMultiModal, SupportsPP):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        lm_aphrodite_config = aphrodite_config.with_hf_config(lm_config, architectures=architectures)
        self.language_model = init_aphrodite_registered_model(
            aphrodite_config=lm_aphrodite_config, hf_config=lm_config, prefix=maybe_prefix(prefix, "language_model")
        )
    ...
    def embed_multimodal(self, **kwargs: object) -> NestedTensors:
        """Sonar multimodal encoder entrypoint."""
    ...
    def get_input_embeddings(
        ...
        # Under newer Sonar versions the registered LM wrapper exposes
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        """Load weights with name mapping from HuggingFace to Sonar structure"""
