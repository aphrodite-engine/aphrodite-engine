...
from aphrodite.model_executor.models.interfaces import SupportsMRoPE, SupportsMultiModal, SupportsPP
...
# from aphrodite.model_executor.models.qwen2_code2wav_dit import Qwen2Code2wav
...
from aphrodite.omni.model_executor.layers.rotary_embedding.mrope import (
...
from aphrodite.omni.model_executor.models.utils import add_prefix_to_loaded_weights, split_list_into_ranges
...
# `get_llm_pos_ids_for_vision` was removed from upstream Sonar (commit
# 0cf49a5d15); sonar-omni keeps an identical copy as a static method on
...
class Qwen2_5OmniForConditionalGeneration(
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        config: Qwen2_5OmniConfig = aphrodite_config.model_config.hf_config
        ...
        if self.model_stage == "thinker":
            ...
            with self._mark_language_model(aphrodite_config=aphrodite_config):
            ...
            if self.token2wav_config is not None:
                with self._mark_language_model(aphrodite_config=aphrodite_config):
                    self.token2wav = init_aphrodite_registered_model(
                        aphrodite_config=aphrodite_config,
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        ...
        if token2wav_weights and self.token2wav is not None:
            ...
            model_path = self.aphrodite_config.model_config.model
            download_dir = self.aphrodite_config.load_config.download_dir
