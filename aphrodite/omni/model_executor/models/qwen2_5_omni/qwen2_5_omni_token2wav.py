...
from aphrodite.model_executor.models.utils import AutoWeightsLoader as _Aphrodite_AutoWeightsLoader
from aphrodite.model_executor.models.utils import WeightsMapper as _Aphrodite_WeightsMapper
from aphrodite.model_executor.models.utils import (
    init_aphrodite_registered_model as _aphrodite_init_aphrodite_registered_model,
)
from aphrodite.model_executor.models.utils import maybe_prefix as _aphrodite_maybe_prefix
from aphrodite.omni.model_executor.layers.timestep_embedding import DiTTimestepEmbedding
from aphrodite.omni.model_executor.models.common.alias_free_activation import AliasFreeActivation1d
from aphrodite.omni.model_executor.models.common.snake_activation import SnakeBeta
from aphrodite.omni.model_executor.models.qwen2_5_omni.audio_length import (
...
# See: aphrodite/omni/model_executor/models/common/{snake_activation,alias_free_activation}.py
...
# ================= Sonar-style wrapper for Token2Wav =================


class Qwen2_5OmniToken2WavForConditionalGenerationAPHRODITE(nn.Module, SupportsPP):
    logger = init_logger(__name__)

    # Map HF weights -> Sonar module names
    hf_to_aphrodite_mapper = _Aphrodite_WeightsMapper(
        orig_to_new_prefix={
            # HF root is 'model.'
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        self.token2wav = _aphrodite_init_aphrodite_registered_model(
            aphrodite_config=aphrodite_config,
            prefix=_aphrodite_maybe_prefix(prefix, "token2wav_model"),
            hf_config=self.config,
            architectures=["Qwen2_5OmniToken2WavDiTModel"],
        )

        # Provide placeholder to align with Sonar runner expectations
    ...
    @property
    def sampler(self):
        # Token2Wav does not use sampler; return Sonar default for API parity
        return Sampler()
    ...
    def load_weights_without_buffers(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        loader = _Aphrodite_AutoWeightsLoader(self)
