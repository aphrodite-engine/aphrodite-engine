...
from aphrodite.inputs import MultiModalHashes
...
from aphrodite.model_executor.models.utils import WeightsMapper, init_aphrodite_registered_model, maybe_prefix
...
from aphrodite.multimodal.parse import AudioProcessorItems, MultiModalDataItems, VideoProcessorItems
from aphrodite.multimodal.processing.context import TimingContext
from aphrodite.multimodal.processing.inputs import ProcessorInputs
...
_PER_VIDEO_USE_AUDIO_IN_VIDEO_KEY = "_aphrodite_omni_per_video_use_audio_in_video"
...
def _coerce_use_audio_in_video_for_hf_processor(
    ...
    # HF processors only support a global bool. For per-video masks, Sonar
...
def _presampled_videos_hf_kwargs(
    ...
    """Adjust HF video kwargs for videos pre-sampled by Sonar's video loader.
...
class Qwen2_5OmniVideoProcessorItems(VideoProcessorItems):
    ...
    def get_processor_data(self) -> Mapping[str, object]:
        ...
        # Read through self.get(), not self.data. Sonar now wraps loaded media in
        ...
        # self.get() is also correct on the pre-wrapper Sonar, where it is a
...
class Qwen2_5OmniThinkerMultiModalProcessor(
    ...
    def _cached_apply_hf_processor(
        ...
        with timing_ctx.record("get_cache_missing_items"):
            ...
            # (pair expansion must run after is_cached); keep in sync with Sonar.
            mm_missing_data = {}
...
class Qwen2_5OmniThinkerForConditionalGeneration(
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        thinker_config: Qwen2_5OmniThinkerConfig = aphrodite_config.model_config.hf_config
