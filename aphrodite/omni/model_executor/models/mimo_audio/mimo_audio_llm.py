...
from aphrodite.model_executor.model_loader.weight_utils import default_weight_loader, maybe_remap_kv_scale_name
from aphrodite.model_executor.models.interfaces import MultiModalEmbeddings, SupportsMultiModal, SupportsPP
...
from aphrodite.omni.model_executor.models.mimo_audio.config_mimo_audio import MiMoAudioConfig
...
class MiMoAudioLLMForConditionalGeneration(nn.Module, SupportsMultiModal, SupportsPP):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        aphrodite_config.model_config.hf_config = self.config
        ...
        aphrodite_config.model_config.hf_config.rope_parameters.update(mrope_config)

        self.model = init_aphrodite_registered_model(
        ...
        # Sonar 0.28 turned SupportsPP.make_empty_intermediate_tensors from a
        ...
        # matches Sonar's external sampler (SamplingParams temperature=0.0).  Both
        ...
        # do_sample=True here without also routing Sonar's sampled token back into
    ...
    def embed_multimodal(self, **kwargs: object) -> MultiModalEmbeddings:
        if kwargs.get("modality_preprocess") is None:
            mm_dummy_embeddings = []
            # TODO: audio_lengths is not the same. In aphrodite12, audio_length=tensor([[28],[28]...], device='cuda:0'),
            #  however, in aphrodite0.14, it becomes int array:[28, 28, 28, 28, 28, 28, ....]
