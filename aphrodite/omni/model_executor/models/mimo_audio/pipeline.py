...
from aphrodite.omni.model_executor.models.mimo_audio.config_mimo_audio import NO_INTERLEAVE_NEXT_TOKEN_ID

_PROC = "aphrodite.omni.model_executor.stage_input_processors.mimo_audio"
