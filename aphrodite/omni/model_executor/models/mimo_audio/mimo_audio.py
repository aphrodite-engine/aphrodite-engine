...
from aphrodite.model_executor.models.utils import init_aphrodite_registered_model
...
from aphrodite.omni.model_executor.models.mimo_audio.config_mimo_audio import (
...
from aphrodite.omni.model_executor.models.mimo_audio.mimo_audio_code2wav import get_tokenizer_worker
from aphrodite.omni.model_executor.models.qwen2_5_omni.qwen2_5_omni import OmniOutput
...
class MiMoAudioForConditionalGeneration(
    ...
    def __init__(
        ...
        self.device = aphrodite_config.device_config.device
        ...
        if self.model_stage == "fused_thinker_talker":
            ...
            self.fused_thinker_talker = init_aphrodite_registered_model(
