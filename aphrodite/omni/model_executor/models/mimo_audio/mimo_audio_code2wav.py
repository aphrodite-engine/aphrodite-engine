...
from aphrodite.model_executor.models import SupportsPP
from aphrodite.omni.model_executor.models.mimo_audio.config_mimo_audio import TALKER_CODEC_PAD_TOKEN_ID, MiMoAudioConfig
from aphrodite.omni.model_executor.models.mimo_audio.cuda_graph_decoder_wrapper import CUDAGraphMiMoDecoderWrapper
from aphrodite.omni.model_executor.models.mimo_audio.modeling_audio_tokenizer import MiMoAudioTokenizer
...
class MiMoAudioToken2WavForConditionalGenerationAPHRODITE(nn.Module, SupportsPP):
    ...
    def __init__(self, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        self.audio_tokenizer_path = getattr(
            aphrodite_config.model_config, "audio_tokenizer_path", None
        ...
        self.tokenizer_config_path = (
            getattr(aphrodite_config.model_config, "audio_tokenizer_config_path", None)
            or os.environ.get("MIMO_AUDIO_TOKENIZER_PATH")
        ...
        connector_cfg = getattr(aphrodite_config.model_config, "stage_connector_config", None)
        extra_cfg = (
            (
    ...
    def forward(
        ...
        **kwargs,
        ...
        is_async_chunk = getattr(self.aphrodite_config.model_config, "async_chunk", False)
    ...
    def embed_input_ids(
        ...
        return (
            torch.zeros_like(input_ids).reshape(-1, 1).repeat(1, self.aphrodite_config.model_config.get_hidden_size())
        )
