...
"""
OmniVoice model for Sonar Omni two-stage TTS pipeline.
...
from aphrodite.inputs.llm import MultiModalDataDict
...
class OmniVoiceModel(
    ...
    """OmniVoice model for Sonar Omni two-stage pipeline.
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        self.model_dir = aphrodite_config.model_config.model

        if self.model_stage == "omnivoice_generator":
            from aphrodite.omni.model_executor.models.omnivoice.omnivoice_generator import (
                OmniVoiceGenerator,
            )
            ...
            from aphrodite.omni.model_executor.models.omnivoice.omnivoice_decoder import (
                OmniVoiceDecoder,
            )
    ...
    def _forward_generator(self, input_ids: torch.Tensor, kwargs: dict) -> OmniOutput:
        ...
        from aphrodite.omni.model_executor.models.omnivoice.duration import (
