...
#   inference_scripts_aphrodite/audiogen_scripts/cfg_logits_processor.py
...
in :mod:`aphrodite.omni.model_executor.models.common.cfg_pairing`; the scheduler
...
from aphrodite.omni.model_executor.models.common.cfg_pairing import (
    _COND,
    _UNCOND,
    apply_cfg_patches,
    cfg_patches_applied,
...
class AudexCFGLogitsProcessor(LogitsProcessor):
    ...
    def _ensure_sample_patched(cls) -> None:
        ...
        # Divergence from the official file: it patches Sonar's
        # ``GPUModelRunner._sample``, but sonar-omni's AR runner overrides
