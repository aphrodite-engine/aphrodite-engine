...
from aphrodite.omni.model_executor.models.audex.speech_decoder import (
...
class AudexCode2Wav(nn.Module):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        # Build the decoder skeleton from config so Sonar's memory profiler
    ...
    def _connector_extra_config(self) -> dict[str, Any]:
        connector_cfg = getattr(self.aphrodite_config.model_config, "stage_connector_config", None)
