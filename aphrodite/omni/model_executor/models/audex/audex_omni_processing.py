...
#   inference_scripts_aphrodite/audioqa_scripts/audex_2b_aphrodite/audio_features.py
#   inference_scripts_aphrodite/audioqa_scripts/audex_2b_aphrodite/processing_audex_aphrodite.py
...
Placeholder expansion uses Sonar's ``PromptReplacement``: a single
