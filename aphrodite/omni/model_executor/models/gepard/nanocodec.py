...
LOOKBACK_FRAMES = int(os.environ.get("APHRODITE_GEPARD_LOOKBACK_FRAMES", "8"))
...
END_OF_SPEECH_FADE_MS = float(os.environ.get("APHRODITE_GEPARD_END_FADE_MS", "0.0"))
END_OF_SPEECH_SILENCE_MS = float(os.environ.get("APHRODITE_GEPARD_END_SILENCE_MS", "0.0"))
