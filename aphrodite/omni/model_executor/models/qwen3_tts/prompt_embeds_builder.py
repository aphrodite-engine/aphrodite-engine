...
:class:`aphrodite.omni.model_executor.models.qwen3_tts.qwen3_tts_talker.Qwen3TTSTalkerForConditionalGeneration`
...
def load_audio_to_np(x: str) -> tuple[np.ndarray, int]:
    ...
    Uses upstream Sonar's MediaConnector for http(s) URLs and ``file:`` URIs
...
class Qwen3TTSPromptEmbedsBuilder:
    ...
    def extract_speaker_embedding(self, wav: np.ndarray, sr: int) -> torch.Tensor:
        # Sonar workers do not automatically move arbitrary torch.nn.Modules to
