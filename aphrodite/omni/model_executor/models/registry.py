...
_OMNI_MODELS = {
    ...
    "Qwen2_5OmniToken2WavModel": (
        ...
        "Qwen2_5OmniToken2WavForConditionalGenerationAPHRODITE",
    ),
    ...
    "MiMoAudioToken2WavModel": (
        "mimo_audio",
        "mimo_audio_code2wav",
        "MiMoAudioToken2WavForConditionalGenerationAPHRODITE",
    ),
    ## ming-tts
...
OmniModelRegistry = _ModelRegistry(
    {
        ...
        **{
            model_arch: _LazyRegisteredModel(
                module_name=f"aphrodite.omni.model_executor.models.{mod_folder}.{mod_relname}",
                class_name=cls_name,
            )
