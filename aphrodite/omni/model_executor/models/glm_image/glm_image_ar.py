...
from aphrodite.config import AphroditeConfig, CacheConfig, MultiModalConfig
...
from aphrodite.model_executor.layers.conv import Conv2dLayer
...
from aphrodite.model_executor.models.qwen2 import Qwen2MLP as GlmImageTextMLP
...
class GlmImageMultiModalProcessor(BaseMultiModalProcessor[GlmImageProcessingInfo]):
    ...
    def _call_hf_processor(
        ...
        # Image-to-image mode
        # NOTE: Use "images" (plural) - this is what Sonar's ImageProcessorItems.get_processor_data() returns
        ...
        if processor is not None:
            ...
            # IMPORTANT (i2i): Sonar multimodal encoder must see source-only grids
    ...
    def _apply_hf_processor_main(
        ...
        *,
        ...
        Problem: When Sonar processes cached mm items (enable_hf_prompt_update=False),
    ...
    def _hf_processor_applies_updates(
        ...
        By returning True, we tell Sonar that HF processor DID apply prompt updates,
        so Sonar will use _find_mm_placeholders to locate the expanded tokens
...
class GlmImageVQVAE(nn.Module):
    ...
    def __init__(self, config: GlmImageVQVAEConfig):
        ...
        # Using Sonar's optimized Conv2dLayer
...
class GlmImageVisionModel(nn.Module):
    ...
    def compute_attn_mask_seqlen(
        ...
        if (
            ...
            # Return as 1D tensor for Sonar 0.14.0+ API compatibility
...
class GlmImageRotaryEmbedding(nn.Module):
    ...
    Unlike Sonar's standard MRotaryEmbedding which uses cache-based lookup,
...
class GlmImageTextAttention(nn.Module):
    ...
    def __init__(
        ...
        # Use custom GlmImageRotaryEmbedding instead of Sonar's get_rope
...
class GlmImageTextModel(nn.Module):
    ...
    def embed_input_ids(self, input_ids: torch.Tensor) -> torch.Tensor:
        ...
        This method is required by Sonar's SupportsMultiModal interface.
...
class GlmImageForConditionalGeneration(nn.Module, SupportsMultiModal, SupportsPP, SupportsMRoPE):
    ...
    This is the main entry point for GLM-Image in Sonar. It wraps:
    ...
    # Weight mapping from HuggingFace to Sonar format
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = "") -> None:
        super().__init__()
        config: GlmImageConfig = aphrodite_config.model_config.hf_config
        quant_config = aphrodite_config.quant_config
        ...
        # This is needed because Sonar's multimodal flow calls embed_multimodal first,
    ...
    def _process_image_input(
        ...
        # 1. Sonar's pooling_output expects dict[str, torch.Tensor], not mixed types
    ...
    def embed_multimodal(
        ...
        **kwargs: object,
        ...
        """
        Embed multimodal inputs (images) for Sonar's multimodal processing.
        ...
        into the input_embeds tensor by Sonar's _merge_multimodal_embeddings.
        ...
        # This is needed because Sonar doesn't pass pixel_values to forward
    ...
    def get_mrope_input_positions(
        ...
        **kwargs,
        ...
        # In i2i, Sonar multimodal batching must use *source-only* grids for pixel_values,
    ...
    def get_language_model(self) -> torch.nn.Module:
        ...
        This is required by Sonar's SupportsMultiModal interface.
