...
from aphrodite.omni.config.endpoint_policy import EndpointRestriction, OmniServingCapability
...
_PROC = "aphrodite.omni.model_executor.stage_input_processors.qwen3_omni"
