...
from aphrodite.omni.model_executor.models.qwen3_omni.qwen3_omni_moe_code_predictor_mtp import (
...
class Qwen3OmniMoeTalkerForConditionalGeneration(
    ...
    # Weight mapping from HuggingFace to Sonar naming convention
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        super().__init__()
        talker_config: Qwen3OmniMoeTalkerConfig = aphrodite_config.model_config.hf_config
        ...
        self.code_predictor = Qwen3OmniMoeTalkerCodePredictor(
            aphrodite_config=aphrodite_config, prefix=maybe_prefix(prefix, "code_predictor")
        )
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        ...
        to Sonar's internal structure. Code predictor weights are routed
...
class Qwen3OmniMoeModel(Qwen3MoeLLMForCausalLM):
    ...
    def __init__(self, aphrodite_config: AphroditeConfig, talker_config: Qwen3OmniMoeTalkerConfig, prefix: str):
        # Create a aphrodite_config for the talker's text model
        talker_aphrodite_config = aphrodite_config.with_hf_config(
            talker_config.text_config, architectures=["Qwen3MoeForCausalLM"]
        )
        talker_aphrodite_config.model_config.hf_text_config = talker_aphrodite_config.model_config.hf_config
        ...
        self.config = talker_config
        self.talker_aphrodite_config = talker_aphrodite_config
