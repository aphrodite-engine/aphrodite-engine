...
from aphrodite.config import AphroditeConfig  # type: ignore
from aphrodite.logger import init_logger  # type: ignore
...
class Qwen3OmniMoeCode2Wav(nn.Module, Qwen3OmniNestedSupportsQuant):
    ...
    def __init__(
        ...
        *,
        ...
        self.config: Qwen3OmniMoeCode2WavConfig = aphrodite_config.model_config.hf_config
    ...
    def enable_cudagraph(
        ...
        from aphrodite.omni.model_executor.models.qwen3_tts.cuda_graph_decoder_wrapper import (
