...
from aphrodite.omni.entrypoints.duplex.protocol import DuplexCapabilities
from aphrodite.omni.entrypoints.duplex.runtime_adapter import ServingRuntimeConfigError
from aphrodite.omni.model_executor.models.minicpmo_4_5.duplex.session import (
    MiniCPMO45ServingSessionState,
)
from aphrodite.omni.model_executor.models.nemotron_voicechat.duplex.data_plane import (
