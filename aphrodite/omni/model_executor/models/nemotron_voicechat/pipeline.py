...
* Stage 0 (``thinker``, LLM_AR): vendored FastConformer perception + additive
  channel fusion feeding the NemotronH backbone on Sonar; emits the frame-locked
...
_PROC = "aphrodite.omni.model_executor.stage_input_processors.nemotron_voicechat"
...
NEMOTRON_VOICECHAT_PIPELINE = PipelineConfig(
    ...
    duplex_runtime_extension=(
        "aphrodite.omni.model_executor.models.nemotron_voicechat.duplex.runtime.NemotronVoiceChatDuplexRuntimeExtension"
    ),
    duplex_serving_adapter=(
        "aphrodite.omni.model_executor.models.nemotron_voicechat.duplex.serving_adapter.NemotronVoiceChatServingRuntimeAdapter"
    ),
