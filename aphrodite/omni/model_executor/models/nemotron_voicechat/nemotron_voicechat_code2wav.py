...
class NemotronVoiceChatCode2Wav(nn.Module):
        ...
        **kwargs: Any,
        ...
        for i in range(num_req):
            ...
            if codec_streaming:
                ...
                from aphrodite.omni.model_executor.models.nemotron_voicechat.nemo_vendored.ear_tts_vae_codec import (
                    CausalConv1dCache,
                )
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        ...
        The Sonar safetensors iterator streams the full unified checkpoint; only
