...
from aphrodite.omni.model_executor.models.minicpmo_4_5.duplex.policy import MiniCPMO45DuplexPolicy
from aphrodite.omni.model_executor.models.minicpmo_4_5.minicpmo_4_5_omni_llm import (
...
from aphrodite.omni.model_executor.models.utils import add_prefix_to_loaded_weights
...
class MiniCPMO45OmniForConditionalGeneration(nn.Module, SupportsMultiModal, SupportsPP, SupportsMRoPE):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        config: MiniCPMOConfig = aphrodite_config.model_config.hf_config
        ...
        from aphrodite.omni.model_executor.models.minicpmo_4_5.duplex.compat import (
    ...
    def preprocess(
        ...
        **kwargs,
        ...
        if state is None:
            from aphrodite.omni.model_executor.models.minicpmo_4_5.duplex.stage0 import (
    ...
    def _duplex_data_plane_helper(self):
        ...
        if helper is not None:
            return helper
        from aphrodite.omni.model_executor.models.minicpmo_4_5.duplex.stage0 import MiniCPMO45Stage0DuplexRuntime

        model_path = getattr(getattr(self.aphrodite_config, "model_config", None), "model", None)
    ...
    def embed_multimodal(self, **kwargs: object):
        """Sonar V1 encoder profiling calls this; the inherited Protocol stub returns None."""
    ...
    def _minicpmo45_tokenizer(self):
        ...
        if tokenizer is None:
            try:
                ...
                tokenizer = cached_tokenizer_from_config(self.aphrodite_config.model_config)
            except Exception:
                pass
