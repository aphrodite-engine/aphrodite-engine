...
class MiniCPMO45Stage0DuplexRuntime:
    ...
    def _stage_prefill_embeddings_only(
        ...
        *,
        ...
        model forward. The normal Sonar runner consumes the returned embeddings
    ...
    def _token_embedding_dtype(self) -> Any:
        ...
        Official ``get_aphrodite_embedding`` casts vision hidden states to the token
        ...
        *,
        ...
        if callable(process_audio):
            ...
            for target in (self.stage_model, self.thinker):
                ...
                # The split Sonar stage0 wrapper ports official
        ...
        # The split Sonar stage0 wrapper may only expose the streaming encoder
