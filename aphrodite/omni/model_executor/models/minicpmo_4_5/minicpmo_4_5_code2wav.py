...
class MiniCPMO45Code2Wav(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.model_path = str(aphrodite_config.model_config.model)
        self._model_revision = getattr(aphrodite_config.model_config, "revision", None)
    ...
    def _extra_config(self) -> dict[str, Any]:
        model_config = getattr(self.aphrodite_config, "model_config", None)
        ...
        **kwargs: Any,
        ...
        if self.backend is None:
            ...
            logger.warning_once(
                ...
                getattr(getattr(self.aphrodite_config, "load_config", None), "load_format", "unknown"),
            )
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        ...
        # parameters as initialized so Sonar's strict loader audit does not
    ...
    def _build_backend(self) -> None:
        ...
        # on NPU.
        from aphrodite.omni.model_executor.models.minicpmo_4_5.minicpmo_4_5_token2wav import (
        ...
        try:
            # Sonar constructs bf16 models under a bf16 default-dtype context.
        ...
        if use_trt and current_omni_platform.is_cuda():
            from aphrodite.omni.model_executor.models.step_audio2.step_audio2_dit_trt import build_dit_trt_stepper
