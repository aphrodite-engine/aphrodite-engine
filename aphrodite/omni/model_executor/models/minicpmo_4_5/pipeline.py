...
_PROC = "aphrodite.omni.model_executor.stage_input_processors.minicpmo_4_5_omni"
...
MINICPMO_4_5_PIPELINE = PipelineConfig(
    ...
    duplex_runtime_extension=(
        "aphrodite.omni.model_executor.models.minicpmo_4_5.duplex.runtime.MiniCPMO45DuplexRuntimeExtension"
    ),
    duplex_serving_adapter=(
        "aphrodite.omni.model_executor.models.minicpmo_4_5.duplex.serving_adapter.MiniCPMO45ServingRuntimeAdapter"
    ),
