...
class MiniMaxMusic3AcousticForConditionalGeneration(nn.Module):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = "") -> None:
        ...
        # Skeleton only. Sonar's memory profiler walks the module tree at
    ...
    def _connector_extra_config(self) -> dict[str, Any]:
        ...
        connector = getattr(self.aphrodite_config.model_config, "stage_connector_config", None)
    ...
    def load_weights(self, weights: Iterable[tuple[str, Tensor]]) -> set[str]:
        ...
        The iterator Sonar hands over covers the stage's own checkpoint folder,
