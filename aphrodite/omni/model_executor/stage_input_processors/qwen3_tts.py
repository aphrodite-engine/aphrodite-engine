...
from aphrodite.omni.model_executor.stage_input_processors.chunk_size_utils import (
...
def talker2code2wav_token_only(
    ...
    for i, talker_output in enumerate(source_outputs):
        ...
        if additional_info:
            next_prompt["additional_information"] = additional_info
        code2wav_inputs.append(next_prompt)
