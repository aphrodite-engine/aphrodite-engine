...
``aphrodite/omni/model_executor/models/minimax_music3/pipeline.py``:
...
from aphrodite.omni.model_executor.models.minimax_music3.prompt import build_cfg_null_token_ids
from aphrodite.omni.model_executor.stage_input_processors.bagel import ExpandedPrompt
