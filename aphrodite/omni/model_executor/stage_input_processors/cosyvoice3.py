...
from aphrodite.omni.model_executor.models.cosyvoice3.utils import unpad_prompt_conditioning
...
def text2flow_token_only(
    ...
    CosyVoice3 sync keeps codec ids on the legacy token path.  Some Sonar v1
