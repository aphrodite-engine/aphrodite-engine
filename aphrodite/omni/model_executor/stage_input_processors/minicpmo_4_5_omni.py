...
from aphrodite.omni.data_entry_keys import CodesStruct, MetaStruct, OmniPayloadStruct
from aphrodite.omni.engine.duplex.intermediate import (
...
def _extract_native_runtime_ref_audio(data_plane_metadata):
    ...
    if not isinstance(runtime_config, dict):
        return None
    from aphrodite.omni.model_executor.models.minicpmo_4_5.duplex.input import decode_native_ref_audio_from_config
...
def llm2tts(
    source_outputs,
    prompt: OmniTokensPrompt | TextPrompt | list[OmniTokensPrompt | TextPrompt | None] | None = None,
    ...
    for llm_output in llm_outputs:
        ...
        if is_native_duplex_handoff:
            ...
            if not isinstance(override_keys, list):
                raise ValueError("Duplex override_keys must be a list")
        ...
        tts_inputs.append(
            OmniTokensPrompt(
                ...
                model_intermediate_buffer=dict(model_intermediate_buffer),
                multi_modal_data=(
