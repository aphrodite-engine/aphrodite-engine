...
from aphrodite.model_executor.model_loader.weight_utils import DisabledTqdm, get_lock
...
def download_weights_from_hf_specific(
    ...
    download_kwargs = {"tqdm_class": DisabledTqdm} if not envs.APHRODITE_USE_MODELSCOPE else {}
...
def resolve_model_to_local_path(
    ...
    *,
    ...
    # Cache-only lookups stay on huggingface_hub even under APHRODITE_USE_MODELSCOPE:
