...
`aphrodite.omni.worker.sparse_audio.resolve_sparse_mm_routing` and arrives here
as plain arguments.
"""
...
from aphrodite.omni.utils.mm_outputs import to_payload_element
...
def build_combined_prefix_cache_mm_payload(
    ...
    *,
    ...
    for mm_key in combined_multimodal_outputs:
