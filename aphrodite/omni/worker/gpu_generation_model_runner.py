...
"""Code2Wav GPU Model Runner for Sonar Omni.
...
from aphrodite.omni.worker.gpu_ar_model_runner import ExecuteModelState, _ensure_tensor_values
...
class GPUGenerationModelRunner(OmniGPUModelRunner, OmniConnectorModelRunnerMixin):
    """Generation model runner for Sonar Omni (non-autoregressive).
    ...
    def _update_request_states(self, scheduler_output: SchedulerOutput):
        ...
        assert isinstance(cached_reqs, OmniCachedRequestData)
        req_states = []
    ...
    def execute_model(
        ...
        with (
            ...
            if num_scheduled_tokens <= 0:
                ...
                result = self.kv_connector_no_forward(scheduler_output, self.aphrodite_config)
    ...
    def _dummy_run(
        ...
        with self.maybe_dummy_run_with_lora(
            ...
            with (
                ...
                # stages are not. The kwarg stays accepted for Sonar API compat.
