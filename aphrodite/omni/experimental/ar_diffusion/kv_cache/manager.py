...
This is the *body* of AR-Diffusion's KV management: it owns a Sonar ``KVCacheManager`` (a
...
from aphrodite.omni.experimental.ar_diffusion.capability import ARDiffusionKVBranchSpec
from aphrodite.omni.experimental.ar_diffusion.kv_cache.config import ARDiffusionKVConfig
from aphrodite.omni.experimental.ar_diffusion.kv_cache.paged import (
    ChunkWindowSpec,
...
class ARDiffusionRequestAdapter(Request):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            prompt_token_ids=[0] * prefill_prefix_tokens,
            sampling_params=SamplingParams(max_tokens=1),
            pooling_params=None,
        )
        self.skip_reading_prefix_cache = True
        # Sonar 0.26 KVCacheManager.allocate_slots reads this when computing
        ...
        self.num_computed_tokens = prefill_prefix_tokens
    ...
    def on_chunk_committed(self) -> None:
        ...
        self.num_computed_tokens = self._prefill + self._completed_chunks * self._chunk_size
    ...
    def __init__(
        ...
        *,
        ...
        def _required_managed_blocks(capacity: int) -> int:
            assert config.window_chunks is not None
