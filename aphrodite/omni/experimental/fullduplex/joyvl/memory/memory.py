...
from aphrodite.omni.experimental.fullduplex.joyvl.decision import prompts
...
def build_memory_prefix(
    ...
    *,
    ...
    for summary in memory.mid_term_summaries:
        history_parts.append(f"<{summary.frame_range}>\n{summary.summary_text}")
    if history_parts:
