...
from aphrodite.omni.experimental.fullduplex.joyvl.decision.prompts import DELEGATION_SOLVER_PROMPT
...
class ImageGenDelegationBridge:
    ...
    OpenAI-compatible ``/v1/images/generations`` endpoint (e.g. Sonar Omni Qwen-Image).
...
class ImageEditDelegationBridge:
    ...
    (e.g. Sonar Omni Qwen-Image-Edit) over the OpenAI-compatible ``/v1/chat/completions``
