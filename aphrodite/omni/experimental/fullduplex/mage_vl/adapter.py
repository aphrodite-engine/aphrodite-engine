...
from aphrodite.omni.experimental.fullduplex.core.runtime import DuplexRuntime, Emit
...
class MageVLDuplexAdapter(DuplexAdapter):
    ...
    same adapter can front the remote-code Transformers path, Sonar once native
