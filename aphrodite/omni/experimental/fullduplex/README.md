...
client.py          legacy Realtime probe client (RealtimeDuplexClient) used by
                   ...
                   aphrodite.omni.clients.duplex.DuplexClient instead
...
```text
aphrodite/omni/engine/duplex/                       engine control plane, sessions, leases
aphrodite/omni/entrypoints/duplex/           WebSocket serving and Realtime projection
aphrodite/omni/entrypoints/duplex_request_client.py request/output lifecycle
aphrodite/omni/model_executor/models/minicpmo_4_5/duplex/  MiniCPM adapter
aphrodite/omni/model_executor/models/personaplex/duplex/   PersonaPlex adapter
aphrodite/omni/model_executor/models/nemotron_voicechat/duplex/  Nemotron VoiceChat adapter
aphrodite/omni/model_executor/duplex_sampling.py    AR-runner sampling hook helper
aphrodite/omni/outputs/duplex.py                    typed output decision envelope
```
...
1. Create a sibling package `aphrodite/omni/experimental/fullduplex/<model>/`; keep
