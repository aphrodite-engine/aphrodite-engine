...
_FISH_KVCACHE_ATTN_ENV = "APHRODITE_OMNI_FISH_KVCACHE_ATTN"
...
def _triton_backend() -> Any:
    from aphrodite.omni.attention import fish_kvcache_triton
...
def _get_decode_workspace(
    ...
    key: tuple[str, int | None, str] | tuple[str, int | None, int, int, int, int]
    partial_shapes: tuple[tuple[int, ...], tuple[int, ...], tuple[int, ...]]
