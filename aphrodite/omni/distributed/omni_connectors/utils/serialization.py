...
class OmniMsgpackEncoder:
    """
    This implementation is adapted from Sonar’s MsgpackEncoder.
...
class OmniMsgpackDecoder:
    """
    This implementation is adapted from Sonar’s MsgpackDecoder.
    However, zero-copy support has not been implemented yet.
    ...
    def _decode_request_output(self, obj: dict[str, Any]) -> RequestOutput:
        ...
        avoid triggering the "Ignoring extra arguments" warning in aphrodite.
