...
from aphrodite.omni.diffusion.attention.backends.ring.ring_globals import (
...
from aphrodite.omni.diffusion.attention.backends.ring.ring_selector import AttnType
from aphrodite.omni.diffusion.attention.parallel.base import (
...
class RingParallelAttention:
    ...
    def run_attention(
        ...
        def _run_sdpa() -> torch.Tensor:
            from aphrodite.omni.diffusion.attention.backends.ring_pytorch_attn import ring_pytorch_attn_func
        ...
        from aphrodite.omni.diffusion.attention.backends.ring_flash_attn import ring_flash_attn_func
