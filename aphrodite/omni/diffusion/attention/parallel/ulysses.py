...
from aphrodite.omni.diffusion.attention.parallel.base import ParallelAttentionContext
from aphrodite.omni.diffusion.distributed.comm import SeqAllToAll4D
from aphrodite.omni.diffusion.distributed.group_coordinator import SequenceParallelGroupCoordinator
...
class UlyssesParallelAttention:
    ...
    def __init__(
        ...
        if _a2a_permute_enabled(
            ...
            from aphrodite.omni.diffusion.distributed.a2a_permute import ensure_a2a_permute_available
    ...
    def pre_attention(
        ...
        if mode == "advanced_uaa":
            ...
            if _a2a_permute_enabled(
                ...
                from aphrodite.omni.diffusion.distributed.a2a_permute import ulysses_qkv_fwd
    ...
    def post_attention(self, attn_output: torch.Tensor, ctx: ParallelAttentionContext | None) -> torch.Tensor:
        ...
        if ctx.joint_len > 0:
            ...
            if ctx.use_uaa:
                ...
                from aphrodite.omni.diffusion.distributed.a2a_permute import ulysses_o_rev
