...
from aphrodite.omni.diffusion.attention.backends.abstract import QueryRange
from aphrodite.omni.diffusion.attention.parallel.base import ParallelAttentionContext
from aphrodite.omni.diffusion.distributed.group_coordinator import (
...
class AllGatherKVParallelAttention:
    ...
    def pre_attention(
        ...
        assert isinstance(k_img_full, torch.Tensor)
        assert isinstance(v_img_full, torch.Tensor)
