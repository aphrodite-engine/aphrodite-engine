...
similar to Sonar's AttentionBackendEnum. Each backend registers its class path,
...
if TYPE_CHECKING:
    from aphrodite.omni.diffusion.attention.backends.abstract import AttentionBackend
...
class DiffusionAttentionBackendEnum(Enum, metaclass=_DiffusionBackendEnumMeta):
    ...
    FLASH_ATTN = "aphrodite.omni.diffusion.attention.backends.flash_attn.FlashAttentionBackend"
    TORCH_SDPA = "aphrodite.omni.diffusion.attention.backends.sdpa.SDPABackend"
    SAGE_ATTN = "aphrodite.omni.diffusion.attention.backends.sage_attn.SageAttentionBackend"
    SAGE_ATTN_3 = "aphrodite.omni.diffusion.attention.backends.sage_attn3.SageAttention3Backend"
    CUDNN_ATTN = "aphrodite.omni.diffusion.attention.backends.cudnn_attn.CuDNNAttentionBackend"
    FLASHINFER_ATTN = "aphrodite.omni.diffusion.attention.backends.flashinfer_attn.FlashInferAttentionBackend"
    FASTVIDEO_VSA = "aphrodite.omni.diffusion.attention.backends.fastvideo_vsa.FastVideoVSABackend"
    FLASH_ATTN_HUB = "aphrodite.omni.diffusion.attention.backends.flash_attn_hub.FlashAttentionHubBackend"
    FLASH_ATTN_3_HUB = "aphrodite.omni.diffusion.attention.backends.flash_attn_hub.FlashAttention3HubBackend"
    TRTLLM_ATTN = "aphrodite.omni.diffusion.attention.backends.trtllm_attn.TrtllmAttentionBackend"
    RAINFUSION_ATTN = "aphrodite.omni.diffusion.attention.backends.rainfusion_attn.RainFusionAttentionBackend"
