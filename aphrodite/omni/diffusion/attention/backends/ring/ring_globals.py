...
HAS_FA3 = False
fa3_fwd_func: Callable[..., Any] | None = None
fa3_attn_func: Callable[..., Any] | None = None
...
HAS_FA4 = False
fa4_attn_func: Callable[..., Any] | None = None
try:
...
try:
    ...
    fa3_fwd_func = flash_attn_interface._flash_attn_forward
    fa3_attn_func = flash_attn_interface.flash_attn_func
    HAS_FA3 = True
...
if not HAS_FA3:
    try:
        ...
        fa3_fwd_func = fa3_fwd_interface._flash_attn_forward
        fa3_attn_func = fa3_fwd_interface.flash_attn_func
        HAS_FA3 = True
