...
from aphrodite.omni.diffusion.attention.backends.flash_attn import FlashAttentionBackend
...
# slices the sequence on dim 1. Sonar Omni diffusion attention hands the impl
