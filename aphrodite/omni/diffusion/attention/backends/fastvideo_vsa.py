...
from aphrodite.omni.diffusion.attention.backends.sdpa import SDPAImpl
...
if not hasattr(torch.ops.aphrodite_omni, "fastvideo_vsa_bshd"):

    @torch.library.custom_op("aphrodite_omni::fastvideo_vsa_bshd", mutates_args=())
...
_fastvideo_vsa_bshd_op = torch.ops.aphrodite_omni.fastvideo_vsa_bshd
...
if not hasattr(torch.ops.aphrodite_omni, "fastvideo_h3_vsa_bhsd"):

    @torch.library.custom_op("aphrodite_omni::fastvideo_h3_vsa_bhsd", mutates_args=())
...
_fastvideo_h3_vsa_bhsd_op = torch.ops.aphrodite_omni.fastvideo_h3_vsa_bhsd
