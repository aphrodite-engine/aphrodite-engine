...
if not hasattr(torch.ops.aphrodite_omni, "sageattn3_blackwell"):

    @torch.library.custom_op("aphrodite_omni::sageattn3_blackwell", mutates_args=())
...
_sageattn3_blackwell_op = torch.ops.aphrodite_omni.sageattn3_blackwell
