...
def _ensure_built() -> None:
    ...
    with _BUILD_LOCK:
        ...
        load(
            name="aphrodite_omni_a2a_permute",
            sources=[src],
...
# ---------------------------------------------------------------------------
@torch.library.custom_op("aphrodite_omni_a2a::ulysses_qkv_fwd", mutates_args=(), device_types="cuda")
...
# ---------------------------------------------------------------------------
@torch.library.custom_op("aphrodite_omni_a2a::ulysses_o_rev", mutates_args=(), device_types="cuda")
