...
in diffusers. We use "Sequence Parallelism" to align with Sonar Omni terminology.
...
class SequenceParallelConfig:
    """Configuration for Sequence Parallelism using Sonar Omni's parallel state.

    This class provides a unified interface for SP configuration that integrates
    with Sonar Omni's existing SequenceParallelGroupCoordinator. Unlike diffusers'
    ...
    Note:
        ...
        Sonar Omni supports hybrid Ulysses-Ring attention (both > 1).
    """
    ...
    def get_world_size(self) -> int:
        ...
        """
        from aphrodite.omni.diffusion.distributed.parallel_state import get_sequence_parallel_world_size
    ...
    def get_rank(self) -> int:
        ...
        Raises:
            RuntimeError: If parallel state is not initialized.
        """
        from aphrodite.omni.diffusion.distributed.parallel_state import get_sequence_parallel_rank
    ...
    def get_ulysses_rank(self) -> int:
        ...
        """
        from aphrodite.omni.diffusion.distributed.parallel_state import get_ulysses_parallel_rank
    ...
    def get_ring_world_size(self) -> int:
        ...
        """
        from aphrodite.omni.diffusion.distributed.parallel_state import get_ring_parallel_world_size
    ...
    def get_ring_rank(self) -> int:
        ...
        """
        from aphrodite.omni.diffusion.distributed.parallel_state import get_ring_parallel_rank
...
class SequenceParallelPartialInput:
    ...
    designed for Sonar Omni's dual-stream attention models.
    ...
    for module_id, module_plan in plan.items():
        ...
        if isinstance(module_plan, dict):
            for key, value in module_plan.items():
                ...
                if isinstance(value, (SequenceParallelInput, SequenceParallelPartialInput)):
