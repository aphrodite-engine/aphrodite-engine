...
from aphrodite.omni.diffusion.models.interface import DecodedChunkConsumer
...
def _patch_attention_block(module: nn.Module, group: dist.ProcessGroup, split_dim: str) -> None:
    if getattr(module, "_aphrodite_omni_spatial_shard_attention", False):
        return
    ...
    module._aphrodite_omni_spatial_shard_attention = True  # type: ignore[attr-defined]
...
def install_wan_spatial_shard_decode(vae: Any, group: dist.ProcessGroup, split_dim: str = "height") -> None:
    ...
    if getattr(vae, "_aphrodite_omni_wan_spatial_shard_installed", False):
        installed_split_dim = getattr(vae, "_aphrodite_omni_wan_spatial_shard_split_dim", "height")
    ...
    vae._aphrodite_omni_wan_spatial_shard_installed = True
    vae._aphrodite_omni_wan_spatial_shard_split_dim = split_dim
