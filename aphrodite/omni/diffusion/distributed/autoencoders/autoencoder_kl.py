...
from aphrodite.omni.diffusion.distributed.autoencoders.distributed_vae_executor import (
    DistributedOperator,
    DistributedVaeMixin,
    GridSpec,
    TileTask,
...
# from aphrodite.omni.diffusion.models.nextstep_1_1.modeling_flux_vae import AutoencoderKL as Next_Step_AutoencoderKL

logger = init_logger(__name__)


class _AutoencoderMethods(Protocol):
    @classmethod
    ...
    def decode(self, z: torch.Tensor, return_dict: bool = True, *args: Any, **kwargs: Any) -> Any: ...
...
class DistributedAutoencoderKL_base(DistributedVaeMixin):
    ...
    def from_pretrained(cls, *args: Any, **kwargs: Any):
        model = cast(_AutoencoderMethods, super()).from_pretrained(*args, **kwargs)
        model.init_distributed()
        return model

    @classmethod
    def from_config(cls, *args: Any, **kwargs: Any):
        model = cast(_AutoencoderMethods, super()).from_config(*args, **kwargs)
        model.init_distributed()
        return model
    ...
    def decode(self, z: torch.Tensor, return_dict: bool = True, *args: Any, **kwargs: Any):
        if not self.is_distributed_enabled():
            return cast(_AutoencoderMethods, super()).decode(z, return_dict, *args, **kwargs)
