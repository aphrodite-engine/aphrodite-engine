...
from aphrodite.omni.diffusion.models.diffusers_adapter.pipeline_utils import resolve_diffusers_pipeline_class
...
def get_dummy_run_num_frames(model_class_name: str, supports_audio_input: bool) -> int:
    ...
    if model_cls is not None and hasattr(model_cls, "dummy_run_num_frames"):
        return int(model_cls.dummy_run_num_frames)
