...
from aphrodite.omni.diffusion.diffusion_kv.metadata import (
    DiffusionKVMetadata,
    DiffusionKVSequenceMetadata,
)
from aphrodite.omni.diffusion.diffusion_kv.request import DiffusionKVRequest
...
class DiffusionKVCacheManager:
    """Atomic public-request facade over native Sonar KVCacheManager."""
    ...
    def __init__(
        ...
        *,
        ...
        # Native Sonar may reserve a null block, so an idle BlockPool does not
    ...
    def _get_empty_pool_required_blocks(self, requests: Sequence[DiffusionKVRequest]) -> int:
        ...
        Sonar performs this calculation inside ``allocate_slots`` when
