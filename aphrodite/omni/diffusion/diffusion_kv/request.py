...
class DiffusionKVRequest(Request):
    ...
    def __init__(
        ...
        *,
        ...
        self._diffusion_seq_len = seq_len
        super().__init__(
        ...
        # Native Sonar Request surface. Keep this list intentionally small and
        ...
        # Sonar 0.26+ uses this optional boundary when publishing cached blocks;
    ...
    def num_tokens(self) -> int:
        return self._diffusion_seq_len
