...
"""Diffusion input-batch structures following the MRV2-style Sonar layout.
...
from aphrodite.omni.diffusion.interaction.modality_handlers.prompt import prompt_update_versions
...
def scatter_latents(
    ...
    This is the CPU fallback of the Sonar-style post-update path. The mapping is
