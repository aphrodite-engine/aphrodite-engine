...
from aphrodite.omni.diffusion.sched.base_scheduler import BaseScheduler
...
def _normalize_explicit_flow_shift(
    value: str | bytes | bytearray | SupportsFloat | SupportsIndex | None,
) -> float | None:
