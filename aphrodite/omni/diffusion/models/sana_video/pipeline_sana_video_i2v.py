...
from aphrodite.omni.diffusion.models.sana_video.pipeline_sana_video import (
...
from aphrodite.omni.diffusion.request import OmniDiffusionRequest, resolve_video_num_frames
...
class SanaImageToVideoPipeline(SanaVideoPipeline, SupportImageInput):
    """Native Sonar Omni SANA-Video 2B image-to-video pipeline.
