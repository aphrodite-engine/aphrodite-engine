...
from aphrodite.omni.diffusion.distributed.autoencoders.autoencoder_kl_ltx2 import (
...
from aphrodite.omni.diffusion.distributed.cfg_parallel import CFGParallelMixin, _wrap
...
from aphrodite.omni.diffusion.request import resolve_video_num_frames
...
def retrieve_timesteps(
    ...
    **kwargs,
    ...
    # Sonar initializes models under a CUDA default-device context. Diffusers'
...
class SanaVideoPipeline(
    ...
    r"""
    Sonar Omni pipeline for text-to-video generation using
