...
from aphrodite.omni.diffusion.models.bagel.bagel_transformer import (  # noqa: F401
    Bagel,
...
class LanceBagel(Bagel):
    ...
    def _lance_bucket_resize_pil(image):
        ...
        # sonar-omni preserved the input image's hat when upstream removed it.
    ...
    def forward_cache_update_vae(
        ...
        :meth:`Bagel.forward_cache_update_vae` in sonar-omni computes
        ...
        # — both upstream and sonar-omni default to ``use_sample=True``).  Each
        ...
        # per branch made sonar-omni's gen vs cfg VAE-ref K cache diverge by
