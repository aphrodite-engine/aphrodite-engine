...
from aphrodite.omni.diffusion.models.krea2.krea2_transformer import Krea2Transformer2DModel
...
class Krea2Pipeline(nn.Module, DiffusionPipelineProfilerMixin, ProgressBarMixin, SupportsComponentDiscovery):
    """The Krea 2 text-to-image pipeline (Sonar Omni port of ``diffusers.Krea2Pipeline``).
