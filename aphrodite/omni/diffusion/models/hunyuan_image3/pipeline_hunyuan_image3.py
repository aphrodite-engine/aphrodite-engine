...
from aphrodite.config.aphrodite import get_current_aphrodite_config
...
from aphrodite.omni.model_executor.models.hunyuan_image3.siglip2 import Siglip2VisionTransformer
...
def _resize_and_crop_center(image: PILImage.Image, target_width: int, target_height: int) -> PILImage.Image:
    ...
    # aphrodite.omni.model_executor.models.hunyuan_image3.hunyuan_image3 so the AR
...
class HunyuanImage3Pipeline(
    ...
    def __init__(self, od_config: OmniDiffusionConfig) -> None:
        ...
        from aphrodite.omni.diffusion.distributed.autoencoders.autoencoder_kl_hunyuan import (  # noqa: PLC0415
    ...
    def instantiate_vit_image_tokens(
        ...
        for batch_idx, image in enumerate(cond_vit_images):
            ...
            # hidden_size) after the Sonar-layers refactor, not an HF-style output.
