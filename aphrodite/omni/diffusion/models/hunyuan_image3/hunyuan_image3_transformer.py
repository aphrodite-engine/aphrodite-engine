...
from aphrodite.omni.diffusion.attention.backends.abstract import (
    AttentionMetadata,
)
...
from aphrodite.omni.diffusion.distributed.sp_plan import (
    SequenceParallelInput,
    SequenceParallelOutput,
)
from aphrodite.omni.diffusion.distributed.utils import get_local_device
from aphrodite.omni.diffusion.forward_context import set_forward_context_denoise_step_idx
from aphrodite.omni.diffusion.layers.fused_moe import FusedMoE
from aphrodite.omni.diffusion.layers.norm import RMSNorm
from aphrodite.omni.diffusion.layers.rope import RotaryEmbedding
...
# resolves to.
from aphrodite.omni.diffusion.models.hunyuan_image3.layers import ResBlock
from aphrodite.omni.diffusion.models.hunyuan_image3.layers.common import conv_nd, normalization
from aphrodite.omni.diffusion.utils.kv_utils import repeat_kv
from aphrodite.omni.model_executor.layers.timestep_embedding import timestep_embedding
...
class HunYuanSparseMoeBlock(nn.Module):
    def __init__(
        ...
        enable_expert_parallel = get_current_aphrodite_config().parallel_config.enable_expert_parallel
...
class HunYuanAttention(nn.Module):
    def __init__(
        ...
        # which attention, from aphrodite or omni?
    ...
    def forward(
        ...
        **kwargs,
        ...
        past_key_value: Cache | None = kwargs.get("past_key_value")
...
class HunyuanImage3Model(nn.Module):
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]):
        ...
        for name, loaded_weight in weights:
            ...
            # quant_config.get_cache_scale was removed in Sonar v0.23.0 (see #4810).
