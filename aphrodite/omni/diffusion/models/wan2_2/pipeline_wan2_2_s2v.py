...
"""
Wan2.2 Speech-to-Video (S2V) Pipeline for Sonar Omni.
...
from aphrodite.omni.diffusion.models.interface import SupportAudioInput, SupportImageInput
...
from aphrodite.omni.diffusion.models.wan2_2.wan2_2_s2v_transformer import (
    create_s2v_transformer_from_config,
)
from aphrodite.omni.diffusion.offloader.config import DIT_COMPONENT, selected_offload_components
...
class Wan22S2VPipeline(
    ...
    def _init_diffusers_format(self, model_path: str, dtype: torch.dtype) -> None:
        ...
        # -- Transformer (S2V variant, native sonar-omni ops) --
