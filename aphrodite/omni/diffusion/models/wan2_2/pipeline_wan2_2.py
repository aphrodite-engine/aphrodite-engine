...
from aphrodite.omni.diffusion.distributed.autoencoders.autoencoder_kl_wan import DistributedAutoencoderKLWan
from aphrodite.omni.diffusion.distributed.cfg_parallel import CFGParallelMixin
from aphrodite.omni.diffusion.distributed.pipeline_parallel import AsyncLatents, PipelineParallelMixin
from aphrodite.omni.diffusion.distributed.utils import get_local_device
from aphrodite.omni.diffusion.forward_context import DenoiseProgressMixin
from aphrodite.omni.diffusion.lora.loader import WanLoraLoaderMixin
from aphrodite.omni.diffusion.model_loader.diffusers_loader import DiffusersPipelineLoader
from aphrodite.omni.diffusion.model_loader.hub_prefetch import from_pretrained_with_prefetch, prefetch_subfolders
from aphrodite.omni.diffusion.models.dmd2 import DMD2PipelineMixin
from aphrodite.omni.diffusion.models.interface import SupportsComponentDiscovery
from aphrodite.omni.diffusion.models.progress_bar import ProgressBarMixin, _is_rank_zero
from aphrodite.omni.diffusion.models.schedulers import FlowUniPCMultistepScheduler
from aphrodite.omni.diffusion.models.wan2_2.scheduling_wan_euler import WanEulerScheduler
from aphrodite.omni.diffusion.models.wan2_2.wan2_2_transformer import WanSelfAttention, WanTransformer3DModel
from aphrodite.omni.diffusion.offloader import OffloadPlan
from aphrodite.omni.diffusion.postprocess import interpolate_video_tensor
from aphrodite.omni.diffusion.profiler.diffusion_pipeline_profiler import DiffusionPipelineProfilerMixin
from aphrodite.omni.diffusion.request import OmniDiffusionRequest
from aphrodite.omni.diffusion.worker.request_batch import DiffusionRequestBatch, split_diffusion_output_by_request
...
def load_wan_weights_with_optional_gate(model: nn.Module, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
    ...
    model.has_gate_compress_weights = has_gate_compress_weights
...
def create_transformer_from_config(
    ...
    if "quantization_config" in config:
        from aphrodite.omni.quantization.factory import resolve_quant_config_from_disk
