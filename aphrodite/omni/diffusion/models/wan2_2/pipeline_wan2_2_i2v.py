...
from aphrodite.omni.diffusion.models.interface import SupportImageInput, SupportsComponentDiscovery
from aphrodite.omni.diffusion.models.progress_bar import ProgressBarMixin, _is_rank_zero
from aphrodite.omni.diffusion.models.utils import _load_json
from aphrodite.omni.diffusion.models.wan2_2.pipeline_wan2_2 import (
...
from aphrodite.omni.diffusion.models.wan2_2.wan2_2_transformer import WanTransformer3DModel
...
from aphrodite.omni.inputs.data import OmniTextPrompt
        ...
        *,
        ...
        if self.has_transformer_2:
            ...
            if isinstance(t2_quant, dict) and "quant_method" in t2_quant:
                from aphrodite.omni.quantization.factory import build_quant_config
