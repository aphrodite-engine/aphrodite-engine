...
Sonar Omni-native layers (``sana_wm_transformer.py`` / ``ucpe.py``); nothing here
...
from aphrodite.omni.diffusion.models.ltx2.ltx2_latents import (
    denormalize_latents,
    normalize_latents,
    pack_latents,
...
from aphrodite.omni.diffusion.models.sana_wm.camera_control import (
    SanaWmCameraCondition,
    build_plucker_condition,
)
from aphrodite.omni.diffusion.models.sana_wm.config import (
    SANA_WM_VAE_SPATIAL_COMPRESSION,
    SANA_WM_VAE_TEMPORAL_COMPRESSION,
    SanaWmConfig,
)
from aphrodite.omni.diffusion.models.sana_wm.request import normalize_sana_wm_payload
from aphrodite.omni.diffusion.models.sana_wm.sana_wm_transformer import (
    SANA_WM_STAGE1_PROMPT_CHANNELS,
    SanaWmTransformer3DModel,
)
from aphrodite.omni.diffusion.models.schedulers import FlowMatchEulerDiscreteScheduler
...
SANA_WM_STAGE1_TEXT_ENCODER_ENV = "APHRODITE_OMNI_SANA_WM_STAGE1_TEXT_ENCODER"
...
class SanaWmPipeline(
    ...
    def _run_native_backend(
        ...
        *,
        ...
        # diffusers' ``FlowMatchEulerDiscreteScheduler``; this is Sonar Omni's
