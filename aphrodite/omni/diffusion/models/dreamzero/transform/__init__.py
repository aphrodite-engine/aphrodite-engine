...
from aphrodite.omni.diffusion.models.dreamzero.transform.base import TRANSFORMS

logger = init_logger(__name__)

DEFAULT_EMBODIMENT = "roboarena"
_BUILTIN_TRANSFORM_MODULES = (
    "aphrodite.omni.diffusion.models.dreamzero.transform.droid",
    "aphrodite.omni.diffusion.models.dreamzero.transform.roboarena",
)
