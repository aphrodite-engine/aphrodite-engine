...
"""DreamZero pipeline for sonar-omni.
...
from aphrodite.omni.diffusion.cache.stepcache import (
    get_stepcache_state,
    is_stepcache_active,
)
from aphrodite.omni.diffusion.data import DiffusionOutput, OmniDiffusionConfig
from aphrodite.omni.diffusion.distributed.autoencoders.autoencoder_kl_wan import (
    DistributedAutoencoderKLWan,
)
from aphrodite.omni.diffusion.distributed.cfg_parallel import CFGParallelMixin
from aphrodite.omni.diffusion.distributed.parallel_state import get_classifier_free_guidance_world_size
...
from aphrodite.omni.diffusion.models.dreamzero.causal_wan_model import CausalWanModel
from aphrodite.omni.diffusion.models.dreamzero.image_encoder import DreamZeroImageEncoder
from aphrodite.omni.diffusion.models.dreamzero.state_dreamzero import DreamZeroState
from aphrodite.omni.diffusion.models.dreamzero.transform import (
    DEFAULT_EMBODIMENT,
    ensure_transforms_loaded,
)
from aphrodite.omni.diffusion.models.dreamzero.transform.base import get_transform
from aphrodite.omni.diffusion.models.dreamzero.utils import (
    DEFAULT_CFG_SCALE,
...
from aphrodite.omni.diffusion.models.schedulers.scheduling_flow_unipc_multistep import FlowUniPCMultistepScheduler
...
from aphrodite.omni.experimental.world_models.adapters.state_dreamzero_adapter import DreamZeroStateAdapter
from aphrodite.omni.experimental.world_models.session_state import (
    SessionStateManager,
...
class DreamZeroPipeline(nn.Module, CFGParallelMixin):
    ...
    def __init__(self, *, od_config: OmniDiffusionConfig, prefix: str = "") -> None:
        ...
        if "ar_diffusion" not in engine_backend.lower().replace("-", "_"):
            raise ValueError(
                ...
                "engine_backend: aphrodite.omni.experimental.ar_diffusion.engine.ARDiffusionEngine "
    ...
    def setup_compile(self) -> None:
        ...
        """
        from aphrodite.omni.diffusion.models.dreamzero.wan_vae_feat_cache_patch import (
