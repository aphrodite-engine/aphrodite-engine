...
class MammothModa2DiTPipeline(nn.Module, SupportsComponentDiscovery):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        # which is insufficient for Sonar dummy-run/cudagraph warmup).
        ...
        # Sonar PP interface compatibility
    ...
    def forward(
        ...
        **kwargs: Any,  # noqa: ARG002
        ...
        # Sampling knobs are declared in aphrodite/omni/model_extras/mammothmodal2_preview.py
