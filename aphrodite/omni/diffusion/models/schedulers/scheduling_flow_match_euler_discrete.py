...
# Originally from https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_flow_match_euler_discrete.py
...
Modified by Sonar Omni contributors for local integration and RNG compatibility.
"""
