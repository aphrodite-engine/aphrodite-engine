...
from aphrodite.omni.diffusion.models.longcat_image.longcat_image_transformer import (
    LongCatImageTransformer2DModel,
)
from aphrodite.omni.diffusion.models.longcat_image.pipeline_longcat_image import calculate_shift
...
from aphrodite.omni.diffusion.utils.size_utils import normalize_min_aligned_size
...
class LongCatImageEditPipeline(
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        """Load weights using AutoWeightsLoader for Sonar integration."""
