...
from aphrodite.omni.diffusion.distributed.sp_sharding import sp_shard_with_padding
...
from aphrodite.omni.diffusion.models.flux.flux_transformer import FeedForward
...
class HunyuanVideo15Transformer3DModel(nn.Module):
    ...
    Ported from diffusers ``HunyuanVideo15Transformer3DModel`` with sonar-omni
