...
from aphrodite.omni.diffusion.distributed.autoencoders.autoencoder_kl import DistributedAutoencoderKL
from aphrodite.omni.diffusion.distributed.utils import get_local_device
from aphrodite.omni.diffusion.forward_context import set_forward_context_ref_latent
from aphrodite.omni.diffusion.model_loader.diffusers_loader import DiffusersPipelineLoader
from aphrodite.omni.diffusion.model_loader.hub_prefetch import prefetch_subfolders
from aphrodite.omni.diffusion.models.ming_flash_omni.byte5_encoder import (
    MingByT5Encoder,
)
from aphrodite.omni.diffusion.models.ming_flash_omni.condition_encoder import (
    MingConditionEncoder,
)
from aphrodite.omni.diffusion.models.ming_flash_omni.ming_zimage_transformer import (
    MingZImageTransformer2DModel,
)
from aphrodite.omni.diffusion.models.z_image.pipeline_z_image import ZImagePipeline
...
from aphrodite.omni.transformers_utils.configs.ming_flash_omni import MingImageGenConfig
...
class MingImagePipeline(ZImagePipeline):
    ...
    def forward(self, req: DiffusionRequestBatch) -> DiffusionOutput:
        ...
        Returns:
            ...
            image tensor in ``[-1, 1]``. The sonar-omni diffusion engine's
...
def get_ming_image_post_process_func(od_config: OmniDiffusionConfig):
    ...
    postprocess to convert it to ``list[PIL.Image]`` which sonar-omni's
    ...
    in aphrodite/omni/diffusion/registry.py.
    """
    import json
