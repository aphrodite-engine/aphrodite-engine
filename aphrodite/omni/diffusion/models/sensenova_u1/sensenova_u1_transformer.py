...
Ported from the sensenova_u1 package with aphrodite tensor-parallel support:
...
from aphrodite.omni.diffusion.cache.cachedit import CacheDiTAdapterConfig, SensenovaCachedAdapter
