...
"""SenseNova-U1 Pipeline for Sonar Omni.
...
from aphrodite.omni.diffusion.lora.loader import (
    LoraLoaderMixin,
...
from aphrodite.omni.transformers_utils.configs.sensenova_u1 import (
    SenseNovaU1Config,
)
...
class SenseNovaU1Pipeline(
    ...
    """SenseNova-U1 text-to-image and image-to-image pipeline for sonar-omni.
    ...
    def _decode_context(self, past_key_values):
        ...
        forward.
        """
        if os.environ.get("APHRODITE_OMNI_SENSENOVA_PAGED_DECODE", "1") != "1":
            return None
    ...
    def _add_lora_deltas(self, state_dict: dict[str, torch.Tensor]) -> int:
        """Add every matching delta into its parameter, sharding through Sonar.
