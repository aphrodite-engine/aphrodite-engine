...
"""
Stable Audio DiT Model for Sonar Omni.
"""
...
from aphrodite.omni.diffusion.layers.fourier import GaussianFourierProjection
...
class StableAudioSelfAttention(nn.Module):
    """
    Optimized self-attention for Stable Audio using Sonar layers.
...
class StableAudioCrossAttention(nn.Module):
    """
    Optimized cross-attention for Stable Audio using Sonar layers.
...
class StableAudioDiTModel(nn.Module):
    """
    Optimized Stable Audio DiT model using Sonar layers.

    This is an optimized version of the diffusers StableAudioDiTModel that uses
    Sonar's efficient linear layers and attention implementations.
