...
"""
Stable Audio Open Pipeline for Sonar Omni.

This module provides text-to-audio generation using the Stable Audio Open model
from Stability AI, integrated with the Sonar Omni diffusion framework.
"""
...
from aphrodite.omni.diffusion.models.interface import SupportAudioOutput, SupportsComponentDiscovery
from aphrodite.omni.diffusion.models.stable_audio.stable_audio_transformer import (
    StableAudioDiTModel,
...
class StableAudioPipeline(nn.Module, SupportAudioOutput, SupportsComponentDiscovery, DiffusionPipelineProfilerMixin):
    ...
    from Stability AI, integrated with Sonar Omni's diffusion framework.
