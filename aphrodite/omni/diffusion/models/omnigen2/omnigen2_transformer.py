...
def _patch_cutlass_padded_fp8():
    """Monkey-patch aphrodite._custom_ops.cutlass_scaled_mm to pad tensors whose
    ...
    Sonar's cutlass_scaled_mm falls back to a Triton scaled_mm kernel for
    ...
    logger.info(
        "Patched aphrodite._custom_ops.cutlass_scaled_mm with CUTLASS-padded FP8 "
