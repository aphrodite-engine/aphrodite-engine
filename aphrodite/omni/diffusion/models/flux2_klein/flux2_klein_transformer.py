...
from aphrodite.omni.diffusion.layers.rope import RotaryEmbedding, apply_rope_to_qk
        ...
        **kwargs,
        ...
        if encoder_hidden_states is not None and self.added_kv_proj_dim is not None:
            ...
            if use_sp_joint_attention and image_rotary_emb is not None:
                ...
                hidden_states_mask: torch.Tensor | None = kwargs.get("hidden_states_mask")
                encoder_hidden_states_mask: torch.Tensor | None = kwargs.get("encoder_hidden_states_mask")
