...
# Refactored to use aphrodite.omni diffusion infrastructure for optimized attention backends
...
class DiT(nn.Module):
    ...
    aphrodite.omni diffusion infrastructure for FlashAttention/SageAttention/SDPA.
    """
