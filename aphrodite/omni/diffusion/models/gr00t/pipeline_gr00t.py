...
from aphrodite.omni.diffusion.models.gr00t.policy import Gr00tPolicy
from aphrodite.omni.diffusion.request import DUMMY_DIFFUSION_REQUEST_ID
...
class Gr00tN1d7Pipeline(nn.Module):
    """GR00T N1.7 policy pipeline backed by Sonar Omni's local GR00T port.

    Sonar Omni owns the serving integration: OpenPI observations arrive through
