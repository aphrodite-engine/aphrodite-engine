...
from aphrodite.omni.diffusion.models.gr00t.dataio.embodiment_tags import (
    FINETUNE_ONLY_TAGS,
    POSTTRAIN_TAGS,
    EmbodimentTag,
)
from aphrodite.omni.diffusion.models.gr00t.dataio.types import MessageType, VLAStepData
from aphrodite.omni.diffusion.models.gr00t.modeling.gr00t_n1d7 import Gr00tN1d7
from aphrodite.omni.diffusion.models.gr00t.modeling.processing_gr00t_n1d7 import Gr00tN1d7Processor
...
class Gr00tPolicy:
    ...
    def _get_action(
        ...
        Args:
            ...
            options: Optional per-request model parameters, forwarded verbatim to
                the action head (e.g. ``generator``)
