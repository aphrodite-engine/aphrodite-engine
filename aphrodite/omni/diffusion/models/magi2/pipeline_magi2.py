...
"""Native Sonar Omni pipeline for ``sand-ai/MAGI-2-preview``.

The model, packing, scheduler, checkpoint mapping, and decoder integration are
owned by Sonar Omni.  SandAI's Apache-2.0 implementation was used as the
...
from aphrodite.omni.diffusion.offloader import OffloadPlan, PinnedModuleStager
    ...
    def __init__(self, od_config: OmniDiffusionConfig, **kwargs: object) -> None:
        ...
        with torch.device("cpu"):
            if self._is_output_rank:
                ...
                from aphrodite.omni.diffusion.models.lance.wan_vae import LanceWanVAE
