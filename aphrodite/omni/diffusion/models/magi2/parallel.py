...
expert-parallel primitives.  It has been modified to reuse Sonar Omni's
...
def get_magi2_ulysses_group() -> Magi2ParallelGroup:
    """Return Sonar Omni's Ulysses subgroup, or a rank-local fallback.
...
def get_magi2_ep_group() -> Magi2ParallelGroup:
    ...
    groups are initialized and owned by Sonar Omni; MAGI creates no ad-hoc
    process groups.
    """
...
def get_magi2_tp_group() -> Magi2ParallelGroup:
    """Return Sonar's tensor-parallel group without an SP fallback."""
