...
from aphrodite.omni.diffusion.cache.base import CachedTransformer
from aphrodite.omni.diffusion.data import DiffusionParallelConfig, OmniDiffusionConfig
from aphrodite.omni.diffusion.distributed.hsdp_utils import is_transformer_block_module
...
class GlmImageAttention(nn.Module):
    """
    Joint attention for GLM-Image model using sonar-omni's optimized attention.
...
class GlmImageTransformer2DModel(CachedTransformer):
    ...
    This is the sonar-omni optimized version of the GLM-Image DiT model.
    ...
    def forward(
        ...
        if sp_size is not None and sp_size > 1:
            from aphrodite.omni.diffusion.forward_context import is_forward_context_available
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        ...
        This method handles the mapping from diffusers weight names to sonar-omni weight names,
        ...
        for name, loaded_weight in weights:
            ...
            for param_name, weight_name, shard_id in stacked_params_mapping:
                ...
                # Map diffusers name to sonar-omni name
