...
"""
GlmImagePipeline implementation for Sonar Omni.

This pipeline implements GLM-Image text-to-image generation with:
- AR stage (Sonar): GLM-Image AR stage generates prior tokens
...
from aphrodite.omni.diffusion.models.glm_image.glm_image_transformer import (
    GlmImageKVCache,
...
class GlmImagePipeline(nn.Module, DiffusionPipelineProfilerMixin, SupportsComponentDiscovery):
    ...
    - AR stage (Sonar): Generates prior image tokens
    ...
    def forward(self, req: DiffusionRequestBatch) -> DiffusionOutput:
        ...
        if external_prior_tokens is not None:
            ...
            raise ValueError(
                "GLM-Image diffusion pipeline expects prior tokens from the Sonar AR stage. "
