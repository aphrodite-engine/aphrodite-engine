...
"""Cosmos3 text/image/video/sound/action pipeline for sonar-omni.
...
from aphrodite.omni.diffusion.models.schedulers.scheduling_flow_match_euler_discrete import (
    FlowMatchEulerDiscreteScheduler,
)
from aphrodite.omni.diffusion.models.schedulers.scheduling_flow_unipc_multistep import (
    FlowUniPCMultistepScheduler,
)
from aphrodite.omni.diffusion.offloader.config import OffloadStrategy, resolve_offload
...
from aphrodite.omni.entrypoints.openai.video_api_utils import positive_float
from aphrodite.omni.experimental.world_models.adapters.state_cosmos3_adapter import (
    Cosmos3StateAdapter,
)
...
def get_cosmos3_ir_op_priority_func(od_config: OmniDiffusionConfig):
    ...
    def ir_op_priority_func(ir_op_priority, aphrodite_config=None):
    ...
    * **T2V** otherwise (default video generation).
    ...
    def _prepare_sound_latents(
        ...
        *,
        ...
        hop_size = int(getattr(sound_tokenizer, "hop_size", None) or sound_tokenizer.temporal_compression_factor)
