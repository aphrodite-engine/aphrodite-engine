...
"""Cosmos3 guardrail hooks for sonar-omni.
...
from aphrodite.omni.diffusion.models.progress_bar import _is_rank_zero
from aphrodite.omni.errors import GuardrailViolationError
