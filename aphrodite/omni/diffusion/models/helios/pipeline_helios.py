...
from aphrodite.omni.diffusion.interaction.mixin import InteractionMixin
from aphrodite.omni.diffusion.interaction.types import ChunkMediaSpec
from aphrodite.omni.diffusion.model_loader.diffusers_loader import DiffusersPipelineLoader
from aphrodite.omni.diffusion.models.helios.helios_transformer import HeliosTransformer3DModel
from aphrodite.omni.diffusion.models.helios.scheduling_helios import HeliosScheduler
...
class HeliosPipeline(
    ...
    """Helios text-to-video / image-to-video / video-to-video pipeline for sonar-omni.
