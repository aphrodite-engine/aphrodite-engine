...
"""
BagelPipeline implementation for Sonar Omni.
"""
...
from aphrodite.transformers_utils.configs.bagel import BagelConfig
...
if TYPE_CHECKING:
    ...
    from aphrodite.omni.inputs.data import OmniDiffusionSamplingParams, OmniPromptType
...
class BagelPipeline(nn.Module, SupportsComponentDiscovery, DiffusionPipelineProfilerMixin):
    """Bagel generation pipeline (MoT) packaged for sonar-omni diffusion engine.
    ...
    def __init__(self, *, od_config: OmniDiffusionConfig, prefix: str = ""):
        ...
        # Allow overriding from sonar-omni config if user wants MoE/vanilla.
        ...
        # Let Sonar loader download and stream all *.safetensors under model root.
        ...
        # 1. Quantization: When quantization is enabled, Sonar linear layers live on meta
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        ...
        def _iter_candidate_names(name: str) -> Iterable[str]:
            ...
            while this sonar-omni integration nests them under `self.bagel`.
            """
                            ...
                            if cand.endswith("bagel.latent_pos_embed.pos_embed") and tensor.ndim == 2:
                                ...
                                if side * side == int(npos) and hdim == int(self.bagel.hidden_size):
                                    ...
                                    if hasattr(self.bagel, "config"):
                                        self.bagel.config.max_latent_size = int(side)
