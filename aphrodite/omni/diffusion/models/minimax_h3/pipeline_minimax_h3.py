...
"""Sonar Omni pipeline for MiniMax H3 FL2VA and Ref2VA partitions."""
...
from aphrodite.omni.diffusion.cache.cachedit import (
    CacheDiTBackend,
...
from aphrodite.omni.diffusion.model_loader.diffusers_loader import (
...
from aphrodite.omni.diffusion.models.progress_bar import ProgressBarMixin
from aphrodite.omni.diffusion.offloader import (
...
from aphrodite.omni.diffusion.profiler.diffusion_pipeline_profiler import (
    DiffusionPipelineProfilerMixin,
)
from aphrodite.omni.diffusion.sched.sigma_schedule import DMD2SigmaSchedule
from aphrodite.omni.diffusion.worker.request_batch import DiffusionRequestBatch
from aphrodite.omni.errors import OmniClientError, client_error_from_metadata
from aphrodite.omni.model_executor.model_loader.weight_utils import (
    download_weights_from_hf_specific,
)
from aphrodite.omni.model_executor.models.minimax_h3.checkpoint import (
    resolve_minimax_h3_partition,
)
from aphrodite.omni.model_executor.models.minimax_h3.conditioning import (
    MiniMaxH3TextConditioning,
)
from aphrodite.omni.model_executor.models.minimax_h3.preprocessing import (
...
from aphrodite.omni.model_executor.models.minimax_h3.reference_video import (
...
from aphrodite.omni.quantization import (
...
if TYPE_CHECKING:
    from aphrodite.omni.diffusion.worker.input_batch import InputBatch
    from aphrodite.omni.diffusion.worker.utils import StepRequestState
