...
"""MiniMax H3 packed-token audio/video DiT for Sonar Omni.

Sonar tensor parallel linears and the unified attention layer provide TP and
...
from aphrodite.omni.diffusion.attention.ops.minimax_h3_modulation import (
    indexed_gate,
...
from aphrodite.omni.diffusion.layers.activation import SiluAndMul
...
from aphrodite.omni.diffusion.models.host_weight_contract import FinalLayoutModelContract
    ...
    def load_weights(
        ...
        for name, loaded_weight in weights:
            ...
            if name.endswith(".attn.qkv_proj.weight"):
                # Transform checkpoint layout before entering Sonar's loader so
