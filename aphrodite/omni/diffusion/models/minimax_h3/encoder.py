...
The encoder is reimplemented on top of Sonar-style tensor-parallel building
...
Tensor parallelism follows Sonar's TP semantics: vocab-parallel embeddings and
...
from aphrodite.omni.diffusion.layers.norm import RMSNorm as DiffusionRMSNorm
from aphrodite.omni.diffusion.offloader.module_residency import (
...
#
# These mirror the math of Sonar's ``VocabParallelEmbedding``,
...
class MiniMaxH3Qwen3VLVocabParallelEmbedding(nn.Module):
    ...
    def forward(self, input_: torch.Tensor) -> torch.Tensor:
        ...
        # Mirror Sonar's `VocabParallelEmbedding`: token ids that fall outside
