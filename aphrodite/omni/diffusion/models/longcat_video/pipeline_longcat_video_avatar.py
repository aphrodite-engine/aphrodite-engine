...
from aphrodite.omni.diffusion.models.longcat_video.longcat_video_avatar_transformer import (
...
class LongCatVideoAvatarPipeline(nn.Module, SupportImageInput, SupportAudioInput):
    ...
    def _load_components(self) -> None:
        try:
            ...
            raise ImportError(
                ...
                "Install the optional extra with `pip install 'sonar-omni[longcat-video-avatar]'`."
            ) from exc
        ...
        # Sonar initializes native pipelines under the target device context.
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        """Load DiT weights using Sonar's diffusion weight loader."""
