...
from aphrodite.omni.diffusion.attention.layer import Attention as AphroditeAttention
...
class Attention(nn.Module):
    """LongCat self-attention projections with Sonar Omni attention execution."""
...
class MultiHeadCrossAttention(nn.Module):
    """LongCat cross-attention projections with Sonar Omni attention execution."""
...
class AvatarSelfAttention(Attention):
    """Avatar self-attention with Sonar Omni attention execution."""
...
class SingleStreamAudioAttention(nn.Module):
    """Avatar audio cross-attention using Sonar Omni attention backend."""
