...
if TYPE_CHECKING:
    from aphrodite.omni.diffusion.models.lingbot_world.transformer import CausalLingBotWorldTransformer3DModel
    from aphrodite.omni.diffusion.models.progress_bar import TqdmProgressBar
