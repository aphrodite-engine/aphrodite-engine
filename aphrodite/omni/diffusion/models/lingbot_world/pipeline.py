...
from aphrodite.omni.diffusion.models.lingbot_world.actions import (
...
from aphrodite.omni.diffusion.models.lingbot_world.camera import (
    CameraTrajectory,
...
from aphrodite.omni.diffusion.models.lingbot_world.dmd_block import ARBlockContext, LingBotDMDBlockRunner
from aphrodite.omni.diffusion.models.lingbot_world.transformer import (
...
from aphrodite.omni.diffusion.models.wan2_2.pipeline_wan2_2 import load_transformer_config, retrieve_latents
...
if TYPE_CHECKING:
    ...
    from aphrodite.omni.experimental.ar_diffusion.kv_cache.state import (
        ARDiffusionKVState,
    )
...
_ACTION_ROOT_ENV = "APHRODITE_OMNI_LINGBOT_ACTION_ROOT"
...
class LingBotWorldCausalDMDPipeline(
    ...
    def _parse_request(self, req: DiffusionRequestBatch) -> _LingBotRequestInputs:
        ...
        elif image.ndim == 3 and image.shape[0] == 3 or image.ndim == 4 and image.shape[:2] == (1, 3):
