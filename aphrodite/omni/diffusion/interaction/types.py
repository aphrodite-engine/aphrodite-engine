...
class InteractionEvent:
    ...
    Example:
    - ``QueuedPromptEvent`` in ``aphrodite.omni.diffusion.interaction.modality_handlers.prompt``
    """
...
class InteractionSession:
    ...
    Example:
    - ``PromptSession`` in ``aphrodite.omni.diffusion.interaction.modality_handlers.prompt``
    """
