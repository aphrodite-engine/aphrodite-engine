...
from aphrodite.omni.diffusion.interaction.registry import STRUCTURED_HANDLER_REGISTRY
from aphrodite.omni.diffusion.interaction.types import (
    InteractionChunkMetadata,
    InteractionPayload,
    merge_interaction_metadata,
)
from aphrodite.omni.diffusion.models.interface import supports_interaction_apply
...
if TYPE_CHECKING:
    ...
    from aphrodite.omni.diffusion.interaction.modality_handlers.base import InteractionHandler
