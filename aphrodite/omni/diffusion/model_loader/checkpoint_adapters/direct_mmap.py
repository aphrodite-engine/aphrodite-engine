...
class _Cosmos3DirectMmapAdapter:
    ...
    def policy_for(
        ...
        # its checkpoint-key remap. Its custom Sonar loaders reduce to exact
...
def get_direct_mmap_adapter(pipeline: nn.Module) -> DirectMmapAdapter | None:
    ...
    from aphrodite.omni.diffusion.models.magi2.modeling_magi2 import (
    ...
    from aphrodite.omni.diffusion.models.cosmos3.transformer_cosmos3 import (
