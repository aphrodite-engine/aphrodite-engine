...
if TYPE_CHECKING:
    ...
    from aphrodite.omni.host_weight_runtime import HostWeightLeaseCarrier
...
def _resolve_source_root(source: DiffusersPipelineLoader.ComponentSource) -> str:
    source_root = os.fspath(source.model_or_path)
