...
def extract_sensenova_u1_context(
    ...
    **kwargs: Any,
    ...
    from aphrodite.omni.diffusion.models.sensenova_u1.sensenova_u1_transformer import (
...
def extract_minimax_h3_context(
    ...
    **kwargs: Any,
    ...
    """
    from aphrodite.omni.diffusion.attention.ops.minimax_h3_modulation import indexed_scale_shift_
    from aphrodite.omni.diffusion.models.minimax_h3.minimax_h3_transformer import (
