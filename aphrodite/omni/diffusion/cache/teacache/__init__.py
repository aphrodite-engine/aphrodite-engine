...
Usage:
    from aphrodite.omni import Omni
...
from aphrodite.omni.diffusion.cache.teacache.backend import TeaCacheBackend
from aphrodite.omni.diffusion.cache.teacache.config import TeaCacheConfig
from aphrodite.omni.diffusion.cache.teacache.extractors import (
    CacheContext,
    register_extractor,
)
from aphrodite.omni.diffusion.cache.teacache.hook import TeaCacheHook, apply_teacache_hook
