...
"""
Hook-based TeaCache implementation for Sonar Omni.
...
from aphrodite.omni.diffusion.cache.teacache.config import TeaCacheConfig
from aphrodite.omni.diffusion.cache.teacache.extractors import get_extractor
from aphrodite.omni.diffusion.cache.teacache.state import TeaCacheState
from aphrodite.omni.diffusion.distributed.parallel_state import (
    get_classifier_free_guidance_rank,
    get_classifier_free_guidance_world_size,
)
from aphrodite.omni.diffusion.hooks import HookRegistry, ModelHook, StateManager
...
def apply_teacache_hook(module: torch.nn.Module, config: TeaCacheConfig) -> None:
    ...
    Example:
        >>> config = TeaCacheConfig(rel_l1_thresh=0.2, transformer_type="QwenImageTransformer2DModel")
