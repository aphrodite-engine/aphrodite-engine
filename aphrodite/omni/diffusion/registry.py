...
from aphrodite.model_executor.models.registry import _LazyRegisteredModel, _ModelRegistry
from aphrodite.omni.diffusion.config import set_current_diffusion_config
from aphrodite.omni.diffusion.data import OmniDiffusionConfig, uses_diffusers_adapter
from aphrodite.omni.diffusion.distributed.autoencoders.distributed_vae_executor import DistributedVaeMixin
from aphrodite.omni.diffusion.distributed.sp_plan import SequenceParallelConfig, get_sp_plan_from_model
from aphrodite.omni.diffusion.forward_context import get_forward_context
from aphrodite.omni.diffusion.hooks.sequence_parallel import apply_sequence_parallel
from aphrodite.omni.diffusion.utils.tf_utils import find_module_with_attr
...
DiffusionModelRegistry = _ModelRegistry(
    {
        model_arch: _LazyRegisteredModel(
            module_name=f"aphrodite.omni.diffusion.models.{mod_folder}.{mod_relname}",
            class_name=cls_name,
        )
...
def _prepare_diffusion_quant_config(
    ...
    """Prepare diffusion quant config using Sonar-style model bindings."""
