...
"""
RIFE 4.22.lite frame interpolation for Sonar Omni video generation.
...
The FrameInterpolator wrapper and Sonar Omni integration code are original work.
"""
...
def _select_torch_device() -> torch.device:
    try:
        ...
        logger.warning("Failed to resolve current Sonar Omni torch device: %s", exc)
