...
class OmniDiffusionRequest:
    ...
    # Opaque native Sonar connector parameters. The Orchestrator and Scheduler
    ...
    # and carried to DiffusionOutput for the aphrodite.omni:diffusion_kv_load_s metric.
