...
from aphrodite.config import CacheConfig, ParallelConfig
from aphrodite.logger import init_logger
from aphrodite.omni.diffusion.data import DiffusionRequestAbortedError
...
from aphrodite.omni.distributed.omni_connectors.utils.serialization import (
    OmniMsgpackDecoder,
    OmniMsgpackEncoder,
)
from aphrodite.omni.distributed.omni_coordinator import OmniCoordClientForStage
...
from aphrodite.omni.metrics.utils import diffusion_exception_metrics
...
from aphrodite.v1.utils import shutdown
...
class StageDiffusionProcManager:
    ...
    Mirrors the small process-lifecycle surface used by Sonar's
