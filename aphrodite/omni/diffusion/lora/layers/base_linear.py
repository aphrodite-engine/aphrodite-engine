...
from aphrodite.lora.layers.base_linear import BaseLinearLayerWithLoRA
...
class DiffusionBaseLinearLayerWithLoRA(BaseLinearLayerWithLoRA):
    ...
    is inherited from Sonar's BaseLinearLayerWithLoRA.
    """
    ...
    def apply(self, x: torch.Tensor, bias: torch.Tensor | None = None) -> torch.Tensor:
        ...
        # In fully-sharded LoRA mode, Sonar uses an all-gather between shrink and
    ...
    def __getattr__(self, name: str):
        ...
        # from linear layers (e.g. QKVParallelLinear.num_heads). Sonar's LoRA
