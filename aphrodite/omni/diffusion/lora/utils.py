...
from aphrodite.omni.diffusion.lora.layers import (
...
def _match_target_modules(module_name: str, target_modules: list[str]) -> bool:
    """from aphrodite/lora/model_manager.py _match_target_modules, helper function"""
    import regex as re
...
def from_layer_diffusion(
    ...
    """
    Diffusion-specific layer replacement. similar to Sonar's `from_layer`
    """
