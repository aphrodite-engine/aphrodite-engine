...
def _npu_apply_rope_table(
    ...
    if find_spec("mindiesd") is not None:
        from aphrodite.omni.diffusion.layers.rope import apply_rotary_emb_mindiesd
...
_OMNI_OP_LIB = Library("aphrodite_omni", "FRAGMENT")
if not hasattr(torch.ops.aphrodite_omni, "fused_qk_norm_rope"):
...
def fused_qk_norm_rope(
    ...
    *,
    ...
    return torch.ops.aphrodite_omni.fused_qk_norm_rope(
        q,
        k,
        q_weight,
        k_weight,
