...
OMNI_DEFAULT_PLUGINS_GROUP = "aphrodite.omni.general_plugins"
# Platform plugins group will be loaded in all processes when
# `aphrodite.omni.platforms.current_omni_platform` is called and the value not
# initialized.
OMNI_PLATFORM_PLUGINS_GROUP = "aphrodite.omni.platform_plugins"
