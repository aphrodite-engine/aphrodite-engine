...
"""Composable parallel strategies for Sonar Omni.
...
translation and apply logic lives alongside them and consumes Sonar Omni's own
config objects.
"""

from aphrodite.omni.config.composable_parallel.aggregation import (
...
from aphrodite.omni.config.composable_parallel.apply import (
    StrategyApplyError,
    StrategyApplyResult,
...
from aphrodite.omni.config.composable_parallel.spec import (
    MESH_AXIS_KINDS,
    KernelSpec,
    LayerHookSpec,
    MeshAxisKind,
...
from aphrodite.omni.config.composable_parallel.translator import (
