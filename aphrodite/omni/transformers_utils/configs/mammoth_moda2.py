...
from aphrodite.omni.tokenizers.mammoth_moda2_tokenizer import MammothUTokenizer
...
class Mammothmoda2Qwen2_5_VLTextConfig(Qwen2_5_VLTextConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # NOTE: Sonar uses `hf_text_config.vocab_size` for sampling parameter validation
...
class Mammothmoda2Config(PretrainedConfig):
    ...
    # ---- Proxy attrs for Sonar multimodal/mrope helpers ----
    # aphrodite/omni/model_executor/layers/mrope.py expects these fields on `hf_config`.
