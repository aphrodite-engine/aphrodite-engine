...
class BailingMoeV2Config(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # This refers to the pattern used for GLM-Image in aphrodite/omni/patch.py
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if isinstance(talker_config, dict):
            self.talker_config: MingFlashOmniTalkerConfig | None = MingFlashOmniTalkerConfig(**talker_config)
        else:
