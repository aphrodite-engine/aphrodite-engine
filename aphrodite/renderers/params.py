...
from aphrodite.inputs import EmbedsPrompt, TextPrompt, TokensPrompt
...
class TokenizeParams:
    ...
    def _get_text_truncation_offset(self, tokenizer: TokenizerLike | None, text: str) -> int:
    ...
    def apply_pre_tokenization(
        ...
        If that is not possible, raise a `APHRODITEValidationError`.
    ...
    def _truncation_slice(self, tokenizer: TokenizerLike | None, length: int) -> slice | None:
