...
class NixlBaseConnectorScheduler:
    ...
    def __init__(
        ...
        self._is_hma_required = (
            ...
            and any(not isinstance(g.kv_cache_spec, FullAttentionSpec) for g in kv_cache_config.transfer_groups)
        )
        self._has_mamba = any(isinstance(g.kv_cache_spec, MambaSpec) for g in kv_cache_config.transfer_groups)
        ...
        self._reqs_need_recv: dict[ReqId, tuple[Request, BlockIds, tuple[int, ...]]] = {}
    ...
    def _nixl_handshake_listener(
        ...
        with zmq_ctx(zmq.ROUTER, path) as sock:
            ...
            while True:
                ...
                sock.send_multipart((identity, b"", encoded_data[(target_pp_rank, target_tp_rank)], ts))
