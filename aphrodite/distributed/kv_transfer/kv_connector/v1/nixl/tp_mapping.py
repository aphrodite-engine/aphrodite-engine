...
from aphrodite.v1.kv_cache_interface import AttentionSpec, KVCacheSpec, MambaSpec
...
def compute_tp_mapping(
    ...
    local_consumers = transfer_topology.dcp_consumer_count(remote_tp_size, remote_dcp_size)
