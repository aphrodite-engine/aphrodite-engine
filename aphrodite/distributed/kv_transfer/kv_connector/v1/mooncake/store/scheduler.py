...
class MooncakeStoreScheduler:
    ...
    def build_connector_meta(self, scheduler_output: SchedulerOutput) -> KVConnectorMetadata:
        ...
        for request in scheduler_output.scheduled_new_reqs:
            ...
            last_chunk_tokens_num = len(prefill_tokens) // self._block_size * self._block_size
        ...
        if not force_skip_save:
            for i, req_id in enumerate(cached_reqs.req_ids):
                ...
                if req_id in cached_reqs.resumed_req_ids:
                    ...
                    last_chunk_tokens_num = prefill_end // self._block_size * self._block_size
                    req_meta = ReqMeta.from_request_tracker(
                        request_tracker,
                        self._block_size,
                        load_spec=None,
    ...
    def request_finished(
        ...
        # before finishing.
        if tracker is None or (tracker.num_saved_tokens <= 0 and not tracker.has_pending_offload):
            return False, None
