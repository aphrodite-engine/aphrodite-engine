...
class MooncakeStoreCoordinator:
    ...
    def __init__(
        ...
        self.enable_partial_hash_hits = partial_hash_hits_enabled(kv_cache_groups, hash_block_size)
...
def partial_hash_hits_enabled(kv_cache_groups: list[KVCacheGroupSpec], hash_block_size: int) -> bool:
