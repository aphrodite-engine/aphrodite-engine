...
class MoRIIOWrapper:
    ...
    def set_backend_type(self, backend_type):
        ...
        qp_per_transfer = envs.APHRODITE_MORIIO_QP_PER_TRANSFER
        post_batch_size = envs.APHRODITE_MORIIO_POST_BATCH_SIZE
        num_worker_threads = envs.APHRODITE_MORIIO_NUM_WORKERS
