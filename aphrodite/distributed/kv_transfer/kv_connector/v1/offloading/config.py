...
if TYPE_CHECKING:
    ...
    from aphrodite.v1.kv_cache_interface import KVCacheConfig, KVCacheTensor
...
def build_offloading_config(
    ...
    if kv_cache_config.num_blocks > 0:
        packed_tensors = tuple(is_kv_cache_tensor_packed(tensor) for tensor in kv_cache_config.kv_cache_tensors)
