    ...
    def register_kv_caches(self, kv_caches: dict[str, torch.Tensor]):
        ...
        for kv_cache_group in kv_cache_config.kv_cache_groups:
            ...
            for layer_name in group_layer_names:
                ...
                block_stride_bytes = (
                    ref.stride(0) * elem_size if isinstance(layer_kv_cache_spec, AttentionSpec) else page
                )
        ...
        packed_layer_name = next(
            (layer_name for layer_name, (tensor,) in tensors_per_block.items() if tensor.stride(0) != tensor.shape[1]),
            None,
        )
