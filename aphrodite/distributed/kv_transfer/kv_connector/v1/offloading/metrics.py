...
from aphrodite.v1.kv_offload.worker.worker import TransferType
...
class OffloadPromMetrics(KVConnectorPromMetrics):
    def __init__(
        ...
        self._counter_kv_bytes = self._counter_cls(
            name="aphrodite:kv_offload_total_bytes",
