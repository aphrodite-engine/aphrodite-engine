...
from .utils import (ENGINE_NAME, apply_mm_hashes_to_token_ids,
                    lmcache_get_config)
...
class ReqMeta:
    ...
    def from_request_tracker(
        ...
        if len(token_ids) > num_blocks * block_size:
            ...
            logger.error(
                "Num tokens: {}, num blocks: {}, block size: {}",
                len(token_ids),
                num_blocks,
                block_size,
            )
        ...
        if load_spec is not None and load_spec.can_load:
            logger.debug(
                "Scheduled to load {} tokens for request {}",
...
class LMCacheConnectorV1Impl:
    def __init__(
        ...
        if role == KVConnectorRole.SCHEDULER:
            ...
            self.lmcache_engine = init_lmcache_engine(
                ...
                aphrodite_config.scheduler_config,
            )
        ...
        **kwargs,
        ...
        if self.current_layer == 0:
            ...
            for idx, request in enumerate(connector_metadata.requests):
                ...
                logger.info(
                    "Storing KV cache for {} out of {} tokens "
                    "(skip_leading_tokens={}) for request {}",
    ...
    def get_num_new_matched_tokens(
        ...
        logger.info(
            "Reqid: {}, Total tokens {}, LMCache hit tokens: {}, need to load: {}",
            request.request_id,
            request.num_tokens,
        ...
        # TODO: Align to Aphrodite block size. Should test whether it can be removed
