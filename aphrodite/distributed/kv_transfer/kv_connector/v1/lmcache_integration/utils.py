...
def create_lmcache_metadata(
    ...
    Args:
        aphrodite_config: Aphrodite configuration object containing model, parallel, and
                    cache configs (alternative to individual config parameters)
        model_config: Model configuration (alternative to aphrodite_config)
        parallel_config: Parallel configuration (alternative to aphrodite_config)
        cache_config: Cache configuration (alternative to aphrodite_config)
    ...
    # Support both aphrodite_config object and individual config parameters
