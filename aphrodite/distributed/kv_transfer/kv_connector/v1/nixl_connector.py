    ...
    def __init__(self, aphrodite_config: AphroditeConfig, role: KVConnectorRole):
        ...
        if role == KVConnectorRole.SCHEDULER:
            self.connector_scheduler: Optional[NixlConnectorScheduler] = \
                NixlConnectorScheduler(aphrodite_config, self.engine_id)
...
class NixlConnectorScheduler:
    ...
    def __init__(self, aphrodite_config: AphroditeConfig, engine_id: str):
        ...
        self.side_channel_port = (
            ...
            aphrodite_config.parallel_config.data_parallel_rank *
    ...
    def get_num_new_matched_tokens(
        ...
        logger.debug(
            ...
            "num_computed_tokens={}, kv_transfer_params={}",
    ...
    def update_state_after_alloc(self, request: "Request",
        ...
        logger.debug(
            ...
            "num_external_tokens={}, kv_transfer_params={}",
        ...
        if self.use_host_buffer and params.get("do_remote_decode"):
            ...
            if params.get("remote_block_ids"):
                if all(p in params for p in ("remote_engine_id", "remote_host",
                    ...
                    logger.warning(
                        "Got invalid KVTransferParams: {}. This "
    ...
    def request_finished(
        ...
        logger.debug(
            ...
            "kv_transfer_params={}", request.status, params)
        if not params:
            return False, None
...
class NixlConnectorWorker:
    ...
    def __init__(self, aphrodite_config: AphroditeConfig, engine_id: str):
        ...
        self.kv_buffer_device: str = \
            aphrodite_config.kv_transfer_config.kv_buffer_device
    ...
    def _nixl_handshake_listener(metadata: NixlAgentMetadata,
        ...
        logger.debug("Size of encoded NixlAgentMetadata: {} bytes",
                     str(size_in_bytes))
        ...
        with zmq_ctx(zmq.ROUTER, path) as sock:
            ...
            while True:
                ...
                if msg != GET_META_MSG:
                    logger.warning(
                        "Connection listener got unexpected message {}", msg)
    ...
    def _nixl_handshake(
        ...
        logger.debug("Querying metadata on path: {} at remote rank {}", path,
                     p_remote_rank)
        ...
        with zmq_ctx(zmq.REQ, path) as sock:
            ...
            logger.debug("NIXL handshake: get metadata took: {}",
            ...
            logger.debug("NIXL handshake: add agent took: {}",
    ...
    def register_kv_caches(self, kv_caches: dict[str, torch.Tensor]):
        ...
        logger.info(
            "Registering KV_Caches. use_mla: {}, kv_buffer_device: {}, "
            "use_host_buffer: {}, num_blocks: {}, block_shape: {}, "
            "per_layer_kv_cache_shape: {}", use_mla, self.kv_buffer_device,
        ...
        if self.aphrodite_config.model_config.hf_config.model_type == "llama4":
            ...
            assert isinstance(self.aphrodite_config.model_config.hf_text_config,
                              Llama4TextConfig)
            ...
            logger.debug("Llama 4 block window per layer mapping: {}",
        ...
        logger.debug("Created {} blocks for src engine {} and rank {}",
    ...
    def add_remote_agent(self,
        ...
        logger.debug(
            "Created {} blocks for dst engine {} with remote rank {} and "
            "local rank {}", len(blocks_data), engine_id, remote_tp_rank,
            self.tp_rank)
    ...
    def get_finished(self) -> tuple[set[str], set[str]]:
        ...
        if len(done_sending) > 0 or len(done_recving) > 0:
            logger.debug(
                "Rank {}, get_finished: {} requests done sending "
                "and {} requests done recving", self.tp_rank,
            ...
            for notif in notifs:
                ...
                if req_id not in self._reqs_to_send:
                    logger.error(
                        ...
                        "unrecognized request {} were retrieved by "
        ...
        for req_id, handles in list(transfers.items()):
            ...
            for handle, _xfer_stime in handles:
                ...
                if xfer_state == "DONE":
                    ...
                    raise RuntimeError("Transfer failed with state {}",
                                       xfer_state)
            if not in_progress:
    ...
    def start_load_kv(self, metadata: NixlConnectorMetadata):
        ...
        for req_id, meta in metadata.reqs_to_recv.items():
            ...
            logger.debug(
                ...
                "Num local_block_ids: {}. Num remote_block_ids: {}. ", req_id,
    ...
    def _read_blocks_for_req(self, req_id: str, meta: ReqMeta):
        logger.debug(
            "Remote agent {} available, calling _read_blocks for req {}",
