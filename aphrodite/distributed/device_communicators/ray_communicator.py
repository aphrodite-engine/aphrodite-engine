...
class RayPPCommunicator(Communicator):
    ...
    This is wraps around the Aphrodite _PP GroupCoordinator.
    ...
    def __init__(
        ...
        if rank is not None:
            ...
            # Since we wrap around the Aphrodite _PP communicator, we use
            # the rank from the Aphrodite communicator, and ignore the rank
            # passed in from Ray.
    ...
    def destroy(self) -> None:
        # Just sets a flag, Aphrodite manages the lifecycle of the underlying
