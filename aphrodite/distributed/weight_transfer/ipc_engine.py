...
class IPCTrainerSendWeightsArgs:
    ...
    """How to send updates to Aphrodite. Either a string ('ray' or 'http') for
...
class IPCWeightTransferEngine(WeightTransferEngine[IPCWeightTransferInitInfo, IPCWeightTransferUpdateInfo]):
    ...
    def __init__(
        ...
        Args:
            ...
            aphrodite_config: The full Aphrodite config
    ...
    def parse_update_info(self, update_dict: dict[str, Any]) -> IPCWeightTransferUpdateInfo:
        ...
        Requires ``APHRODITE_ALLOW_INSECURE_SERIALIZATION=1`` because the
    ...
    def trainer_send_weights(
        ...
        so that each Aphrodite worker can find its own GPU UUID. Only rank 0
        sends the payload to Aphrodite.
