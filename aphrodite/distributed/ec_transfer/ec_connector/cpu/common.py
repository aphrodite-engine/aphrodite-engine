...
def _get_encoder_cache_hidden_dim(aphrodite_config: "AphroditeConfig") -> int:
...
def create_ec_shared_region(aphrodite_config: "AphroditeConfig") -> ECSharedRegion:
    """Build the EC mmap region from `aphrodite_config`.
    ...
    engine_id = f"{aphrodite_config.instance_id}_dp{dp_rank}"

    dtype = aphrodite_config.model_config.dtype
    hidden_dim = _get_encoder_cache_hidden_dim(aphrodite_config)
