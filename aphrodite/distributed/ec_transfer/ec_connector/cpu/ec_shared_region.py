...
Modeled after SharedOffloadRegion (aphrodite/v1/kv_offload/cpu/) but simplified
...
class ECSharedRegion:
    ...
    File path: /dev/shm/aphrodite_ec_{engine_id}.mmap
    ...
    def __init__(
        ...
        self._mmap_path = f"/dev/shm/aphrodite_ec_{engine_id}.mmap"
