...
from aphrodite.distributed.eplb.eplb_communicator import EplbCommunicator
from aphrodite.distributed.eplb.eplb_utils import CpuGpuEvent
...
def rearrange_expert_weights_inplace(
    ...
    if is_profile:
        if communicator.needs_profile_buffer_reservation:
            ...
            weights_buffer: list[torch.Tensor] = [torch.empty_like(w) for w in first_layer_weights]
