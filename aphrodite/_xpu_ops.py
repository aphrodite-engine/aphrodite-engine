...
import torch
from aphrodite_xpu_kernels.flash_attn_interface import flash_attn_varlen_func
...
def _gemma_rms_norm_impl(
    ...
    # multiply are done in-kernel. See aphrodite-xpu-kernels gemma_rms_norm.
...
def _xpu_fp8_bmm_impl(
    ...
    """XPU FP8 batched GEMM implementation for ``torch.ops.aphrodite.xpu_fp8_bmm``.
