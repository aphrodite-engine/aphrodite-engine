...
class InputPreprocessor:
    ...
    async def _tokenize_prompt_async(
        ...
        """
        Async version of
        [`_tokenize_prompt`][aphrodite.inputs.preprocess.InputPreprocessor._tokenize_prompt].
        """
        tokenizer = self.get_tokenizer_group()
        tokenization_kwargs = self._get_tokenization_kw(tokenization_kwargs)
    ...
    async def _process_multimodal_async(
        ...
        """
        Async version of
        [`_process_multimodal`][aphrodite.inputs.preprocess.InputPreprocessor._process_multimodal].
        """
    ...
    async def _prompt_to_llm_inputs_async(
        ...
        """
        Async version of
        [`_prompt_to_llm_inputs`][aphrodite.inputs.preprocess.InputPreprocessor._prompt_to_llm_inputs].
        """
        parsed = parse_singleton_prompt(prompt)
    ...
    async def _process_encoder_decoder_prompt_async(
        ...
        """
        Async version of
        [`_process_encoder_decoder_prompt`][aphrodite.inputs.preprocess.InputPreprocessor._process_encoder_decoder_prompt].
        """
        encoder_inputs: SingletonInputs
        decoder_inputs: Optional[SingletonInputs]
    ...
    async def _process_decoder_only_prompt_async(
        ...
        """
        Async version of
        [`_process_decoder_only_prompt`][aphrodite.inputs.preprocess.InputPreprocessor._process_decoder_only_prompt].
        """
    ...
    def preprocess(
        ...
        if self.model_config.is_encoder_decoder:
            assert not return_mm_hashes, (
                ...
                "returned until they are supported on Aphrodite V1.")
    ...
    async def preprocess_async(
        ...
        """
        Async version of
        [`preprocess`][aphrodite.inputs.preprocess.InputPreprocessor.preprocess].
        """
        if self.model_config.is_encoder_decoder:
            assert not return_mm_hashes, (
                "Multimodal hashes for encoder-decoder models should not be ",
