...
class FusedMoE(CustomOp):
    ...
    def __init__(
        ...
        if quant_config and quant_config.get_name() == "mxfp4":
            from aphrodite.modeling.layers.quantization.mxfp4 import (  # noqa: E501
        ...
        if self.enable_eplb:
            from aphrodite.modeling.layers.quantization.fp8 import Fp8MoEMethod
    ...
    def forward(
        ...
        if self.shared_experts is None:
            if current_platform.is_tpu():
                ...
                fused_output = torch.ops.aphrodite.moe_forward(
