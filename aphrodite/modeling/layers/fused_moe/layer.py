...
from aphrodite.distributed import (get_dp_group,
        ...
        if current_platform.is_cpu():
            if current_platform.get_cpu_architecture() == CpuArchEnum.X86:
                ...
                layer.ipex_fusion = ipex.llm.modules.GatedMLPMOE(
                    layer.w13_weight,
                    layer.w2_weight,
                    use_prepack=envs.APHRODITE_CPU_MOE_PREPACK,
                )
            else:
...
class FusedMoE(torch.nn.Module):
    ...
    def __init__(
        ...
        use_ep = (aphrodite_config.parallel_config.enable_expert_parallel
        ...
        if current_platform.is_hpu():
            from aphrodite_hpu_extension.ops import DynamicFusedMOE
