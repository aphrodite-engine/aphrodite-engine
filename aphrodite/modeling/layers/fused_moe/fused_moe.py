...
def get_moe_configs(
    ...
    logger.warning(
        ("Using default MoE config. Performance might be sub-optimal! "
         "Config file not found at {}"), config_file_paths)
    return None
...
def aphrodite_topk_softmax(topk_weights: torch.Tensor, topk_indices: torch.Tensor,
...
def grouped_topk(
    ...
    if envs.APHRODITE_USE_FUSED_MOE_GROUPED_TOPK and \
...
def fused_experts_impl(
    ...
    # https://github.com/aphrodite-project/aphrodite/issues/5938
