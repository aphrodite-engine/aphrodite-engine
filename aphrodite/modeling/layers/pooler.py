...
from aphrodite.utils import current_stream, resolve_obj_by_qualname
from aphrodite.v1.pool.metadata import PoolingCursor, PoolingMetadata
...
class PoolerClassify(PoolerActivation):
    ...
    def __init__(self, *, static_num_labels: bool = True) -> None:
        ...
        if static_num_labels:
            ...
            self.num_labels = getattr(aphrodite_config.model_config.hf_config,
                                      "num_labels", 0)
...
class EmbeddingPoolerHead(PoolerHead):
    ...
    def __init__(self) -> None:
        ...
        self.projector = _load_st_projector(
            aphrodite_config.model_config) if aphrodite_config else None
