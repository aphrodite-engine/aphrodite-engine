...
def override_envs_for_invariance():
    curr_attn_backend = envs.APHRODITE_ATTENTION_BACKEND
    supported_backends = [
    ...
    if curr_attn_backend not in supported_backends:
        ...
        os.environ["APHRODITE_ATTENTION_BACKEND"] = supported_backends[0]
    if os.environ["APHRODITE_ATTENTION_BACKEND"] != supported_backends[0]:
        warning = (
