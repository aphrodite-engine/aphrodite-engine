...
# TODO: We might need a more flexible structure to handle
...
class LinearBase(CustomOp):
    ...
    Args:
        ...
        prefix: Prefix for paramter names.
...
class MergedReplicatedLinear(ReplicatedLinear):
    ...
    def weight_loader(self,
                      param: Union[Parameter, BaseAphroditeParameter],
...
class MergedColumnParallelLinear(ColumnParallelLinear):
    ...
    def _load_fused_module_from_checkpoint(self, param: BaseAphroditeParameter,
        ...
        for shard_id, shard_offset, shard_size in shard_offsets:
            ...
            # If quantized, we need to adjust the offset and size to account
            # for the packing.
            if isinstance(param, (PackedColumnParameter, PackedAphroditeParameter
