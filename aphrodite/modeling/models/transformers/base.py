...
class Base(nn.Module, AphroditeModel, SupportsQuant, SupportsLoRA, SupportsPP):
    ...
    def __init_subclass__(cls, *args, **kwargs):
        """Merge hf_to_aphrodite_mapper in MRO from most specific to least specific."""
        super().__init_subclass__(*args, **kwargs)
        hf_to_aphrodite_mapper = WeightsMapper()
        for base in cls.__mro__:
            if base_hf_to_aphrodite_mapper := getattr(base, "hf_to_aphrodite_mapper", None):
                hf_to_aphrodite_mapper |= base_hf_to_aphrodite_mapper
        cls.hf_to_aphrodite_mapper = hf_to_aphrodite_mapper
