...
from aphrodite.attention.ops.vit_attn_wrappers import (
    vit_flash_attn_wrapper, vit_xformers_attn_wrapper)
...
from aphrodite.multimodal.evs import (compute_mrope_for_media,
