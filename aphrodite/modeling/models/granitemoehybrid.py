...
class GraniteMoeHybridModel(nn.Module):
    ...
    def load_weights(self, weights: Iterable[tuple[str,
        ...
        for n, p in weights:
            ...
            # Logic analogous to: https://github.com/aphrodite-project/aphrodite/blob/f49e5aff11c986ed4d45202b1716c5d74786efa9/aphrodite/model_executor/models/granitemoeshared.py#L215
...
class GraniteMoeHybridForCausalLM(nn.Module, HasInnerState, SupportsLoRA,
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        self.model = GraniteMoeHybridModel(aphrodite_config=aphrodite_config,
                                           prefix=maybe_prefix(
                                               prefix, "model"))
