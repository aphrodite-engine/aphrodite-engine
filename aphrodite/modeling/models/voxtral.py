...
from .utils import (flatten_bn, init_aphrodite_registered_model, maybe_prefix,
        ...
        **kwargs,
        ...
        if any(len(t) > 0 for t in text):
            raise ValueError(
                ...
                "For more info, see: "
                "https://github.com/aphrodite-project/aphrodite/issues/8411.")
...
class VoxtralEncoderModel(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.whisper_encoder = WhisperEncoder(aphrodite_config=aphrodite_config,
                                              prefix=maybe_prefix(
