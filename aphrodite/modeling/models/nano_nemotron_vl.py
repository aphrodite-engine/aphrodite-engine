# --------------------------------------------------------
# Adapted from
# https://github.com/vllm-project/vllm/blob/main/aphrodite/modeling/models/internvl.py
...
class NemotronH_Nano_VL_V2(
    ...
    def get_mamba_state_shape_from_config(cls, aphrodite_config: "AphroditeConfig"):
        ...
        temp_aphrodite_config = copy.deepcopy(aphrodite_config)
        temp_aphrodite_config.model_config.hf_config = text_config
