...
from .interfaces_base import AphroditeModel, is_pooling_model
...
class SupportsMultiModal(Protocol):
    ...
    `aphrodite.multimodal.utils.group_mm_kwargs_by_modality` to use.
    """
...
class SupportsPP(Protocol):
    ...
    def forward(
        ...
        *,
        ...
        """
        Accept [`IntermediateTensors`][aphrodite.common.sequence.IntermediateTensors] when
        PP rank > 0.

        Return [`IntermediateTensors`][aphrodite.common.sequence.IntermediateTensors] only
