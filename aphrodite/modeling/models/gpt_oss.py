...
class OAIAttention(nn.Module):
    ...
    def __init__(
        ...
        attention_sink_dtype = (
            torch.float32 if envs.APHRODITE_USE_TRTLLM_CONTEXT_ATTENTION
            or envs.APHRODITE_USE_TRTLLM_DECODE_ATTENTION else torch.bfloat16)
...
class GptOssForCausalLM(nn.Module):
    ...
    def __init__(
        ...
        self.model_config = aphrodite_config.model_config.hf_config
    ...
    def load_weights(self, weights: Iterable[tuple[str,
        ...
        use_ep = self.aphrodite_config.parallel_config.enable_expert_parallel
