...
from aphrodite.modeling.layers.mamba.linear_attn import (
...
class MiniMaxText01Model(nn.Module):
    ...
    def forward(self,
        ...
        if not envs.APHRODITE_USE_V1 and attn_metadata is None:
            return None
        if not envs.APHRODITE_USE_V1:
        ...
        for layer in islice(self.layers, self.start_layer, self.end_layer):
            _caches = None
            if not envs.APHRODITE_USE_V1 and isinstance(
...
class MiniMaxText01ForCausalLM(nn.Module, HasInnerState, IsHybrid):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = "") -> None:
        ...
        self.model = MiniMaxText01Model(aphrodite_config=aphrodite_config,
