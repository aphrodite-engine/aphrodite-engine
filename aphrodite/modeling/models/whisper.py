...
class WhisperEncoder(nn.Module):
    ...
    def __init__(self,
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda prefix: WhisperEncoderLayer(aphrodite_config=aphrodite_config,
...
class WhisperDecoder(nn.Module):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda prefix: WhisperDecoderLayer(aphrodite_config=aphrodite_config,
                                               prefix=f"{prefix}.layers"),
            prefix=f"{prefix}.layers",
        )
        self.layer_norm = nn.LayerNorm(config.d_model)
...
class WhisperModel(nn.Module):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        super().__init__()
        self.encoder = WhisperEncoder(aphrodite_config=aphrodite_config,
                                      prefix=f"{prefix}.encoder")
        self.decoder = WhisperDecoder(aphrodite_config=aphrodite_config,
...
class WhisperProcessingInfo(BaseProcessingInfo):
    ...
    def get_hf_processor(self, **kwargs: object) -> WhisperProcessor:
        ...
        # See: https://github.com/aphrodite-project/aphrodite/issues/20224
...
class WhisperForConditionalGeneration(nn.Module, SupportsTranscription,
    ...
    hf_to_aphrodite_mapper = WeightsMapper(orig_to_new_substr={
        ".fc1.": ".mlp.fc1.",
        ".fc2.": ".mlp.fc2."
    })
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        self.model = WhisperModel(aphrodite_config=aphrodite_config, prefix=prefix)
