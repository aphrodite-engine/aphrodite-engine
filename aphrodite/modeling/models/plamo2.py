...
class Plamo2DecoderLayer(nn.Module):
    ...
    def __init__(self,
        ...
        max_model_len = aphrodite_config.scheduler_config.max_model_len
...
class Plamo2Decoder(torch.nn.Module):
    ...
    def __init__(self, aphrodite_config: AphroditeConfig, prefix: str = "") -> None:
        super().__init__()
        num_hidden_layers = aphrodite_config.model_config.hf_config.num_hidden_layers

        self.layers = nn.ModuleList([
            Plamo2DecoderLayer(aphrodite_config=aphrodite_config,
                               layer_idx=i,
