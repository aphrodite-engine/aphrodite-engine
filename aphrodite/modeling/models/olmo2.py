...
class Olmo2DecoderLayer(nn.Module):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        assert isinstance(config, Olmo2Config)
        # Attention block.
        self.self_attn = Olmo2Attention(aphrodite_config=aphrodite_config,
...
class Olmo2Model(nn.Module):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda prefix: Olmo2DecoderLayer(aphrodite_config=aphrodite_config,
                                             prefix=prefix),
...
class Olmo2ForCausalLM(nn.Module, SupportsPP, SupportsLoRA):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        assert isinstance(config, Olmo2Config)
        self.config = config
        self.model = Olmo2Model(aphrodite_config=aphrodite_config,
