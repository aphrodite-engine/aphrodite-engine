    ...
    def _attention_with_mask(
        ...
        if len(kv_cache.shape) > 1:
            ...
            if self.attn.backend in (_Backend.FLASH_ATTN,
                                     _Backend.FLASH_ATTN_APHRODITE_V1):
                ...
                raise ValueError(
                    ...
                    "FLASH_ATTN, FLASH_ATTN_APHRODITE_V1, "
...
class MllamaTextModel(nn.Module):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        config = aphrodite_config.model_config.hf_config.text_config
...
class MllamaForCausalLM(nn.Module):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        self.vocab_size = config.vocab_size
        self.model = MllamaTextModel(aphrodite_config=aphrodite_config,
...
class MllamaForConditionalGeneration(nn.Module, SupportsMultiModal,
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        super().__init__()
        config: MllamaConfig = aphrodite_config.model_config.hf_config
        quant_config = aphrodite_config.quant_config
        self.config = config
        self.quant_config = quant_config
