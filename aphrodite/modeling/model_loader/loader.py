...
def _process_weights_after_loading(model: nn.Module, model_config: ModelConfig,
    ...
    for _, module in model.named_modules():
        if isinstance(module, QKVCrossParallelLinear):
            # NOTE: special case for cross QKV layer because
...
class BaseModelLoader(ABC):
    ...
    @abstractmethod
    def load_model(self, *, aphrodite_config: AphroditeConfig) -> nn.Module:
...
class TensorizerLoader(BaseModelLoader):
    ...
    def _load_model_serialized_cpu(
        ...
        examples/other/tensorize_aphrodite_model.py) This should still
...
class BitsAndBytesModelLoader(BaseModelLoader):
    ...
    def __init__(self, load_config: LoadConfig):
        ...
        # mapping weight names from transformers to aphrodite.
