...
class TensorizerConfig(MutableMapping):
    ...
    aphrodite_tensorized: Optional[bool] = None
...
def init_tensorizer_model(tensorizer_config: TensorizerConfig,
                          aphrodite_config: AphroditeConfig) -> nn.Module:
    ...
    with meta_tensor_mode(), set_current_aphrodite_config(aphrodite_config,
                                                     check_compile=True):
...
def deserialize_tensorizer_model(model: nn.Module,
    ...
    del model.aphrodite_tensorized_marker
...
def tensorize_aphrodite_model(engine_args: "EngineArgs",
    ...
    from aphrodite import LLMEngine
    from aphrodite.v1.engine.llm_engine import LLMEngine as V1LLMEngine
    ...
    if not envs.APHRODITE_USE_V1:
        ...
        engine = V1LLMEngine.from_aphrodite_config(engine_config)
