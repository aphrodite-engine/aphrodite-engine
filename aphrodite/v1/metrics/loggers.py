...
class PrometheusStatLogger(StatLoggerBase):
    ...
    def __init__(self,
        ...
        self.spec_decoding_prom = self._spec_decoding_cls(
            aphrodite_config.speculative_config, labelnames,
            spec_decode_labelvalues)
        ...
        # GPU cache
        #
        # Deprecated - Renamed as aphrodite:kv_cache_usage_perc
        ...
        # Deprecated - Renamed as aphrodite:prefix_cache_queries
        # TODO: in 0.10, only enable if show_hidden_metrics=True
        ...
        # Deprecated - Renamed as aphrodite:prefix_cache_hits
        # TODO: in 0.10, only enable if show_hidden_metrics=True
...
class StatLoggerManager:
    ...
    def __init__(
        ...
        for engine_idx in self.engine_idxs:
            ...
            for logger_factory in factories:
                ...
                if (isinstance(logger_factory, type)
                    ...
                    continue
                loggers.append(logger_factory(aphrodite_config,
        ...
        self.prometheus_logger = prometheus_factory(aphrodite_config, engine_idxs)
    ...
    def record(
        ...
        for loggers in per_engine_loggers:
            loggers.record(scheduler_stats, iteration_stats, engine_idx)
    ...
    def log_engine_initialized(self):
        ...
        for per_engine_loggers in self.per_engine_logger_dict.values():
            for loggers in per_engine_loggers:
                loggers.log_engine_initialized()
