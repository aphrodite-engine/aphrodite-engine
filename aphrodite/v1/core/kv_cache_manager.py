...
from aphrodite.v1.core.kv_cache_utils import (BlockHashType, KVCacheBlock,
                                              hash_request_tokens)
from aphrodite.v1.core.specialized_manager import get_specialized_manager
...
class KVCacheManager:
    ...
    def get_computed_blocks(
        ...
        # NOTE: Since incomplete blocks are not eligible for
    ...
    def get_num_common_prefix_blocks(
        ...
        NOTE: The number of requests in the RUNNING state is **greater
