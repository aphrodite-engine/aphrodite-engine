...
class EncoderCacheManager:
    """Manages caching of encoder outputs for multimodal models in Aphrodite V1.
    ...
    @classmethod
    def create_manager(cls, *, cache_size: int, aphrodite_config: "AphroditeConfig") -> "EncoderCacheManager":
