...
class Scheduler(SchedulerInterface):
    ...
    def __init__(
        ...
        # NOTE: Here, "encoder" includes the vision encoder (and
    ...
    def schedule(self) -> SchedulerOutput:
        ...
        while req_index < len(self.running) and token_budget > 0:
            ...
            if num_new_tokens == 0:
                ...
                # NOTE: Here, by doing `continue` instead of `break`,
    ...
    def _try_schedule_encoder_inputs(
        ...
        for i, pos_info in enumerate(mm_positions):
            ...
            if (not self.encoder_cache_manager.can_allocate(request, i)
                ...
                # NOTE: We assume that the encoder input tokens should
    ...
    def update_from_output(
        ...
        # NOTE: As len(self.running) can be up to 1K or more, the below
        ...
        for req_data in scheduler_output.scheduled_cached_reqs:
            # NOTE: since we free stopped reqs above, adding stopped reqs
