...
from aphrodite.v1.serial_utils import UtilityResult, run_method
...
class EngineCoreSentinel:
    ...
    def retry(self, ft_request: FaultToleranceRequest) -> FaultToleranceResult:
        ...
        with set_current_aphrodite_config(engine.aphrodite_config):
    ...
    def _reinit_dp_group(self) -> dict:
        ...
        parallel_config = engine.aphrodite_config.parallel_config
