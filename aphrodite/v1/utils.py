...
def report_usage_stats(
    ...
    usage_message.report_usage(
        get_architecture_class_name(aphrodite_config.model_config),
        usage_context,
        extra_kvs={
            # Common configuration
            "dtype": str(aphrodite_config.model_config.dtype),
            ...
            # Quantization
            "quantization": aphrodite_config.model_config.quantization,
