...
from aphrodite.utils.ompmultiprocessing import OMPProcessManager
...
class MultiprocExecutor(Executor):
    ...
    def __init__(self, aphrodite_config: AphroditeConfig, monitor_workers: bool = True):
    ...
    def get_response_mqs(self, unique_reply_rank: int = -1) -> list[MessageQueue]:
        ...
        ranks = [unique_reply_rank] if unique_reply_rank != -1 else range(self.world_size)
    ...
    def execute_model(  # type: ignore[override]
        ...
        return self.collective_rpc(
            ...
            non_block=non_block,
            timeout=envs.APHRODITE_EXECUTE_MODEL_TIMEOUT_SECONDS,
    ...
    def _ensure_worker_termination(worker_procs: list[BaseProcess]):
        ...
        if wait_for_termination(active_procs(), timeout=envs.APHRODITE_WORKER_SHUTDOWN_TIMEOUT_SECONDS):
...
class WorkerProc:
    ...
    def __init__(
        ...
        self._init_message_queues(input_shm_handle, aphrodite_config)
    ...
    def worker_main(*args, **kwargs):
        ...
        assigned_physical_gpu_ids = kwargs["aphrodite_config"].parallel_config.assigned_physical_gpu_ids
        ...
        try:
            ...
            if kwargs["aphrodite_config"].parallel_config.numa_bind:
            ...
            if ready_writer is not None:
                ...
                logger.debug_once("[shutdown] WorkerProc: exiting after shutdown request")
            else:
            ...
            if shutdown_requested.is_set():
                logger.debug_once("[shutdown] WorkerProc: terminated by shutdown signal")
            else:
...
def set_multiprocessing_worker_envs(local_world_size: int = 1):
    ...
    os.environ[OMP_NUM_THREADS_SET_BY_APHRODITE] = "1"
