...
class CPUOffloadingSpec(OffloadingSpec):
    ...
    def __init__(self, config: OffloadingConfig):
        ...
        self.replicated_layout = config.replicated_layout and self.SUPPORTS_REPLICATED_LAYOUT
        ...
        self.cache_policy_module_path: str | None = self.extra_config.get("cache_policy_module_path")
