...
class CPUOffloadingManager(OffloadingManager):
    ...
    def __init__(
        ...
        policy_cls = CachePolicyFactory.get_cache_policy_cls(cache_policy, cache_policy_module_path)
    ...
    def get_stats(self) -> OffloadingConnectorStats | None:
        ...
        write_usage = self._num_write_pending_blocks / self._num_blocks if self._num_blocks > 0 else 0.0
        ...
        for allocation_size in self.allocation_sizes_in_current_batch:
            stats.observe_histogram(CPUOffloadingMetrics.CPU_ALLOCATION_SIZE, allocation_size)
