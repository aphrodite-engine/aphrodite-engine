...
class _SecondaryTierFacingParent(ParentManager):
    """ParentManager wrapper that excludes the originating secondary tier."""
    ...
    def create_store_job(self, keys: Collection[OffloadKey], req_context: ReqContext) -> JobMetadata:
...
class TieringOffloadingManager(OffloadingManager):
    ...
    def __init__(
        ...
        self._tier_parents: dict[SecondaryTierManager, _SecondaryTierFacingParent] = {
            tier: _SecondaryTierFacingParent(self, tier) for tier in self.secondary_tiers
        }
        ...
        *,
        ...
        for tier in self.secondary_tiers:
            ...
            if result is LookupResult.HIT:
                ...
                if req_state is not None and promoted and req_state.secondary_lookup_start_time is None:
