...
class TierMatcher(NamedTuple):
    ...
    def matches(self, medium: Medium | None, locality: Locality | None) -> bool:
        ...
        locality_matches = self.locality is None or locality is None or self.locality == locality
...
class OffloadingKVEventsConfig:
    # Global Aphrodite KV event publishing flag. When false, connector-specific
