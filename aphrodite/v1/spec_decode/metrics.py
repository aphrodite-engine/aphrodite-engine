...
class SpecDecodingProm:
    ...
    The acceptance rate can be calculated using a PromQL query:
      ...
      rate(aphrodite:spec_decode_num_accepted_tokens_total[$interval]) /
      rate(aphrodite:spec_decode_num_draft_tokens_total[$interval])

    The mean acceptance length can be calculated using:

      rate(aphrodite:spec_decode_num_accepted_tokens_total[$interval]) /
      rate(aphrodite:spec_decode_num_drafts[$interval])

    A per-position acceptance rate vector can be computed using

      aphrodite:spec_decode_num_accepted_tokens_per_pos[$interval] /
      aphrodite:spec_decode_num_drafts[$interval]
    """
    ...
    def __init__(self, speculative_config: Optional[SpeculativeConfig],
        ...
        self.counter_spec_decode_num_drafts = \
            prometheus_client.Counter(
                name="aphrodite:spec_decode_num_drafts_total",
