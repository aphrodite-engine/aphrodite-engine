...
class EagleProposer:
    ...
    def __init__(
        ...
        self.is_multimodal_model = aphrodite_config.model_config \
            .is_multimodal_model

        self.use_cuda_graph = (self.aphrodite_config.compilation_config.level
                               == CompilationLevel.PIECEWISE and
                               not self.aphrodite_config.model_config.enforce_eager)
    ...
    def load_model(self, target_model: nn.Module) -> None:
        ...
        target_attn_layer_names = set(
            get_layers_from_aphrodite_config(self.aphrodite_config, Attention).keys())
        ...
        if self.aphrodite_config.speculative_config.method != "eagle3" and \
