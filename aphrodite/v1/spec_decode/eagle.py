...
from aphrodite.modeling.models.deepseek_v2 import DeepseekV32IndexerCache
    ...
    def load_model(self, target_model: nn.Module) -> None:
        ...
        if self.indexer_layer_names:
            ...
            self.draft_indexer_metadata_builder = (
                ...
                .get_attn_backend()
                .get_builder_cls()(
                    indexer_layers[first_layer].get_kv_cache_spec(self.aphrodite_config),
        ...
        if self.aphrodite_config.speculative_config.method != "eagle3":
...
# Refer to https://github.com/aphrodite-project/aphrodite/pull/16899 for the details.
