...
if TYPE_CHECKING:
    ...
    from aphrodite.v1.outputs import AsyncModelRunnerOutput, ModelRunnerOutput
else:
...
class WorkerBase:
    ...
    def __init__(
        ...
        aphrodite.ir.set_default_torch_wrap(aphrodite_config.compilation_config.ir_enable_torch_wrap)
