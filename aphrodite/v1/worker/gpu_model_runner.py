...
from aphrodite.config import (AphroditeConfig, CompilationLevel, CUDAGraphMode,
...
from aphrodite.forward_context import (BatchDescriptor, DPMetadata,
                                       set_forward_context)
...
class GPUModelRunner(LoRAModelRunnerMixin, KVConnectorModelRunnerMixin):
    ...
    def __init__(
        ...
        self.input_batch = InputBatch(
            ...
            logitsprocs=build_logitsprocs(
                self.aphrodite_config, self.device, self.pin_memory,
                self.is_pooling_model,
                self.aphrodite_config.model_config.logits_processors),
    ...
    def get_supported_pooling_tasks(self) -> list[PoolingTask]:
        ...
        if (self.scheduler_config.chunked_prefill_enabled
            ...
            log_once("DEBUG", "Chunked prefill is not supported with "
    ...
    def execute_model(
        ...
        if (self.compilation_config.cudagraph_mode != CUDAGraphMode.NONE
                and not envs.APHRODITE_DISABLE_PAD_FOR_CUDAGRAPH
    ...
    def maybe_randomize_inputs(self, input_ids: torch.Tensor):
        ...
        if not randomize_inputs:
            ...
            log_once("DEBUG", "Randomizing dummy data for DP Rank")
            ...
            if self.model_config.multimodal_config.skip_mm_profiling:
                ...
                if (encoder_budget := mm_budget.get_encoder_budget()) > 0:
                    ...
                    logger.info(
                        ...
                        "{} tokens, and profiled with {} {} items of the "
        ...
        if block_sizes != [self.cache_config.block_size]:
            ...
            self.input_batch = InputBatch(
                ...
                num_speculative_tokens=(
                    ...
                    if self.aphrodite_config.speculative_config else 0),
            )
    ...
    def initialize_kv_cache_tensors(
        ...
        for layer_name, target_layer_name in self.shared_kv_cache_layers.items(
            ...
            logger.debug("{} reuses KV cache of {}", layer_name,
                         target_layer_name)
    ...
    def get_kv_cache_spec(self) -> dict[str, KVCacheSpec]:
        ...
        if len(mamba_layers) > 0:
            if (self.aphrodite_config.speculative_config is not None
                    and self.aphrodite_config.model_config.hf_config.model_type
                    not in ["qwen3_next"]):
                raise NotImplementedError(
