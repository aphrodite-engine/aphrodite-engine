...
from aphrodite.v1.spec_decode.utils import is_spec_decode_supported
from aphrodite.v1.utils import bind_kv_cache
...
class GPUModelRunner(LoRAModelRunnerMixin):
    ...
    def __init__(
        ...
        # NOTE: sliding_window is None for models with interleaved
        ...
        if self.speculative_config:
            ...
            if get_pp_group().is_last_rank:
                if self.speculative_config.method == "ngram":
                    ...
                    self.drafter = EagleProposer(self.aphrodite_config,
        ...
        self.use_cuda_graph = (self.aphrodite_config.compilation_config.level
                               == CompilationLevel.PIECEWISE
                               and not self.model_config.enforce_eager)
        # TODO: Provide an option to tune the max cudagraph batch size.
        ...
        self.arange_np = np.arange(max(self.max_num_reqs + 1,
                                       ...
                                       self.max_num_tokens),
                                   dtype=np.int64)
        # NOTE: These tensors are "stateless", i.e., they are literally
    ...
    def _update_states(self, scheduler_output: "SchedulerOutput") -> None:
        ...
        # NOTE: There could be an edge case where finished_req_ids and
        ...
        # NOTE: The unscheduled requests are either preempted requests
        ...
        # NOTE: The persistent batch optimization assumes that
        ...
        for req_data in scheduler_output.scheduled_cached_reqs:
            ...
            # NOTE: `num_tokens` here may include spec decode tokens.
    ...
    def _prepare_inputs(
        ...
        # NOTE: We use torch.index_select instead of np.take here
        ...
        # NOTE: We can't simply use `token_indices // block_size` here
        ...
        if not use_spec_decode:
            # NOTE: Due to chunked prefills, the batch may contain
    ...
    def _compute_cascade_attn_prefix_len(
        ...
        NOTE: The common prefix length returned by this function
        ...
        # NOTE: Cascade attention uses two attention kernels: one
    ...
    def execute_model(
        ...
        if self.is_multimodal_model:
            # NOTE: To unify token ids and soft tokens (vision
        ...
        # TODO: The following loop can be slow since it iterates over
    ...
    def _dummy_sampler_run(
        ...
        if self.use_spec_decode:
            ...
            target_logits = torch.randn(num_tokens,
                                        ...
                                        device=self.device,
                                        dtype=logits.dtype)
            # NOTE: Here, we should use int32 because the sampler uses
