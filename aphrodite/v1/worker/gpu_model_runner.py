...
from aphrodite.forward_context import DPMetadata, set_forward_context
from aphrodite.modeling.layers.mamba.mamba_mixer2 import MambaBase
...
from aphrodite.modeling.models.interfaces import (is_mixture_of_experts,
...
from aphrodite.multimodal.inputs import (BatchedTensorInputs, MultiModalKwargs,
                                         PlaceholderRange)
from aphrodite.multimodal.utils import group_mm_inputs_by_modality
from aphrodite.tasks import GenerationTask, PoolingTask, SupportedTask
from aphrodite.utils import (STR_DTYPE_TO_TORCH_DTYPE, DeviceMemoryProfiler,
                             GiB_bytes, LazyLoader, check_use_alibi,
                             get_dtype_size, is_pin_memory_available, round_up,
                             supports_dynamo)
from aphrodite.v1.attention.backends.mamba_selectors import (
...
from aphrodite.v1.kv_cache_interface import (AttentionSpec,
                                             ...
                                             SlidingWindowSpec)
from aphrodite.v1.outputs import (EMPTY_MODEL_RUNNER_OUTPUT, LogprobsTensors,
                                  ModelRunnerOutput)
...
class GPUModelRunner(LoRAModelRunnerMixin, KVConnectorModelRunnerMixin):
    ...
    def __init__(
        ...
        if self.speculative_config and get_pp_group().is_last_rank:
            if self.speculative_config.method == "ngram":
                ...
                self.drafter = EagleProposer(self.aphrodite_config, self.device,
                                             self)  # type: ignore
        ...
        self.use_cuda_graph = (
            self.aphrodite_config.compilation_config.level
            == CompilationLevel.PIECEWISE
            and self.aphrodite_config.compilation_config.use_cudagraph
    ...
    def _prepare_inputs(
        ...
        if self.is_encoder_only_model:
            ...
            attention_layers = get_layers_from_aphrodite_config(
        ...
        for kv_cache_group_id, kv_cache_group_spec in enumerate(
            ...
            # https://github.com/aphrodite-project/aphrodite/pull/21588
    ...
    def get_dp_padding(self,
        ...
        if dp_size == 1 or self.aphrodite_config.model_config.enforce_eager:
            # Early exit.
            return 0, None
    ...
    def load_model(self, eep_scale_up: bool = False) -> None:
        ...
        if is_mixture_of_experts(
            ...
            logger.info("EPLB is enabled for model {}.",
        ...
        if (
            ...
            backend = self.aphrodite_config.compilation_config.init_backend(
                self.aphrodite_config)
        ...
        if self.is_multimodal_model:
            ...
            if (encoder_budget := mm_budget.get_encoder_budget()) > 0:
                ...
                logger.info(
                    ...
                    "{} tokens, and profiled with {} {} items of the maximum "
                    "feature size.",
                    encoder_budget,
                    max_mm_items_per_batch,
                    dummy_modality,
    ...
    def capture_model(self) -> None:
        if not self.use_cuda_graph:
            logger.warning(
                ...
                "set -O {} and ensure `use_cudagraph` was not manually set to "
    ...
    def initialize_kv_cache_tensors(
        ...
        if self.shared_kv_cache_layers:
            ...
            attn_layers = get_layers_from_aphrodite_config(self.aphrodite_config,
                                                      Attention)
    ...
    def get_kv_cache_spec(self) -> dict[str, KVCacheSpec]:
        ...
        mamba_layers = get_layers_from_aphrodite_config(self.aphrodite_config, MambaBase)
        if len(mamba_layers) > 0:
            ...
            page_size_padded = (
                self.aphrodite_config.cache_config.mamba_page_size_padded)
