...
from aphrodite.v1.core.encoder_cache_manager import compute_mm_encoder_budget
from aphrodite.v1.kv_cache_interface import KVCacheGroupSpec, KVCacheSpec
...
def sanity_check_mm_encoder_outputs(
    ...
    [`aphrodite.modeling.models.SupportsMultiModal.get_multimodal_embeddings`][].
    """
...
def scatter_mm_placeholders(
    ...
    [`aphrodite.multimodal.processing.PromptUpdateDetails.is_embed`][].
...
def gather_mm_placeholders(
    ...
    [aphrodite.v1.worker.utils.scatter_mm_placeholders].
    """
    if is_embed is None:
        return placeholders
...
def is_residual_scattered_for_sp(aphrodite_config: AphroditeConfig, num_input_tokens: int) -> bool:
    ...
    """
    if not aphrodite_config.compilation_config.pass_config.enable_sequence_parallelism:
        return False
    ...
    return num_input_tokens in aphrodite_config.compilation_config.compile_sizes
