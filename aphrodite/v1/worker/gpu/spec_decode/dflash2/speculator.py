...
from aphrodite.v1.worker.gpu.sample.gumbel import gumbel_noised_argmax
...
def _cache_draft_logits_kernel(
    ...
    logits_base = draft_logits_ptr + req_state * draft_logits_stride_0 + step * draft_logits_stride_1
...
class DFlash2Speculator(DFlashSpeculator):
    ...
    def __init__(self, aphrodite_config: AphroditeConfig, device: torch.device):
        ...
        self._cached_candidate_ids = torch.zeros(self._selector_scores.shape, dtype=torch.int64, device=device)
