...
from aphrodite.lora.worker_manager import WorkerLoRAManager
...
def set_active_mm_loras(
    ...
    if mm_mapping is None or not mm_mapping.connector or not all(count is not None for count in connector_token_counts):
        return
