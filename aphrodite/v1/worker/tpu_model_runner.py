...
class TPUModelRunner(LoRAModelRunnerMixin, KVConnectorModelRunnerMixin):
    ...
    def get_kv_cache_spec(self) -> dict[str, KVCacheSpec]:
        ...
        layers = get_layers_from_aphrodite_config(self.aphrodite_config, AttentionLayerBase)
        block_size = self.aphrodite_config.cache_config.block_size
        cache_dtype_str = self.aphrodite_config.cache_config.cache_dtype
    ...
    def load_model(self) -> None:
        ...
        if self.lora_config is not None:
            model = self.load_lora_model(model, self.aphrodite_config, self.device)
