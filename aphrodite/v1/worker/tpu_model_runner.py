...
class TPUModelRunner:
    ...
    def __init__(
        ...
        self.device = device
        self.check_recompilation = envs.APHRODITE_XLA_CHECK_RECOMPILATION
        ...
        self.num_tokens_paddings = _get_token_paddings(
            ...
            padding_gap=envs.APHRODITE_TPU_BUCKET_PADDING_GAP)
    ...
    def _prepare_inputs(self, scheduler_output: "SchedulerOutput"):
        ...
        # NOTE: Due to chunked prefills, there can be at most 1 partial
    ...
    def _dummy_run(self, num_tokens: int) -> None:
        ...
        with set_forward_context(attn_metadata, self.aphrodite_config, 0):
