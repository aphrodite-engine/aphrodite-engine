...
from aphrodite.utils import (LayerBlockType, cdiv, is_pin_memory_available,
                             prev_power_of_2)
...
class TPUModelRunner(LoRAModelRunnerMixin, KVConnectorModelRunnerMixin):
    ...
    def _prepare_inputs(self, scheduler_output: "SchedulerOutput",
        ...
        layer_names = get_layers_from_aphrodite_config(self.aphrodite_config,
                                                  Attention).keys()
    ...
    def update_config(self, overrides: dict[str, Any]) -> None:
        ...
        # https://github.com/aphrodite-project/aphrodite/pull/20095#discussion_r2201497754
    ...
    def _dummy_run(self, num_tokens: int, num_reqs: int,
        ...
        with self.maybe_select_dummy_loras(
                ...
                np.array([num_tokens], dtype=np.int32)), set_forward_context(
                    per_layer_attn_metadata, self.aphrodite_config, 0):
