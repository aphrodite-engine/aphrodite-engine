...
from aphrodite.v1.worker.xpu_model_runner import XPUModelRunner, XPUModelRunnerV2
...
class XPUWorker(Worker):
    ...
    def init_device(self):
        ...
        if (
            ...
            and (parallel_config.data_parallel_external_lb or parallel_config.nnodes_within_dp == 1)
        ):
        ...
        if self.parallel_config.world_size > 1 and torch.distributed.is_xccl_available():
    ...
    def shutdown(self) -> None:
        ...
        super().shutdown()
        from aphrodite.device_allocator.xpumem import XpuMemAllocator
