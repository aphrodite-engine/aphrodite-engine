...
def get_block_table_width(
    ...
    *,
    ...
    if block_size % kernel_block_size != 0:
        raise ValueError(f"kernel_block_size {kernel_block_size} must divide block_size {block_size} evenly")
...
class MultiGroupBlockTable:
    ...
    def __init__(
        ...
        max_num_blocks = [
            ...
            for n, block_size, slot_mapping_mode in zip(max_num_blocks, block_sizes, slot_mapping_modes)
        ]
        ...
        self.block_tables = [
            ...
            for (
                ...
                max_num_blocks_per_req,
                slot_mapping_mode,
            ) in zip(block_sizes, kernel_block_sizes, max_num_blocks, slot_mapping_modes)
        ]
...
class ComputeSlotMappingKernel(AphroditeTritonJitKernel["ComputeSlotMappingKernel.CompileKey"]):
