...
class Worker(WorkerBase):
    ...
    def __init__(
        ...
        if envs.APHRODITE_TORCH_PROFILER_DIR:
            ...
            worker_name = f"{aphrodite_config.instance_id}-rank-{self.rank}"
            logger.info(
            ...
            logger.debug(
                ...
                envs.APHRODITE_TORCH_PROFILER_WITH_FLOPS,
            )
            self.profiler = torch.profiler.profile(
                ...
                record_shapes=envs.APHRODITE_TORCH_PROFILER_RECORD_SHAPES,
                profile_memory=envs.APHRODITE_TORCH_PROFILER_WITH_PROFILE_MEMORY,
                with_stack=envs.APHRODITE_TORCH_PROFILER_WITH_STACK,
                with_flops=envs.APHRODITE_TORCH_PROFILER_WITH_FLOPS,
    ...
    def load_model(self) -> None:
        eep_scale_up = os.environ.get("APHRODITE_ELASTIC_EP_SCALE_UP_LAUNCH") == "1"
...
def init_worker_distributed_environment(
    ...
    from aphrodite.modeling.layers.batch_invariant import init_batch_invariance
