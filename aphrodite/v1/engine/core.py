...
from aphrodite.multimodal.cache import receiver_cache_from_config
from aphrodite.tasks import POOLING_TASKS, SupportedTask
from aphrodite.transformers_utils.config import (
    maybe_register_config_serialize_by_value)
from aphrodite.utils import (decorate_logs, get_hash_fn_by_name,
                             make_zmq_socket, resolve_obj_by_qualname,
                             set_process_title)
from aphrodite.v1.core.kv_cache_utils import (BlockHash, get_kv_cache_config,
...
from aphrodite.v1.engine import (EngineCoreOutputs, EngineCoreRequest,
                                 ...
                                 UtilityResult)
from aphrodite.v1.engine.utils import (EngineHandshakeMetadata,
                                       EngineZmqAddresses, get_device_indices)
...
class EngineCore:
    ...
    def execute_model_with_error_logging(
        ...
        try:
            ...
            dump_engine_exception(self.aphrodite_config, scheduler_output,
...
class EngineCoreProc(EngineCore):
    ...
    def __init__(
        ...
        with self._perform_handshakes(handshake_address, identity,
            ...
            logger.debug("Has DP Coordinator: {}, stats publish address: {}",
...
class DPEngineCoreProc(EngineCoreProc):
    ...
    def __init__(
        ...
        super().__init__(aphrodite_config, local_client, handshake_address,
    ...
    def _init_data_parallel(self, aphrodite_config: AphroditeConfig):
        ...
        if aphrodite_config.kv_transfer_config is not None:
            ...
            logger.debug("Setting kv_transfer_config.engine_id to {}",
                         aphrodite_config.kv_transfer_config.engine_id)
    ...
    def reinitialize_distributed(
        ...
        ReconfigureRankType.SHUTDOWN_CURRENT_RANK:
            ...
            logger.info("Distributed environment reinitialized for DP rank {}",
                        self.dp_rank)
...
class DPEngineCoreActor(DPEngineCoreProc):
    ...
    def __init__(
        ...
        aphrodite_config.parallel_config.data_parallel_rank_local = \
            local_dp_rank
        ...
        super().__init__(aphrodite_config, local_client, "", executor_class,
                         log_stats)

    def _set_visible_devices(self, aphrodite_config: AphroditeConfig,
                             local_dp_rank: int):
    ...
    def _set_cuda_visible_devices(self, aphrodite_config: AphroditeConfig,
                                  local_dp_rank: int,
    ...
    def _perform_handshakes(self, handshake_address: str, identity: bytes,
                            local_client: bool, aphrodite_config: AphroditeConfig,
                            client_handshake_address: Optional[str]):
        """
