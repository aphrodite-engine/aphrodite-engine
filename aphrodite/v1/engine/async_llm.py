...
from aphrodite.v1.engine.core_client import AsyncMPClient, DPAsyncMPClient
...
from aphrodite.v1.metrics.loggers import (StatLoggerBase, StatLoggerFactory,
...
class AsyncLLM(EngineClient):
    ...
    def __init__(
        ...
        self.stat_loggers: list[list[StatLoggerBase]] = setup_default_loggers(
            ...
            engine_num=aphrodite_config.parallel_config.data_parallel_size,
    ...
    async def generate(
        ...
        # Request validation error.
            ...
            if self.log_requests:
                logger.info(
                    "Request {} failed (bad request): {}", request_id, str(e))
            raise
        ...
        # Unexpected error in the generate() task (possibly recoverable).
            ...
            await self.abort(request_id)
            if self.log_requests:
                logger.info("Request {} failed: {}", request_id, str(e))
        ...
        async def output_handler():
            try:
                while True:
                    ...
                    # 4) Logging.
                    # TODO: make into a coroutine and launch it in
