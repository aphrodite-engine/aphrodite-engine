                ...
                if publish_front in events:
                    ...
                    if isinstance(decoded, (list, tuple)) and len(
                        ...
                        if new_engine_count > current_count:
                            ...
                            engines_running = False
                            logger.info(
                                "DPCoordinator scaled up from {} to {} "
                                "engines", current_count, new_engine_count)
                        else:
                            self.engines = self.engines[:new_engine_count]
                            logger.info(
                                "DPCoordinator scaled down from {} to {} "
                                "engines", current_count, new_engine_count)
                ...
                if output_back in events:
                    ...
                    if scheduler_stats:
                        ...
                        if (stats_wave > last_stats_wave
                            ...
                            logger.warning(
                                ...
                                "step ({}, {}) from engine {} (expected "
                                "> ({}, {}))", stats_wave, stats_step,
                    ...
                    if (wave := outputs.wave_complete) is not None:
                        ...
                        if current_wave <= wave:
                            new_wave = wave + 1
                            logger.debug("Moving DP wave from {} to {}.",
                        ...
                        logger.debug(
                            "Starting wave {} after notification of "
