...
from aphrodite.multimodal.utils import merge_and_sort_multimodal_metadata
...
class Processor:
    ...
    def __init__(
        ...
        self.decoding_config = aphrodite_config.decoding_config
    ...
    def _validate_supported_sampling_params(
        ...
        if params.logits_processors:
            raise ValueError("Aphrodite V1 does not support per request "
        ...
        if params.guided_decoding.backend:
            ...
            if (params.guided_decoding.backend != engine_level_backend
                ...
                raise ValueError(
                    ...
                    f"'{params.guided_decoding.backend}', but Aphrodite was "
