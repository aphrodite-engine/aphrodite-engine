...
class RequestState:
    ...
    def make_request_output(
        ...
        return self._new_request_output(external_req_id, outputs, finished, kv_transfer_params, ec_transfer_params)
    ...
    def _new_completion_output(
        ...
        if finished and self.sampling_mask_chunks:
            sampling_mask = SamplingMask([chunk.token_ids.tolist() for chunk in self.sampling_mask_chunks])
...
class OutputProcessor:
    ...
    def get_num_queued_tokens(self) -> int:
        ...
        """
        return sum(req.prompt_len for req in self.request_states.values() if req.is_prefilling)
    ...
    def process_outputs(
        ...
        Aphrodite V1 minimizes the number of python loops over the full
        ...
        for engine_core_output in engine_core_outputs:
            ...
            if pooling_output is None:
                ...
                if engine_core_output.new_sampling_mask is not None:
                    req_state.sampling_mask_chunks.append(engine_core_output.new_sampling_mask)
