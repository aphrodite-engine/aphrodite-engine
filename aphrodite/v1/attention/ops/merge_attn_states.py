...
def _merge_attn_states_torch(
    ...
    if prefill_tokens_with_context < num_tokens:
        output[prefill_tokens_with_context:].copy_(suffix_output[prefill_tokens_with_context:])
        if output_lse is not None:
            output_lse[:, prefill_tokens_with_context:].copy_(suffix_lse[:, prefill_tokens_with_context:])
