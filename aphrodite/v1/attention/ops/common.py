...
class PackSeqTritonKernel(AphroditeTritonJitKernel["PackSeqTritonKernel.CompileKey"]):
...
class UnpackSeqTritonKernel(AphroditeTritonJitKernel["UnpackSeqTritonKernel.CompileKey"]):
    @dataclass(frozen=True)
    class CompileKey:
        dtype: torch.dtype
        block_t: int
