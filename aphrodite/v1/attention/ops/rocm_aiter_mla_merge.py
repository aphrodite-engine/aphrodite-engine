...
from aphrodite.triton_utils import LOGE2, tl, triton
...
def _merge_mla_segments_kernel(
    ...
    tiles_per_segment = tl.maximum(1, tl.cdiv(seq_len, NUM_SEGMENTS_PER_SEQ * TILE_SIZE))
    ...
    segment_base = token_idx.to(tl.int64) * (num_query_heads * NUM_SEGMENTS_PER_SEQ) + head_idx * NUM_SEGMENTS_PER_SEQ
    ...
    output_indices = token_idx * out_stride0 + head_idx * out_stride1 + tl.arange(0, KV_LORA_RANK)
