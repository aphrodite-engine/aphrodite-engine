...
class FlashAttentionBackend(AttentionBackend):
    ...
    @staticmethod
    def get_name() -> str:
        return "FLASH_ATTN_APHRODITE_V1"
...
class FlashAttentionImpl(AttentionImpl):
    ...
    def __init__(
        ...
        if head_size not in support_head_sizes:
            raise ValueError(
                ...
                "Set APHRODITE_USE_V1=0 to use another attention backend.")
    ...
    def forward(
        ...
        # IMPORTANT!
        # NOTE: With piece-wise CUDA graphs, this method is executed in
        ...
        # NOTE: Here, key and value are padded while slot_mapping is
...
def use_cascade_attention(
    ...
    # NOTE: This is the common case. We should return False as soon as
    ...
    #    NOTE: The performance model is very rough and may not be
    #    accurate.
    num_tokens = num_reqs
    # NOTE: These are default tile sizes. flash-attn might use
