...
class PallasAttentionBackend(AttentionBackend):
    ...
    def get_min_page_size(aphrodite_config: AphroditeConfig) -> int:
        ...
        min_page_size = cdiv(aphrodite_config.model_config.max_model_len,
    ...
    @staticmethod
    def get_page_size(aphrodite_config: AphroditeConfig) -> int:
        ...
        # handle VREG spills.
        if aphrodite_config.model_config.max_model_len > 8192:
            return 16
        page_size = next_power_of_2(
            aphrodite_config.model_config.max_model_len) // 16
        if page_size <= 16:
            return 16
        if page_size >= 256:
            return 256
