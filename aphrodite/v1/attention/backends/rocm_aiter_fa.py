...
if current_platform.is_rocm():
    ...
    @triton.jit
    def _aphrodite_layout_trans_kernel(
        k_buffer_ptr,
        v_buffer_ptr,
        k_values_ptr,
        v_values_ptr,
    ...
    def aphrodite_layout_trans(b_query_lens_loc, b_seq_lens_loc, block_table,
        ...
        _aphrodite_layout_trans_kernel[grid](k_cache,
                                        v_cache,
                                        k_values,
                                        v_values,
                                        b_query_lens_loc,
    ...
    def flash_attn_varlen_func_impl(
        ...
        k, v = aphrodite_layout_trans(cu_seqlens_q, cu_seqlens_k, block_table,
    ...
    def forward(
        ...
        if not attn_metadata.use_cascade:
            ...
            if max_seqlen_q > 1:
                ...
                torch.ops.aphrodite.flash_attn_varlen_func(
