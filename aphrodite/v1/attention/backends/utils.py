...
def get_kv_cache_layout():
    ...
    if cache_layout is None:
        if (envs.APHRODITE_USE_TRTLLM_CONTEXT_ATTENTION
                or envs.APHRODITE_USE_TRTLLM_DECODE_ATTENTION):
            cache_layout = "HND"
        else:
...
def get_per_layer_parameters(
        aphrodite_config: AphroditeConfig, layer_names: list[str],
...
def infer_global_hyperparameters(
    ...
    if (not envs.APHRODITE_USE_TRTLLM_CONTEXT_ATTENTION
            and not envs.APHRODITE_USE_TRTLLM_DECODE_ATTENTION):
