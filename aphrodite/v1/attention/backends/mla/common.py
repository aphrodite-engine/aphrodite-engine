...
def use_flashinfer_prefill() -> bool:
    ...
    return (flashinfer_available and not envs.APHRODITE_USE_CUDNN_PREFILL
            and current_platform.is_device_capability(100))


def use_cudnn_prefill() -> bool:
    return (flashinfer_available and envs.APHRODITE_USE_CUDNN_PREFILL
            and current_platform.is_device_capability(100)
    ...
    def __init__(self,
        ...
        if self._use_fi_prefill:
            ...
            self._global_hyperparameters = infer_global_hyperparameters(
                get_per_layer_parameters(aphrodite_config, layer_names,
                                         MLACommonImpl))
