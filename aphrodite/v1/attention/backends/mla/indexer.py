...
class DeepseekV32IndexerMetadataBuilder(AttentionMetadataBuilder):
    ...
    def build_one_prefill_chunk(
        ...
        prefill_query_start_loc = (
            query_start_loc_cpu[req_slice.start : req_slice.stop + 1] - query_start_loc_cpu[req_slice.start]
        )
        ...
        token_to_seq = torch.repeat_interleave(seq_idx, seq_lens_cpu[req_slice]).to(self.device)
    ...
    def _prepare_decode_tensors(
        ...
        if not use_native and max_decode_len > 1:
            ...
            if use_native and next_n > 1:
                ...
                self.decode_seq_lens_buffer[:num_decodes] = seq_lens.unsqueeze(1) - next_n + 1 + self.offsets_buffer
    ...
    def build(
        ...
        compressed_slot_mapping = common_attn_metadata.slot_mapping
