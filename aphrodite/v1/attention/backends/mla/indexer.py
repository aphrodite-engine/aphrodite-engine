...
class DeepseekV32IndexerMetadataBuilder(AttentionMetadataBuilder):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.use_flattening = (
            self.use_fp4_indexer_cache or not current_platform.is_device_capability_family(100)
    ...
    def build(
        ...
        if num_decodes > 0:
            ...
            if self.compress_ratio > 1:
                ...
                seq_lens_is_local_view = (use_native and next_n > 1) or (not use_native and max_decode_len > 1)
