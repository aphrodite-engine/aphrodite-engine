...
class CPUMLAImpl(MLACommonImpl[MLACommonMetadata]):
    ...
    def __init__(
        ...
        **mla_args,
        ...
        if any(unsupported):
            raise NotImplementedError("CPU MLA does not support alibi_slopes / sliding_window / logits_soft_cap.")
    ...
    def forward_mqa(
        ...
        out = torch.zeros(bs, num_heads, self.kv_lora_rank, dtype=q.dtype, device=q.device)
