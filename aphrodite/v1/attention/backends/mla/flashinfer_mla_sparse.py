...
class FlashInferMLASparseSM120Backend(_FlashInferMLASparseBackendBase):
    ...
    def supported_kv_cache_layouts(cls) -> tuple[KVCacheLayout, ...]:
        # The SM120 sparse launcher expects a compact packed-FP8 token pool.
    ...
    @staticmethod
    def get_impl_cls() -> type[MLAAttentionImpl]:
        from aphrodite.v1.attention.backends.mla.flashinfer_mla_sparse_sm120 import (
...
class FlashInferMLASparseMetadataBuilder(SparseMLACommonMetadataBuilder[FlashInferMLASparseMetadata]):
...
class FlashInferMLASparseImpl(SparseMLACommonImpl[FlashInferMLASparseMetadata]):
    ...
    def forward_mqa(
        ...
        _, block_stride_rows = flat_kv_row_view(kv_c_and_k_pe_cache, attn_metadata.block_size)
        ...
        if self.is_nope_mla:
            ...
            topk_indices_physical[:, 0] = topk_indices_physical[:, 0].masked_fill(empty_rows, 0)
