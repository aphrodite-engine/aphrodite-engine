...
class MLAPrefillBackend(ABC):
    ...
    def supports_mla_dimensions(cls, mla_dimensions: MLADimensions) -> bool:
        return not cls.supported_mla_dimensions or mla_dimensions in cls.supported_mla_dimensions
    ...
    def validate_configuration(
        ...
        if not cls.supports_mla_dimensions(mla_dimensions):
            reason = f"Model does not have supported MLA dimensions (got {mla_dimensions}"
            if cls.supported_mla_dimensions and mla_dimensions not in cls.supported_mla_dimensions:
