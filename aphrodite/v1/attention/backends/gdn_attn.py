...
from aphrodite.v1.attention.backends.utils import (
    ...
    compute_causal_conv1d_metadata, split_decodes_and_prefills)
...
class GDNAttentionMetadataBuilder(AttentionMetadataBuilder[GDNAttentionMetadata]):
    ...
    def __init__(
        ...
        self.decode_cudagraph_max_bs = min(
            self.aphrodite_config.scheduler_config.max_num_seqs * (self.num_spec + 1),
    ...
    def build(  # type: ignore[override]
        ...
        if (
            ...
            num_actual_tokens = self.aphrodite_config.pad_for_cudagraph(m.num_actual_tokens)
