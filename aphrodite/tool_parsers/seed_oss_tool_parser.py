...
class SeedOssToolParser(ToolParser):
    ...
    def __init__(self, tokenizer: TokenizerLike, tools: list[Tool] | None = None):
        ...
        logger.info("Aphrodite Seed-Oss XML tool parser loaded (%s).", self.__class__.__name__)
    ...
    def extract_tool_calls(
        ...
        try:
            ...
            tool_calls = [
                self._parse_xml_function_call(function_call_str, self.tools) for function_call_str in function_calls
            ]
        ...
        if self.in_function:
            ...
            if not self.json_closed and self.function_end_token in tool_text:
                ...
                if func_content_end != -1:
                    ...
                    try:
                        parsed_tool = self._parse_xml_function_call(func_content, self.tools)
                        if parsed_tool:
