...
import aphrodite.models.deepseek_v32.common.kernels as K
...
def make_inputs(num_tokens: int, num_heads: int):
    ...
    return dict(
        ...
        index_q=torch.randn(num_tokens, INDEX_HEADS, INDEX_HEAD_DIM, device=dev, dtype=bf16),
        ...
        index_weights=torch.randn(num_tokens, INDEX_HEADS, device=dev, dtype=torch.float32),
...
def run(kwargs, *, cutedsl: bool):
    ...
    from aphrodite.models.deepseek_v32.nvidia.ops import fused_q_cutedsl as C
