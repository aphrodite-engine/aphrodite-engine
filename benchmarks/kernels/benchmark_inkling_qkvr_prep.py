...
from aphrodite.models.inkling.nvidia.ops import qkvr_prep
...
def benchmark(inputs, args) -> float:
    ...
    return statistics.median(time_graph(graph, args.warmup, args.repeats) for _ in range(args.trials))
