...
func (c *RouterConfig) GetEndpointsForModel(modelName string) []APHRODITEEndpoint {
	var endpoints []APHRODITEEndpoint
...
func (c *RouterConfig) GetEndpointByName(name string) (*APHRODITEEndpoint, bool) {
	for _, endpoint := range c.APHRODITEEndpoints {
