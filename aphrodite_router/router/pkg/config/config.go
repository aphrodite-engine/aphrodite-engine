...
type BackendModels struct {
	...
	// Aphrodite endpoints configuration for multiple backend support
	APHRODITEEndpoints []APHRODITEEndpoint `yaml:"aphrodite_endpoints"`
}
...
// APHRODITEEndpoint represents a Aphrodite backend endpoint configuration
type APHRODITEEndpoint struct {
	// Name identifier for the endpoint
	Name string `yaml:"name"`

	// Address of the Aphrodite endpoint
	Address string `yaml:"address"`

	// Port of the Aphrodite endpoint
	Port int `yaml:"port"`
...
type ModelParams struct {
	...
	// These must be registered with Aphrodite using --lora-modules flag
	LoRAs []LoRAAdapter `yaml:"loras,omitempty"`
}

// LoRAAdapter represents a LoRA adapter configuration for a model
type LoRAAdapter struct {
	// Name of the LoRA adapter (must match the name registered with Aphrodite)
	Name string `yaml:"name"`
