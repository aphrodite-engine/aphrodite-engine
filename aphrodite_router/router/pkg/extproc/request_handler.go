...
import (
	...
	"github.com/aphrodite-engine/aphrodite-engine/aphrodite_router/router/pkg/headers"
	...
	"github.com/aphrodite-engine/aphrodite-engine/aphrodite_router/router/pkg/observability/tracing"
	"github.com/aphrodite-engine/aphrodite-engine/aphrodite_router/router/pkg/utils/http"
...
func (r *OpenAIRouter) handleModelsRequest(_ string) (*ext_proc.ProcessingResponse, error) {
	...
	if r.Config != nil {
		...
		models = append(models, OpenAIModel{
			...
			Object:      "model",
			Created:     now,
			OwnedBy:     "aphrodite-router",
			Description: "Intelligent Router for Mixture-of-Models",
			LogoURL:     "", // You can customize this URL
		})
	} else {
