...
const TERMINAL_SCRIPT: TerminalLine[] = [
    ...
    { type: 'command', content: '$ curl -X POST http://aphrodite-router/v1/chat/completions \\', delay: 500 },
    { type: 'command', content: '  -d \'{"model": "MoM", "messages": [{"role": "user", "content": "What is 2+2?"}]}\'', delay: 400 },
    { type: 'output', content: '', delay: 200 },
    { type: 'output', content: '🔀 Aphrodite Router - Chain-Of-Thought 🔀', delay: 300 },
...
const LandingPage: React.FC = () => {
  ...
  const highlightContent = (content: string) => {
    // Split by both "MoM" and "aphrodite-router"
    const parts = content.split(/(\"MoM\"|aphrodite-router)/gi)
    return parts.map((part, index) => {
      ...
      if (part.toLowerCase() === 'aphrodite-router') {
        return (
          <span key={index} style={{
            color: '#3b82f6',
            fontWeight: 'bold',
      ...
      <nav className={styles.navbar}>
        <div className={styles.navContent}>
          <div className={styles.navBrand}>
            <img src="/aphrodite.png" alt="Aphrodite" className={styles.navLogo} />
            <span className={styles.navBrandText}>Aphrodite Router Dashboard</span>
          </div>
        ...
        <div className={styles.leftPanel}>
          <div className={styles.heroSection}>
            <div className={styles.heroTitleWrapper}>
              <img src="/aphrodite.png" alt="Aphrodite Logo" className={styles.aphroditeLogo} />
