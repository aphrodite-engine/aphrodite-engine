...
const TopologyPage: React.FC = () => {
  ...
  const generateTopology = (configData: ConfigData) => {
    ...
    const promptGuardModel = 'Aphrodite-Router-Jailbreak'
    newNodes.push({
      id: 'prompt-guard',
      data: {
        label: (
    ...
    const piiModel = 'Aphrodite-Router-PII'
    newNodes.push({
      id: 'pii-detection',
      data: {
        label: (
    ...
    const cacheBertModel = 'Aphrodite-Router-Similarity'
    newNodes.push({
      id: 'semantic-cache',
      data: {
        label: (
    ...
    const classificationModel = 'Aphrodite-Router-Classify'
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <h1 className={styles.title}>🗺️ Aphrodite Router Topology</h1>
